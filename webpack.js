...
webpack({
  ...
  resolve: {
    alias: {
      ...
      GameCardBox$: path.resolve(__dirname, 'lib/templates/lib/game-cardbox/game-cardbox.js'),
      GameCardFan$: path.resolve(__dirname, 'lib/templates/lib/game-cardfan/game-cardfan.js'),
