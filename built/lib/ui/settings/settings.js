...
var SettingsTemplate = require('./settings.template');
module.exports = /** @class */ (function () {
    ...
    Settings.prototype.attachEvents = function (app) {
        var _this = this;
        var reset_button = document.querySelector('.settings-reset-button');
        reset_button.addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, app.storage.resetOptions()];
                    case 1:
                        _a.sent();
        ...
        var save_button = document.querySelector('.settings-backup-button');
        save_button.onclick = function () {
            var pom = document.createElement('a');
            pom.setAttribute('type', "hidden");
            pom.setAttribute('href', 'data:application/json;utf-8,' + encodeURIComponent(JSON.stringify(_this.app.options)));
            pom.setAttribute('download', "saito.wallet.json");
            document.body.appendChild(pom);
            pom.click();
            pom.remove();
        };
        var load_button = document.querySelector('.settings-import-button');
        load_button.addEventListener('click', function () {
            ...
            inputFile.addEventListener('change', function (e) {
                ...
                reader.onload = function (e) {
                    ...
                    var tmpoptions = JSON.parse(contents);
    ...
    Settings.prototype.initSettings = function () {
        var change_theme_mode = function (event) {
