...
var Miner = /** @class */ (function () {
    ...
    Miner.prototype.initialize = function () {
        var _this = this;
        this.app.connection.on('BlockchainNewLongestChainBlock', function (msg) {
            _this.stopMining();
            _this.startMining(msg.block_hash, msg.difficulty);
        });
    };
    Miner.prototype.startMining = function (previous_block_hash, difficulty) {
        var _this = this;
        ...
        this.mining_timer = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mine()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Miner.prototype.mine = function () {
        return __awaiter(this, void 0, void 0, function () {
            var random_hash, transaction;
            return __generator(this, function (_a) {
                if (this.mining_active) {
                    random_hash = this.app.crypto.generateRandomNumber();
                    if (this.app.goldenticket.validate(this.target, random_hash, this.app.wallet.returnPublicKey(), this.difficulty)) {
                        transaction = this.app.wallet.createUnsignedTransaction();
                        transaction.transaction.type = transaction_1.TransactionType.GoldenTicket;
