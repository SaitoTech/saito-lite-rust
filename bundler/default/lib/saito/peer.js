...
class Peer {
  ...
  sendRequest(message, data = "") {
    ...
    if (this.socket != null) {
console.log("SENDING THE SOCKET 1");
      if (this.socket.connected == true && this.socket.readyState === this.socket.OPEN) {
        ...
        try {
console.log("SENDING THE SOCKET 2");
...
console.log("SENDING THE SOCKET 3");
...
console.log("SENDING THE SOCKET 4");
...
console.log("SENDING THE SOCKET 5");
