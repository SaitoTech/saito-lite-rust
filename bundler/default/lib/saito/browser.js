...
class Browser {
  ...
  async initialize(app) {
    ...
    if (this.app.BROWSER != 1) { return 0;}
  ...
  isSupportedBrowser(userAgent) {
    ...
    if (userAgent.toLowerCase().indexOf("safari/") > -1) {
      if (userAgent.toLowerCase().indexOf("chrome") == -1 && userAgent.toLowerCase().indexOf("firefox") == -1) { return 0; }
    }

    //
    // require ES6
    //
    try { Function("() => {};"); } catch(err) { return 0; }
