...
class Block {
  ...
  deserialize(buffer) {
    ...
    this.block.id = parseInt(this.app.networkApi.u64FromBytes(buffer.slice(4, 12)));
    this.block.timestamp = parseInt(this.app.networkApi.u64FromBytes(buffer.slice(12, 20)));
    ...
    this.block.burnfee = parseInt(this.app.networkApi.u64FromBytes(buffer.slice(197, 205)));
    this.block.difficulty = parseInt(this.app.networkApi.u64FromBytes(buffer.slice(205, 213)));
