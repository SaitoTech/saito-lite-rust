...
function init(){
	...
	if( fs.existsSync('config/modules.config.js') == true ){
		...
		console.clear();
		console.log( "\u001b[1;36m"+"** 1. INITIAL SAITO COMPILE **"+"\x1b[0m" );
		console.log("It looks like you have already installed Saito. If you are ");
		...
		console.log( "");
		console.log( "");
		console.log( "Continuing with this installation will delete existing data,");
		console.log( "reset your wallet and resync the blockchain. Are you sure ");
...
function init2(){
	...
	if( fs.existsSync('config/saito.io.conf') == true ){
		...
		console.log( "" );
		console.log( "You can join the Saito Network and participate in development" );
		console.log( "of the public chain. Or you can setup a local node for the" );
...
function nuke(){
	...
	console.log( "  -------------------------  " );
	console.log( "  \x1b[33mNUKING YOUR \x1b[31mSAITO \x1b[33mINSTALL\x1b[0m   " );
	console.log( "  -------------------------  " );
...
function reset_bundler() {
	...
	var rmFileArr = ['DESCRIPTION.txt', 'BUGS.txt', 'README.txt', 'README.md', 'install.sh', 'license'];
...
function copyDir(source, destination) {
    ...
    fs.readdirSync(source, { withFileTypes: true }).forEach((entry) => {
      ...
      entry.isDirectory() ? copyDir(sourcePath, destinationPath) : fs.copyFileSync(sourcePath, destinationPath);
    });
  }
...
function userInput(query){
    ...
    return new Promise(resolve => inp.question(query, function(ans){
        inp.close();
        resolve(ans);
    }))
}
