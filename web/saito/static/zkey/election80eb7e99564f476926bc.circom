...
template DynamicVoteCircuit(MAX_CANDIDATES) {
    ...
    rangeCheckMax.in[1] <== MAX_CANDIDATES + 1;  // if you want inclusive, adjust accordingly
    rangeCheckMax.out === 1;
    ...
    // (Optional) check candidateIndex >= 0 
    // For field elements, you'd do something like 
    // "candidateIndex < p" is always true if p is large prime. 
    // If you want to ensure no negative wrap, you can do more advanced checks or rely on the platform.
