			...
			3:
				...
				function (module, __webpack_exports__, __webpack_require__) {
					...
					(function (CONNECTION_STATUS) {
						...
						CONNECTION_STATUS['ClosedByJsStore'] =
							'closed_by_jsstore';
					...
					var meta_helper_MetaHelper =
						...
						(function () {
							...
							MetaHelper.autoIncrementKey = function (
								tableName,
								columnName
							) {
								return (
							...
							MetaHelper.set = function (key, value, util) {
								if (!util.tx) {
									util.createTransaction([
										MetaHelper.tableName
									]);
								}

								var store = util.objectStore(
									MetaHelper.tableName
								);
						...
						(function () {
							return function (db) {
								...
								this.tables = db.tables.map(function (table) {
									return new table_meta_TableMeta(
										table,
										db.version
									);
								});
					...
					var idbutil_IDBUtil =
						...
						(function () {
							...
							IDBUtil.prototype.createTransaction = function (
								tables,
								mode
							) {
								var _this = this;
							...
							IDBUtil.prototype.initDb = function () {
								...
								return promise(function (res, rej) {
									...
									dbOpenRequest.onsuccess = function () {
										...
										_this.con.onversionchange = function (
											e
										) {
									...
									dbOpenRequest.onupgradeneeded = function (
										...
										var createObjectStore = function (
											...
											if (
												upgradeConnection.objectStoreNames.contains(
													table.name
												)
											) {
												upgradeConnection.deleteObjectStore(
													table.name
												);
											}

											var store =
												upgradeConnection.createObjectStore(
													table.name,
													option
												);
							...
							LogHelper.prototype.getMsg_ = function () {
								...
								switch (this.type) {
									case ERROR_TYPE.NotArray:
										errMsg =
											'Supplied value is not an array';
										break;
									...
									case ERROR_TYPE.UndefinedColumnName:
										errMsg =
											...
											this.info_['TableName'] +
											"'";
										break;

									case ERROR_TYPE.UndefinedDbName:
										errMsg =
											'Database name is not supplied';
										break;
									...
									case ERROR_TYPE.DbBlocked:
										errMsg =
											'database is blocked, cant be deleted right now';
										break;

									case ERROR_TYPE.NullValueInWhere:
										errMsg =
											"Null/undefined is not allowed in where. Column '" +
											this.info_['column'] +
											"' has null";
										break;
					...
					var getError = function (e) {
						if (e instanceof log_helper_LogHelper) {
							...
							if (e.name) {
								...
								error = new log_helper_LogHelper(
									e.target.error.name
								);
					...
					var base_Base =
						...
						(function () {
							...
							Base.prototype.getColumnInfo = function (
								columnName,
								tableName
							) {
								return this.table(tableName).columns.find(
									function (column) {
					...
					var values_checker_ValuesChecker =
						...
						(function () {
							...
							ValuesChecker.prototype.checkAndModifyValues =
								function (values) {
									var _this = this;
							...
							ValuesChecker.prototype.checkAndModifyValue =
								function (value) {
									var _this = this;
									...
									this.table.columns.every(function (column) {
										error =
											_this.checkAndModifyColumnValue_(
												column,
												value
											);
							...
							ValuesChecker.prototype.checkNotNullAndDataType_ =
							...
							ValuesChecker.prototype.checkAndModifyColumnValue_ =
								function (column, value) {
									...
									if (column.autoIncrement) {
										...
										if (isNull(columnValue)) {
											value[column.name] = ++this
												.autoIncrementValue[
												column.name
											];
										} else {
											if (
												getDataType(columnValue) ===
												DATA_TYPE.Number
											) {
									...
									return this.checkNotNullAndDataType_(
										column,
										value
									);
								};

							ValuesChecker.prototype.getError = function (
								error,
								details
							) {
					...
					var schema_checker_SchemaChecker =
						...
						(function () {
							...
							SchemaChecker.prototype.check = function (
								setValue,
								tblName
							) {
								var _this = this;
							...
							SchemaChecker.prototype.checkByColumn_ = function (
								column,
								value
							) {
								// check not null schema
								if (column.notNull === true && isNull(value)) {
									return new log_helper_LogHelper(
										ERROR_TYPE.NullValue,
										{
											ColumnName: column.name
										}
					...
					var query_helper_QueryHelper =
						...
						(function () {
							...
							QueryHelper.prototype.validate = function (
								api,
								query
							) {
								switch (api) {
							...
							QueryHelper.prototype.getTable_ = function (
								tableName
							) {
								return this.db.tables.find(function (q) {
									return q.name === tableName;
							...
							QueryHelper.prototype.checkUpdate = function (
								query
							) {
								var err = new schema_checker_SchemaChecker(
									this.getTable_(query.in)
							...
							QueryHelper.prototype.checkSelect = function (
								query
							) {
							...
							QueryHelper.prototype.checkForNullInWhere_ =
								function (query) {
							...
							QueryHelper.prototype.addGreatAndLessToNotOp_ =
								function (query) {
							...
							QueryHelper.prototype.checkInsertQuery = function (
								query
							) {
								...
								if (query.skipDataCheck) {
									...
									var valueCheckerInstance =
										new values_checker_ValuesChecker(
											table,
											table.autoIncColumnValue
										);

									var _a =
											valueCheckerInstance.checkAndModifyValues(
												query.values
											),
										values = _a.values,
										err_1 = _a.err;
					...
					var insert_Insert =
						...
						(function (_super) {
							...
							Insert.prototype.execute = function (db) {
								...
								var err = new query_helper_QueryHelper(
									db
								).validate(API.Insert, this.query);
							...
							Insert.prototype.insertData_ = function (db) {
								...
								if (!this.isTxQuery) {
									this.util.createTransaction([
										this.query.into,
										meta_helper_MetaHelper.tableName
									]);
								}

								objectStore = this.util.objectStore(
									this.tableName
								);
								return promiseAll(
									...
									meta_helper_MetaHelper.set(
										meta_helper_MetaHelper.dbSchema,
										db,
										_this.util
									);
								});
					...
					var setPushResult = function () {
						...
						if (this.query.case) {
							this.pushResult = function (value) {
								_this.thenEvaluator.setCaseAndValue(
									_this.query.case,
									value
								);
					...
					var then_evaluator_ThenEvaluator =
						...
						(function () {
							...
							ThenEvaluator.prototype.setCaseAndValue = function (
								caseQuery,
								value
							) {
							...
							ThenEvaluator.prototype.setCaseAndColumn =
								function (caseQuery, columnName) {
									this.caseQuery_ = caseQuery;
									this.setColumn(columnName);
									return this;
								};

							ThenEvaluator.prototype.setColumn = function (
								columnName
							) {
								this.columnName_ = columnName;
								this.caseColumnQuery_ =
									this.caseQuery_[this.columnName_];
								this.length_ = this.caseColumnQuery_.length;
								return this;
							};

							ThenEvaluator.prototype.setValue = function (
								value
							) {
								this.value = value;
								return this;
							...
							ThenEvaluator.prototype.evaluate = function () {
								...
								var lastThen =
									this.caseColumnQuery_[this.length_ - 1]
										.then;
								return lastThen == null
									? this.value[this.columnName_]
									: lastThen;
							};

							ThenEvaluator.prototype.checkCase_ = function (
								cond
							) {
								for (var queryOption in cond) {
									switch (queryOption) {
										...
										case QUERY_OPTION.Between:
											if (
												this.value[this.columnName_] >
													cond[queryOption].low &&
												this.value[this.columnName_] <
													cond[queryOption].high
											) {
												return true;
											}
					...
					var executeWhereUndefinedLogic = function () {
						...
						if (
							...
							if (
								this.objectStore.indexNames.contains(
									this.query.order.by
								)
							) {
								var orderType =
									this.query.order.type &&
									this.query.order.type.toLowerCase() ===
										'desc'
										? 'prev'
										: 'next';
								this.sorted = true;
								cursorRequest = this.objectStore
									.index(this.query.order.by)
									.openCursor(null, orderType);
							} else {
								return promiseReject(
									new log_helper_LogHelper(
						...
						return promise(function (res, rej) {
							...
							cursorRequest.onsuccess = onSuccess.call(
								_this,
								res
							);
						});
					...
					var executeSkipAndLimit = function (onFinished) {
						...
						return function (e) {
							...
							if (cursor) {
								if (
									recordSkipped &&
									_this.results.length !== _this.limitRecord
								) {
					...
					var getOrderColumnInfo = function (orderColumn) {
						...
						if (this.query.join == null) {
							...
							var splittedByDot =
								removeSpace(orderColumn).split('.');
							orderColumn = splittedByDot[1];
							column = this.getColumnInfo(
								orderColumn,
								splittedByDot[0]
							);
						}
						...
						if (column == null) {
							var valueFromFirstColumn =
								this.results[0][orderColumn];
							...
							throw new log_helper_LogHelper(
								ERROR_TYPE.ColumnNotExist,
								{
									column: orderColumn,
									isOrder: true
					...
					var getValInDesc_ = function (value1, value2, caseQuery) {
						for (var columnName in caseQuery) {
							this.thenEvaluator.setCaseAndValue(
								caseQuery,
								value1
							);
							var column1 = this.thenEvaluator
								.setColumn(columnName)
								.evaluate();
							this.thenEvaluator.setCaseAndValue(
								caseQuery,
							...
							var column2 = this.thenEvaluator
								.setColumn(columnName)
								.evaluate();

							switch (typeof value1[column1]) {
								case DATA_TYPE.String:
									return compareStringInDesc_(
										value1[column1],
										value2[column2]
									);

								default:
									return compareNumberInDesc_(
										value1[column1],
										value2[column2]
									);
							}
					...
					var getValInAsc_ = function (value1, value2, caseQuery) {
						for (var columnName in caseQuery) {
							...
							switch (typeof value1[column1]) {
								case DATA_TYPE.String:
									return compareStringinAsc_(
										value1[column1],
										value2[column2]
									);

								default:
									return compareNumberinAsc_(
										value1[column1],
										value2[column2]
									);
							}
					...
					var orderBy_ = function (order) {
						...
						if (
							orderColumn != null &&
							typeof orderColumn === DATA_TYPE.Object
						) {
							if (order.type === 'asc') {
								this.results.sort(function (a, b) {
									return getValInAsc_.call(
										_this,
										a,
										b,
										orderColumn
							...
							var columnInfo = getOrderColumnInfo.call(
								this,
								orderColumn
							);

							if (columnInfo != null) {
								var orderMethod_1 = getValueComparer_(
									columnInfo,
									order
								);
								...
								if (order.case == null) {
									...
									this.thenEvaluator.setCaseAndColumn(
										((_a = {}),
										(_a[orderColumn] = order.case),
										_a),
										orderColumn
									);
									this.results.sort(function (a, b) {
						...
						if (order && this.results.length > 0 && !this.sorted) {
							...
							if (orderQueryType === DATA_TYPE.Object) {
								...
								var _loop_1 = function (i) {
									...
									var currentorderQueryBy =
										currentOrderQuery.by;
									var orderColumnDetail =
										getOrderColumnInfo.call(
											this_1,
											currentorderQueryBy
										);
									...
									if (orderColumnDetail != null) {
										currentorderQueryBy =
											orderColumnDetail.name;
										currentOrderQuery.type = getOrderType_(
											currentOrderQuery.type
										);
					...
					var executeAggregateGroupBy = function () {
						...
						var calculateAggregate = function () {
							var getCount = function () {
								...
								value = value
									? value['count(' + columnToAggregate + ')']
									: 0; // add with old value if data exist
							...
							var getMax = function () {
								...
								value = value
									? value['max(' + columnToAggregate + ')']
									: 0;
								datas[index][columnToAggregate] = datas[index][
									columnToAggregate
								]
									? datas[index][columnToAggregate]
									: 0; // compare between old value and new value
							...
							var getMin = function () {
								...
								value = value
									? value['min(' + columnToAggregate + ')']
									: Infinity;
								datas[index][columnToAggregate] = datas[index][
									columnToAggregate
								]
									? datas[index][columnToAggregate]
									: Infinity; // compare between old value and new value
							...
							var getAvg = function () {
								...
								sumOfColumn += datas[index][columnToAggregate]
									? datas[index][columnToAggregate]
									: 0;
								datas[index]['sum(' + columnToAggregate + ')'] =
									sumOfColumn; // get old count value
								...
								value += datas[index][columnToAggregate]
									...
									: 0;
								datas[index][
									'count(' + columnToAggregate + ')'
								] = value;
							};

							for (var prop in aggregateQry) {
								var aggregateColumn = aggregateQry[prop];
								var aggregateValType =
									getDataType(aggregateColumn);
								var aggregateCalculator = void 0;
						...
						if (aggregateQry.avg) {
							if (
								getDataType(aggregateQry.avg) ===
								DATA_TYPE.String
							) {
								for (index in datas) {
									var sumForAvg =
											datas[index][
												'sum(' + aggregateQry.avg + ')'
											],
										countForAvg =
											datas[index][
												'count(' +
									...
									datas[index][
										'avg(' + aggregateQry.avg + ')'
									] = sumForAvg / countForAvg;

									if (
										aggregateQry.count !== aggregateQry.avg
									) {
										delete datas[index][
											'count(' + aggregateQry.avg + ')'
										];
									}
								...
								var isCountTypeString =
									getDataType(aggregateQry.count) ===
									DATA_TYPE.String;
								var isSumTypeString =
									getDataType(aggregateQry.sum) ===
									DATA_TYPE.String;

								for (index in datas) {
									for (var column in aggregateQry.avg) {
										var avgColumn =
												aggregateQry.avg[column],
											sum =
												datas[index][
													'sum(' + avgColumn + ')'
												],
										...
										datas[index]['avg(' + avgColumn + ')'] =
											sum / count;

										if (isCountTypeString) {
											if (
												aggregateQry.count !== avgColumn
											) {
												delete datas[index][
													'count(' + avgColumn + ')'
												];
											} else if (
												aggregateQry.count.indexOf(
													avgColumn
												) === -1
											) {
												delete datas[index][
										...
										if (isSumTypeString) {
											if (
												aggregateQry.sum !== avgColumn
											) {
												delete datas[index][
													'sum(' + avgColumn + ')'
												];
											} else if (
												aggregateQry.sum.indexOf(
													avgColumn
												) === -1
											) {
												delete datas[index][
					...
					var clone = function (obj) {
						if (clone_isObject(obj)) {
							...
							for (var i in obj) {
								copy[i] =
									obj[i] != null && clone_isObject(obj[i])
										? clone(obj[i])
										: obj[i];
							}
					...
					var where_checker_WhereChecker =
						...
						(function () {
							...
							WhereChecker.prototype.checkIn = function (
								column,
								value
							) {
								return (
									this.where[column][QUERY_OPTION.In].find(
										function (q) {
							...
							WhereChecker.prototype.checkLike_ = function (
								column,
								value
							) {
							...
							WhereChecker.prototype.checkRegex = function (
								column,
								value
							) {
							...
							WhereChecker.prototype.checkComparisionOp_ =
								function (column, value, symbol) {
									var compareValue =
										this.where[column][symbol];
					...
					var base_fetch_BaseFetch =
						...
						(function (_super) {
							...
							BaseFetch.prototype.goToWhereLogic = function () {
								...
								var firstColumn = getObjectFirstKey(
									query.where
								);
								...
								if (
									...
									if (getDataType(value) === 'object') {
										...
										this.whereCheckerInstance =
											new where_checker_WhereChecker(
												query.where,
												checkFlag
											);
										var key = getObjectFirstKey(value);
										this.whereCheckerInstance.remove([
											firstColumn,
											key
										]);
									...
									var column =
										this.getColumnInfo(firstColumn);
									var error =
										column == null
											? new log_helper_LogHelper(
													ERROR_TYPE.ColumnNotExist,
					...
					var executeInLogic = function (column, values) {
						...
						var runInLogic = function (value) {
							return promise(function (res, rej) {
								var cursorRequest = columnStore.openCursor(
									_this.util.keyRange(value)
								);
								cursorRequest.onsuccess = onSuccess.call(
									_this,
									res,
					...
					var executeSkipAndLimitForIn_ = function (
						onFinish,
						skipOrPush
					) {
						var _this = this;
					...
					var executeSkipAndLimitForRegex_ = function (
						onFinish,
						skipOrPush
					) {
						var _this = this;
					...
					var join_Join =
						...
						(function () {
							...
							Join.prototype.execute = function () {
								...
								if (
									getDataType(query.join) === DATA_TYPE.Object
								) {
								...
								return this.executeSelect({
									...
									_this.results = results.map(function (
										item
									) {
										var _a;
										...
										return (
											(_a = {}),
											(_a[_this.currentQueryStackIndex_] =
												item),
											_a
										);
									});
							...
							Join.prototype.startExecutingJoinLogic_ =
								function () {
									var _this = this;
									...
									if (query) {
										try {
											...
											return this.executeSelect({
												...
												_this.tablesFetched.push(
													jointblInfo_1.table2.table
												);
							...
							Join.prototype.jointables = function (
								...
								var table1Index = this.tablesFetched.indexOf(
									jointblInfo.table1.table
								);
								var table2Index =
									this.currentQueryStackIndex_ + 1;

								var performInnerJoin = function () {
									var index = 0;

									_this.results.forEach(function (
										valueFromFirstTable
									) {
										secondtableData.forEach(function (
											...
											if (
												...
												results[index] = __assign(
													{},
													valueFromFirstTable
												);
												results[index++][table2Index] =
													valueFromSecondTable;
											}
										});
									});
								...
								var performleftJoin = function () {
									...
									_this.results.forEach(function (
										...
										if (
											valueMatchedFromSecondTable.length ===
											0
										) {
											valueMatchedFromSecondTable = [
												columnDefaultValue
										...
										valueMatchedFromSecondTable.forEach(
											function (value) {
												results[index] = __assign(
													{},
													valueFromFirstTable
							...
							Join.prototype.getJoinTableInfo_ = function (
								joinOn
							) {
								joinOn = removeSpace(joinOn);
								var splittedjoinOn = joinOn.split('=');
								var splittedjoinOnbydotFirst =
									splittedjoinOn[0].split('.');
								var splittedjoinOnbydotSecond =
									splittedjoinOn[1].split('.');
								var info = {
									table1: {
							...
							Join.prototype.checkJoinQuery_ = function (
								jointblInfo,
								qry
							) {
								var table1 = jointblInfo.table1;
								var table2 = jointblInfo.table2;
								var tableSchemaOf1stTable = this.getTable(
									table1.table
								);
								var tableSchemaOf2ndTable = this.getTable(
									table2.table
								);
								var err; // check on info & with info

								if (qry.with !== table2.table) {
									err = new log_helper_LogHelper(
										ERROR_TYPE.InvalidJoinQuery,
								...
								if (
									tableSchemaOf1stTable.columns.find(
										function (q) {
									...
									tableSchemaOf2ndTable.columns.find(
										function (q) {
					...
					var select_Select =
						...
						(function (_super) {
							...
							function Select(query, util) {
								...
								_this.thenEvaluator =
									new then_evaluator_ThenEvaluator();
								...
								_this.returnResult_ = function () {
									if (_this.query.flatten) {
										...
										_this.query.flatten.forEach(function (
											column
										) {
											_this.results.forEach(function (
												data,
										...
										getKeys(indexToDelete_1).forEach(
											function (key) {
												_this.results.splice(
													Number(key) -
														itemsDeleted_1,
													1
												);
							...
							Select.prototype.execute = function (db) {
								...
								try {
									var err = new query_helper_QueryHelper(
										db
									).validate(API.Select, this.query);
									if (err) return promiseReject(err);
							...
							Select.prototype.processWhereArrayQry =
								function () {
									var _this = this;
									...
									var processFirstQry = function () {
										...
										if (
											_this.query.where[QUERY_OPTION.Or]
										) {
											if (
												getLength(_this.query.where) ===
												1
											) {
							...
							Select.prototype.initTransaction_ = function () {
								...
								this.objectStore = this.util.objectStore(
									this.tableName
								);
							};
							...
							Select.prototype.processWhere_ = function () {
								...
								this.shouldAddValue = function (value) {
									return _this.whereCheckerInstance.check(
										value
									);
								};
							...
							Select.prototype.orQuerySuccess_ = function () {
								this.orInfo.results = __spreadArray(
									__spreadArray([], this.orInfo.results),
									this.results
								);
								...
								if (
									!this.query.limit ||
									this.query.limit >
										this.orInfo.results.length
								) {
									this.results = [];
									var key = getObjectFirstKey(
										this.orInfo.orQuery
									);
									...
									if (key != null) {
										...
										return this.goToWhereLogic().then(
											this.onWhereEvaluated.bind(this)
										);
									}
								}
					...
					var where_executeWhereLogic = function (column, value, op) {
						...
						return promise(function (res, rej) {
							if (
								getLength(_this.query.where) === 1 &&
								_this.objectStore.count
							) {
								cursorRequest = _this.objectStore
									.index(column)
								...
								cursorRequest.onsuccess = function (e) {
									...
									if (cursor) {
										if (
											_this.whereCheckerInstance.check(
												cursor.value
											)
										) {
											++_this.resultCount;
					...
					var in_executeInLogic = function (column, values) {
						...
						var runInLogic = function (value) {
							...
							return promise(function (res, rej) {
								var cursorRequest =
									columnStore.openCursor(keyRange);
						...
						(function (_super) {
							...
							function Count(query, util) {
								...
								_this.executeWhereLogic =
									where_executeWhereLogic;
								_this.executeRegexLogic =
									regex_executeRegexLogic;
							...
							Count.prototype.execute = function (db) {
								...
								this.db = db;
								var queryHelper = new query_helper_QueryHelper(
									db
								);
								var query = this.query;
								var err = queryHelper.validate(
									API.Count,
									query
								);
								...
								try {
									...
									var getDataFromSelect = function () {
										var selectInstance = new select_Select(
											_this.query,
											_this.util
										);
										selectInstance.isTxQuery =
											_this.isTxQuery;
					...
					var update_not_where_executeWhereUndefinedLogic =
						function () {
							var _this = this;
					...
					var update_regex_executeRegexLogic = function (
						column,
						exp
					) {
						var _this = this;
						...
						var cursor;
						var cursorOpenRequest = this.objectStore
							.index(column)
							.openCursor();
					...
					var update_where_executeWhereLogic = function (
						column,
						value,
						op
					) {
					...
					var update_Update =
						...
						(function (_super) {
							...
							function Update(query, util) {
								...
								_this.executeRegexLogic =
									update_regex_executeRegexLogic;
								_this.executeWhereLogic =
									update_where_executeWhereLogic;
								_this.query = query;
								_this.util = util;
							...
							Update.prototype.execute = function (db) {
								...
								try {
									var queryHelper =
										new query_helper_QueryHelper(db);
									var err = queryHelper.validate(
										API.Update,
										query
									);
							...
							Update.prototype.executeComplexLogic_ =
								function () {
									var _this = this;
							...
							Update.prototype.initTransaction = function () {
								...
								this.objectStore =
									this.util.objectStore(tableName);
							};
							...
							DropDb.prototype.execute = function (dbName) {
								return promise(function (res, rej) {
									...
									dropDbRequest.onblocked = function () {
										var err = new log_helper_LogHelper(
					...
					var remove_Remove =
						...
						(function (_super) {
							...
							Remove.prototype.processWhereArrayQry =
								function () {
									var _this = this;
										...
										.then(function (results) {
											...
											var whereQry =
												...
												(_a[pkey] =
													...
													_b)),
												_a);
											_this.query[QUERY_OPTION.Where] =
												whereQry;
					...
					remove_Remove.prototype.executeInLogic = function (
						column,
						values
					) {
						var _this = this;
					...
					remove_Remove.prototype.executeWhereUndefinedLogic =
						function () {
							var _this = this;
					...
					remove_Remove.prototype.executeWhereLogic = function (
						column,
						value,
						op
					) {
					...
					remove_Remove.prototype.executeRegexLogic = function (
						column,
						exp
					) {
						var _this = this;
									...
									return promise(function (res, rej) {
										clearRequest.onsuccess = function () {
											...
											for (var columnName in currentTable.autoIncColumnValue) {
												currentTable.autoIncColumnValue[
													columnName
												] = 0;
											}

											meta_helper_MetaHelper
												.set(
													meta_helper_MetaHelper.dbSchema,
													db,
													_this.util
					...
					var transaction_Transaction =
						...
						(function (_super) {
							...
							Transaction.prototype.validate = function () {
								var query = this.query;
								var notExistingTable = this.notExistingTable_(
									query.tables
								);
							...
							Transaction.prototype.startExecution_ =
								function () {
									var _this = this;
							...
							Transaction.prototype.onReqFinished_ = function (
								result
							) {
								var finisehdRequest = this.reqQueue.shift();
								console.log(
									'finished request : ' +
										finisehdRequest.name +
										' '
								);
								...
								if (finisehdRequest) {
									if (result.error) {
										...
										console.log(
											'transaction aborted due to error occured'
										);
							...
							Transaction.prototype.abortTx_ = function (msg) {
								...
								this.util.abortTransaction();
								console.log(
									'transaction aborted. Msg : ' + msg
								);
							};

							Transaction.prototype.executeRequest_ = function (
								request
							) {
								...
								var onReqFinished =
									this.onReqFinished_.bind(this);
								var query = request.query;

								switch (request.name) {
									case API.Select:
										requestObj = new select_Select(
											query,
											this.util
										);
										break;
							...
							Transaction.prototype.pushReq_ = function (
								request
							) {
								var _this = this;
								...
								var promiseObj = promise(function (
									resolve,
									reject
								) {
							...
							Transaction.prototype.processExecutionOfQry_ =
								function () {
							...
							Transaction.prototype.notExistingTable_ = function (
								tables
							) {
								var _this = this;
					...
					var query_manager_QueryManager =
						...
						(function () {
							...
							QueryManager.prototype.run = function (request) {
								...
								switch (request.name) {
									case API.OpenDb:
										queryResult = this.openDb(
											request.query
										);
										break;

									case API.InitDb:
										queryResult = this.initDb(
											request.query
										);
										break;
									...
									case API.Intersect:
										queryResult = new intersect_Intersect(
											request.query,
											this.util
										).execute(this.db);
										break;
							...
							QueryManager.prototype.returnResult_ = function (
								result
							) {
								if (this.util) {
									this.util.emptyTx();
							...
							QueryManager.prototype.initDb = function (
								dataBase
							) {
								var _this = this;
