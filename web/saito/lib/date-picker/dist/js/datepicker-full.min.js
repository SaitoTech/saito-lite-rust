!(function () {
	...
	const A = new WeakMap(),
		{ addEventListener: Y, removeEventListener: H } = EventTarget.prototype;
	function j(e, t) {
		let i = A.get(e);
		i || ((i = []), A.set(e, i)),
			t.forEach((e) => {
	...
	function G(t, s) {
		...
		if (n.language) {
			...
			if (
				...
				h = a.language = e;
				const t = u || r[I];
				(u = Object.assign({ format: P, weekStart: q }, r[I])),
					h !== I && Object.assign(u, r[h]),
					(a.locale = u),
					o === t.format && (o = a.format = u.format),
					k === t.weekStart &&
						((k = a.weekStart = u.weekStart),
						(a.weekEnd = U(u.weekStart)));
			}
		}
		if (n.format) {
		...
		if (void 0 !== n.minDate) {
			const e = l(0, 0, 1);
			(b = null === n.minDate ? e : z(n.minDate, o, u, b)),
				b !== e && (b = w(b, m, !1)),
				delete n.minDate;
		}
		if (
			(void 0 !== n.maxDate &&
				((x = null === n.maxDate ? void 0 : z(n.maxDate, o, u, x)),
				void 0 !== x && (x = w(x, m, !0)),
				delete n.maxDate),
			x < b
				? ((g = a.minDate = x), (f = a.maxDate = b))
				: (g !== b && (g = a.minDate = b),
				  f !== x && (f = a.maxDate = x)),
			n.datesDisabled &&
		...
		if (void 0 !== n.weekStart) {
			...
			isNaN(e) || ((k = a.weekStart = e), (a.weekEnd = U(e))),
				delete n.weekStart;
		}
		if (
			(n.daysOfWeekDisabled &&
				((a.daysOfWeekDisabled = n.daysOfWeekDisabled.reduce(J, [])),
		...
		let M = p;
		void 0 !== n.maxView && ((M = X(n.maxView, p)), delete n.maxView),
			(M = m > M ? m : M),
			M !== p && (p = a.maxView = M);
		let S = y;
		if (
			(void 0 !== n.startView &&
				((S = X(n.startView, S)), delete n.startView),
			S < m ? (S = m) : S > p && (S = p),
			S !== y && (a.startView = S),
			n.prevArrow)
		) {
	...
	function me(e, t) {
		...
		n
			...
			: le(e, Number(1 === s ? i.dataset.month : i.dataset.year));
	}
	function we(e) {
		e.preventDefault();
	}
	...
	function be(e, t) {
		...
		switch (
			((e.viewDate = t),
			o !== i.getFullYear() && re(e.datepicker, 'changeYear'),
			s.getMonth() !== i.getMonth() && re(e.datepicker, 'changeMonth'),
			n)
		) {
			case 0:
				return t < r || t > d;
	...
	class Se {
		...
		place() {
			...
			let D = 0,
				y = 0,
				{ clientWidth: k, clientHeight: v } = document.documentElement;
			if (w) {
				const e = w.getBoundingClientRect();
				e.top > 0 && (y = e.top),
					e.left > 0 && (D = e.left),
					e.right < k && (k = e.right),
					e.bottom < v && (v = e.bottom);
			}
			let b = 0;
			'auto' === f &&
				(d < D
				...
				'right' === f && (g += h - a),
				(g += b),
				'auto' === p && (p = o - r > y && l + r > v ? 'top' : 'bottom'),
				'top' === p ? (m -= r) : (m += u),
	...
	function Ce(e, t, i, s, a, r) {
		if (n(e, a, r)) {
			if (s(e)) {
				return Ce(t(e, i), t, i, s, a, r);
			}
			return e;
		}
	}
	function Oe(e, t, i, s) {
		...
		(c = Ce(c, d, i < 0 ? -r : r, o, a.minDate, a.maxDate)),
	...
	function He(e, t, i) {
		...
		(d || r) &&
			(d && d.toString() !== e.dates.toString()
				? ((e.dates = d), Ye(e, n ? 3 : 1), re(e, 'changeDate'))
				: Ye(e, 1),
			a && e.hide());
	}
	class je {
		constructor(e, t = {}, i) {
			...
			o && o.length > 0 && (this.dates = o),
				r && (r.value = Be(this.dates, n));
			const l = (this.picker = new Se(this));
			if (a) this.show();
			else {
				const e = We.bind(null, this);
				j(this, [
	...
	function Ke(e, t) {
		...
		void 0 !== d && void 0 !== o
			...
			: e.allowOneSidedRange ||
			  (void 0 === d && void 0 === o) ||
			  ((n.clear = !0), s[r].setDate(s[a].dates, n)),
		...
		(window.DateRangePicker = class {
			constructor(e, t = {}) {
				...
				Object.defineProperty(this, 'datepickers', { get: () => a }),
					...
					Object.freeze(a),
					a[0].dates.length > 0
						? Ke(this, { target: this.inputs[0] })
						: a[1].dates.length > 0 &&
						  Ke(this, { target: this.inputs[1] });
			}
			get dates() {
			...
			getDates(e) {
				const t = e
					? (t) => O(t, e, this.datepickers[0].config.locale)
					: (e) => new Date(e);
