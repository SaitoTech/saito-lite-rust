...
!(function () {
	...
	function Pt(t, a) {
		var e = a.split('-'),
			a = e[0],
			e = e.slice(1).join('-');
		return a !== t || '' === e || ~_.indexOf(e) ? null : e;
	}
	function St() {
		function t(n) {
			return mt(
		...
		var i = 'far' in gt || B.autoFetchSvg,
			a = mt(
				ht,
				function (t, a) {
					var e = a[0],
		...
		(At = a.names), (Ot = a.unicodes), (kt = It(B.styleDefault));
	}
	function Et(t, a) {
		return (wt[t] || {})[a];
	}
			...
			t = t.reduce(function (t, a) {
				...
				return (
					gt[a]
						...
						: e
						? (t.iconName = e)
						: a !== B.replacementClass && t.rest.push(a),
					!n &&
						t.prefix &&
						t.iconName &&
						((e = 'fa' === i ? jt(t.iconName) : {}),
						(a = zt(t.prefix, t.iconName)),
						e.prefix && (i = null),
	...
	function Wt(t) {
		...
		if (a)
			return (
				(a = zt(t, a) || a),
				ut(_t.definitions, t, a) || ut(ot.styles, t, a)
			);
	}
	var _t = new c(),
		Ut = {
					...
					if (Array.isArray(t) && 2 === t.length) {
						var a =
								0 === t[1].indexOf('fa-')
									...
									: t[1],
							e = It(t[0]);
						return { prefix: e, iconName: zt(e, a) || a };
					}
					if (
						'string' == typeof t &&
						(-1 < t.indexOf(''.concat(B.familyPrefix, '-')) ||
							t.match(R))
					) {
						a = Lt(t.split(' '), { skipLookups: !0 });
						return {
							prefix: a.prefix || kt,
							iconName: zt(a.prefix, a.iconName) || a.iconName
						};
					}
					return 'string' == typeof t
						? { prefix: kt, iconName: zt(kt, t) || t }
						: void 0;
				}
			},
			library: _t,
		...
		Xt = function () {
			var t = (
				...
				t = void 0 === t ? h : t;
			(0 < Object.keys(ot.styles).length || B.autoFetchSvg) &&
				p &&
				B.autoReplaceSvg &&
				Ut.dom.i2svg({ node: t });
		};
	...
	function qt(t) {
		var a = t.icons,
			...
			b = [
				B.replacementClass,
				r ? ''.concat(B.familyPrefix, '-').concat(r) : ''
			]
				.filter(function (t) {
	...
	var ta =
			B.measurePerformance && u && u.mark && u.measure
				? u
				: { mark: Zt, measure: Zt },
		aa = 'FA "6.1.2"',
		ea = {
	...
	var sa = {
		replace: function (t) {
			...
			a.parentNode &&
				...
				null === a.getAttribute(A) && B.keepOriginalSource
					? ((t = h.createComment(
		...
		nest: function (t) {
			var a = t[0],
				e = t[1];
			if (~Z(a).indexOf(B.replacementClass)) return sa.replace(t);
			var n = new RegExp(''.concat(B.familyPrefix, '-.*'));
			delete e[0].attributes.id,
				e[0].attributes.class &&
					((t = e[0].attributes.class.split(' ').reduce(
						function (t, a) {
							return (
								(a === B.replacementClass || a.match(n)
									? t.toSvg
									: t.toNode
								).push(a),
								t
	...
	function fa(e, t) {
		...
		0 === e.length
			? n()
			: (B.mutateApproach === E ? g.requestAnimationFrame || ca : ca)(
					function () {
						var t =
								(!0 !== B.autoReplaceSvg &&
									sa[B.autoReplaceSvg]) ||
				...
				la ||
					...
					Q(t).forEach(function (t) {
						...
						'childList' === t.type &&
							...
							!ia(t.addedNodes[0]) &&
							(B.searchPseudoElements && s(t.target),
							r(t.target)),
							'attributes' === t.type &&
								t.target.parentNode &&
			...
			(i.iconName && i.prefix) ||
				(i.prefix &&
					...
					(i.iconName =
						((e = i.prefix),
						(n = t.innerText),
						(xt[e] || {})[n] || Et(i.prefix, bt(t.innerText)))),
				!i.iconName &&
					B.autoFetchSvg &&
					t.firstChild &&
	...
	function ha(t) {
		var a =
			'nest' === B.autoReplaceSvg ? pa(t, { styleParser: !1 }) : pa(t);
	...
	function ya(t) {
		...
		var a = h.documentElement.classList,
			e = B.autoFetchSvg ? Object.keys(M) : Object.keys(ga);
		e.includes('fa') || e.push('fa');
		var o = ['.'.concat(T, ':not([').concat(A, '])')]
			.concat(
				e.map(function (t) {
	...
	function wa(t) {
		...
		if (t) {
			var m = t.prefix,
				d = t.iconName,
				b = t.icon;
			return Bt(k({ type: 'icon' }, t), function () {
				return (
				...
				return {
					counter: function (i) {
						var r =
							...
							t = r.styles,
							f = void 0 === t ? {} : t;
						return Bt({ type: 'counter', content: i }, function () {
							return (
								Ft('beforeDOMElementCreation', {
									content: i,
									params: r
	...
	(Ma = { mixoutsTo: Ut }.mixoutsTo),
			...
			u,
			{
				...
				provides: function (t) {
					t.pseudoElements2svg = function (t) {
						t = t.node;
						B.searchPseudoElements && Pa(void 0 === t ? h : t);
					};
				}
			},
			{
		...
		(function (t) {
			...
			v &&
				(g.FontAwesome || (g.FontAwesome = Ut),
				ft(function () {
					Xt(), Ft('bootstrap');
				})),
				(ot.hooks = k(
					...
					{},
					{
						...
						addShims: function (t) {
							var a;
							(a = ot.shims).push.apply(a, l(t)), St(), Xt();
						}
					}
				));
		});
