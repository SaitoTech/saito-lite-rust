...
!(function () {
	...
	function C(h) {
		for (var c = 1; c < arguments.length; c++) {
			...
			c % 2
				? v(Object(m), !0).forEach(function (c) {
						var z, l;
						(z = h),
							(c = m[(l = c)]),
							l in z
