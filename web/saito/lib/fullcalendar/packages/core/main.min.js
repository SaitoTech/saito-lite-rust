...
!(function (e, t) {
	...
	function r(e, n, r) {
		...
		return (
			'string' == typeof r ? (i.innerHTML = r) : null != r && s(i, r), i
		);
	}
	function i(e) {
		e = e.trim();
		...
		tn = (function (e) {
			...
			return (
				...
				(t.prototype.on = function (e, t) {
					return (
						nn(this._handlers || (this._handlers = {}), e, t), this
					);
				}),
		...
		ln = (function (e) {
			function t(t, n) {
				var i =
					...
					this;
				return (
					(i.overflowX = t), (i.overflowY = n), i.applyOverflow(), i
				);
			}
			return (
				Ee(t, e),
