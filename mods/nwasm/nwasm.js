  ...
  deleteRoms() {
    ...
    /*
        let message = {};
            ...
            message.data.publickey = this.app.wallet.publicKey;

      let newtx = this.app.wallet.createUnsignedTransaction(this.app.wallet.publicKey, BigInt(0), BigInt(0));
      newtx.msg = message;
      ...
      if (x.indexOf("Name: ") == 0) {
        ...
        if (this.active_rom_name.indexOf(x.trim().substring(0, len)) != 0) {
          ...
          if (this.uploaded_rom == false && this.active_rom_name !== "") {
            ...
            for (let item in this.libraries[this.app.wallet.publicKey]) {
