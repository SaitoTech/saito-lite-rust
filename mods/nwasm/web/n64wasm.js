...
// HACK
//
// this tracks whether the user is interacting with a UI component shown
// by Saito. if this variable is TRUE then we want to disable the default
// UI events that emscripten creates.
//
var SAITO_COMPONENT_ACTIVE = false;
var SAITO_COMPONENT_ACTIVE_ID = '';
var SAITO_COMPONENT_CLICKED = false;

document.onclick = (e) => {
	let ect = event.currentTarget;
	let et = event.target;
	let active_id = 'canvas';
	if (ect.id !== 'undefined') {
		active_id = ect.id;
	}
	if (et.id !== 'undefined') {
...
document.onkeydown = (event) => {
	//
	// HACK - 'enter' de-activates chat, but only if we didn't click on it to start typing
	// if we actually clicked to put our cursor in that box, we remain active on the input
	// until the user clicks away manually.
	//
	...
	//
	// HACK - if we are interacting with a Saito component, we skip out
	// before the code below so as to prevent the in-game events from
	// triggering.
	//
	if (SAITO_COMPONENT_ACTIVE == true || SAITO_COMPONENT_CLICKED == true) {
		let e = event.keyCode;
		if (
			e < 8 ||
			(e > 8 && e < 32) ||
			...
			if (e == 46 || e == 8) {
				let msg = document
					.getElementById(SAITO_COMPONENT_ACTIVE_ID)
					.value.toString();
				if (msg.length > 0) {
					msg = msg.substring(0, msg.length - 1);
					document.getElementById(SAITO_COMPONENT_ACTIVE_ID).value =
						msg;
				}
			} else {
				document.getElementById(SAITO_COMPONENT_ACTIVE_ID).value +=
...
var DYNAMIC_BASE = 155650864,
	DYNAMICTOP_PTR = 150407824;
...
var wasmBinaryFile = 'n64wasm.wasm';
...
var ASM_CONSTS = {
	...
	132438: function ($0, $1) {
		...
		for (var c = 0; c < numChannels; ++c) {
			var channelData =
				SDL2.capture.currentCaptureBuffer.getChannelData(c);
	...
	133043: function ($0, $1) {
		...
		for (var c = 0; c < numChannels; ++c) {
			var channelData =
				SDL2.audio.currentOutputBuffer['getChannelData'](c);
			if (channelData.length != $1) {
				throw (
...
var ___tm_current = 150407840;
var ___tm_timezone = (stringToUTF8('GMT', 150407888, 4), 150407888);
function _tzset() {
...
var asmLibraryArg = {
	...
	Va: _eglCreateWindowSurface,
	Ua: _eglDestroyContext,
	Wa: _eglDestroySurface,
	fb: _eglGetConfigAttrib,
	ga: _eglGetDisplay,
	Sa: _eglGetError,
	bb: _eglGetProcAddress,
	cb: _eglInitialize,
	Xa: _eglMakeCurrent,
	Ra: _eglQueryString,
	Ya: _eglSwapBuffers,
	...
	Wg: _emscripten_exit_fullscreen,
	Qa: _emscripten_exit_pointerlock,
	...
	yg: _emscripten_glBeginQueryEXT,
	...
	Ag: _emscripten_glDeleteQueriesEXT,
	...
	ub: _emscripten_glDrawArraysInstancedARB,
	...
	sb: _emscripten_glDrawElementsInstancedARB,
	tb: _emscripten_glDrawElementsInstancedEXT,
	...
	ug: _emscripten_glGetQueryObjectivEXT,
	...
	vg: _emscripten_glGetQueryivEXT,
	...
	wg: _emscripten_glQueryCounterEXT,
	...
	Qb: _emscripten_glSamplerParameterf,
	...
	Ld: _emscripten_glUseProgram,
	Kd: _emscripten_glValidateProgram,
	...
	Xg: _emscripten_request_fullscreen_strategy,
	fa: _emscripten_request_pointerlock,
	Eg: _emscripten_resize_heap,
	xa: _emscripten_sample_gamepad_data,
	ya: _emscripten_set_beforeunload_callback_on_thread,
	...
	Ga: _emscripten_set_touchcancel_callback_on_thread,
	Ia: _emscripten_set_touchend_callback_on_thread,
	Ha: _emscripten_set_touchmove_callback_on_thread,
	...
	n: _glActiveTexture,
	I: _glAttachShader,
	y: _glBindAttribLocation,
	u: _glBindBuffer,
	ia: _glBindFramebuffer,
	m: _glBindTexture,
	D: _glBlendFunc,
	V: _glBlendFuncSeparate,
	W: _glBufferData,
	Sb: _glBufferSubData,
	S: _glClear,
	E: _glClearColor,
...
var _malloc = (Module['_malloc'] = function () {
	return (_malloc = Module['_malloc'] = Module['asm']['_g']).apply(
		null,
		arguments
	);
});
...
var _neil_serialize = (Module['_neil_serialize'] = function () {
	return (_neil_serialize = Module['_neil_serialize'] =
		Module['asm']['bh']).apply(null, arguments);
});
var _neil_toast_message = (Module['_neil_toast_message'] = function () {
	return (_neil_toast_message = Module['_neil_toast_message'] =
		Module['asm']['ch']).apply(null, arguments);
});
var _neil_export_eep = (Module['_neil_export_eep'] = function () {
	return (_neil_export_eep = Module['_neil_export_eep'] =
		Module['asm']['dh']).apply(null, arguments);
});
var _neil_export_sra = (Module['_neil_export_sra'] = function () {
	return (_neil_export_sra = Module['_neil_export_sra'] =
		Module['asm']['eh']).apply(null, arguments);
});
var _neil_export_fla = (Module['_neil_export_fla'] = function () {
	return (_neil_export_fla = Module['_neil_export_fla'] =
		Module['asm']['fh']).apply(null, arguments);
});
var _neil_unserialize = (Module['_neil_unserialize'] = function () {
	return (_neil_unserialize = Module['_neil_unserialize'] =
		Module['asm']['gh']).apply(null, arguments);
});
var _neil_reset = (Module['_neil_reset'] = function () {
	return (_neil_reset = Module['_neil_reset'] = Module['asm']['hh']).apply(
		null,
		arguments
	);
});
var _neilGetSoundBufferResampledAddress = (Module[
	'_neilGetSoundBufferResampledAddress'
] = function () {
	return (_neilGetSoundBufferResampledAddress = Module[
		'_neilGetSoundBufferResampledAddress'
	] =
		Module['asm']['ih']).apply(null, arguments);
});
var _neilGetAudioWritePosition = (Module['_neilGetAudioWritePosition'] =
	function () {
		return (_neilGetAudioWritePosition = Module[
			'_neilGetAudioWritePosition'
		] =
			Module['asm']['jh']).apply(null, arguments);
	});
var _main = (Module['_main'] = function () {
	return (_main = Module['_main'] = Module['asm']['kh']).apply(
		null,
		arguments
	);
});
var _runMainLoop = (Module['_runMainLoop'] = function () {
	return (_runMainLoop = Module['_runMainLoop'] = Module['asm']['lh']).apply(
		null,
		arguments
	);
});
var _toggleFPS = (Module['_toggleFPS'] = function () {
	return (_toggleFPS = Module['_toggleFPS'] = Module['asm']['mh']).apply(
		null,
		arguments
	);
});
...
var dynCall_vi = (Module['dynCall_vi'] = function () {
	return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['vh']).apply(
		null,
		arguments
	);
});
...
var dynCall_iii = (Module['dynCall_iii'] = function () {
	return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['xh']).apply(
		null,
		arguments
	);
});
var dynCall_iiii = (Module['dynCall_iiii'] = function () {
	return (dynCall_iiii = Module['dynCall_iiii'] = Module['asm']['yh']).apply(
		null,
		arguments
	);
});
...
var dynCall_v = (Module['dynCall_v'] = function () {
	return (dynCall_v = Module['dynCall_v'] = Module['asm']['Ah']).apply(
		null,
		arguments
	);
});
...
var dynCall_viii = (Module['dynCall_viii'] = function () {
	return (dynCall_viii = Module['dynCall_viii'] = Module['asm']['Ch']).apply(
		null,
		arguments
	);
});
...
var dynCall_ii = (Module['dynCall_ii'] = function () {
	return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Hh']).apply(
		null,
		arguments
	);
});
...
var dynCall_jiji = (Module['dynCall_jiji'] = function () {
	return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['Oh']).apply(
		null,
		arguments
	);
});
var dynCall_ji = (Module['dynCall_ji'] = function () {
	return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['Ph']).apply(
		null,
		arguments
	);
});
...
var dynCall_vf = (Module['dynCall_vf'] = function () {
	return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['ai']).apply(
		null,
		arguments
	);
});
...
var dynCall_vff = (Module['dynCall_vff'] = function () {
	return (dynCall_vff = Module['dynCall_vff'] = Module['asm']['di']).apply(
		null,
		arguments
	);
});
var dynCall_vfi = (Module['dynCall_vfi'] = function () {
	return (dynCall_vfi = Module['dynCall_vfi'] = Module['asm']['ei']).apply(
		null,
		arguments
	);
});
var dynCall_viif = (Module['dynCall_viif'] = function () {
	return (dynCall_viif = Module['dynCall_viif'] = Module['asm']['fi']).apply(
		null,
		arguments
	);
});
var dynCall_vif = (Module['dynCall_vif'] = function () {
	return (dynCall_vif = Module['dynCall_vif'] = Module['asm']['gi']).apply(
		null,
		arguments
	);
});
var dynCall_viff = (Module['dynCall_viff'] = function () {
	return (dynCall_viff = Module['dynCall_viff'] = Module['asm']['hi']).apply(
		null,
		arguments
	);
});
