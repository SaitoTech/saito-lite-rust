 ...
 * @constructor
 */
cycloa.VirtualMachine = function (
	videoFairy,
	audioFairy,
	pad1Fairy,
	pad2Fairy
...
cycloa.VirtualMachine.prototype.run = function () {
	...
	while (__vm__run) {
		...
		if (this.NMI) {
			...
			__vm__clockDelta += 7;
			this.P &= 239;
			/* ::CPU::Push */ __cpu__ram[0x0100 | (this.SP-- & 0xff)] =
				this.PC >> 8;
			...
			this.PC =
				this.__cpu__rom[31][0x3fa] | (this.__cpu__rom[31][0x3fb] << 8);
			this.NMI = false;
		} else if (this.IRQ) {
			this.onIRQ();
			//from http://crystal.freespace.jp/pgate1/nes/nes_cpu.htm
			...
			if ((this.P & 4) !== 4) {
				...
				this.PC =
					this.__cpu__rom[31][0x3fe] |
					(this.__cpu__rom[31][0x3ff] << 8);
			}
		}
			...
			if (__cpu__pc === 0x4015) {
			   ...
			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
				...
				throw new cycloa.err.CoreException(
					'[FIXME] Invalid addr: 0x' + __cpu__pc.toString(16)
				);
			} else {
		...
		case 4: {
			/* 0x8000 -> 0xA000 */
			__cpu__opbyte =
					__cpu__rom[(__cpu__pc >> 10) & 31][__cpu__pc & 0x3ff];
			break;
		}
		case 5: {
			/* 0xA000 -> 0xC000 */
		...
		case 1: {
			...
			case 4: {
				/* 0x8000 -> 0xA000 */
				__cpu__addr =
							__cpu__rom[(__cpu__addr_base >> 10) & 31][
								__cpu__addr_base & 0x3ff
							];
				break;
			}
			case 5: {
		...
		case 2: {
			...
			case 1: {
				/* 0x2000 -> 0x4000 */
				__cpu__addr_base =
							this.__video__readReg(__cpu__addr_base);
				break;
			}
			case 2: {
				/* 0x4000 -> 0x6000 */
		...
		case 4: {
			...
			case 0: {
				/* 0x0000 -> 0x2000 */
				__cpu__addr_base1 =
							__cpu__ram[__cpu__addr_base1 & 0x7ff];
				break;
			}
			case 1: {
				/* 0x2000 -> 0x4000 */
				__cpu__addr_base1 =
							this.__video__readReg(__cpu__addr_base1);
				break;
			}
			case 2: {
				/* 0x4000 -> 0x6000 */
			...
			case 4: {
				/* 0x8000 -> 0xA000 */
				__cpu__addr_base1 =
							__cpu__rom[(__cpu__addr_base1 >> 10) & 31][
								__cpu__addr_base1 & 0x3ff
							];
				break;
			}
			case 5: {
			...
			case 0: {
				/* 0x0000 -> 0x2000 */
				__cpu__addr_base2 =
							__cpu__ram[__cpu__addr_base2 & 0x7ff];
				break;
			}
			case 1: {
				/* 0x2000 -> 0x4000 */
				__cpu__addr_base2 =
							this.__video__readReg(__cpu__addr_base2);
				break;
			}
			case 2: {
				/* 0x4000 -> 0x6000 */
			...
			case 4: {
				/* 0x8000 -> 0xA000 */
				__cpu__addr_base2 =
							__cpu__rom[(__cpu__addr_base2 >> 10) & 31][
								__cpu__addr_base2 & 0x3ff
							];
				break;
			}
			case 5: {
		...
		case 5: {
			...
			/**
				 ...
				 */
			var __cpu__addr =
					(__cpu__addr_base1 | (__cpu__addr_base2 << 8)) + this.X;
			if (((__cpu__addr ^ __cpu__addr_base) & 0x0100) !== 0)
				__vm__clockDelta += 1;
		...
		case 6: {
			...
			/**
				 ...
				 */
			var __cpu__addr =
					(__cpu__addr_base1 | (__cpu__addr_base2 << 8)) + this.Y;
			if (((__cpu__addr ^ __cpu__addr_base) & 0x0100) !== 0)
				__vm__clockDelta += 1;
		...
		case 7: {
			...
			var __cpu__addr_base3 =
					__cpu__addr_base1 | (__cpu__addr_base2 << 8);
			...
			case 0: {
				/* 0x0000 -> 0x2000 */
				__cpu__addr_base4 =
							__cpu__ram[__cpu__addr_base3 & 0x7ff];
				break;
			}
			case 1: {
				/* 0x2000 -> 0x4000 */
				__cpu__addr_base4 =
							this.__video__readReg(__cpu__addr_base3);
				break;
			}
			case 2: {
				/* 0x4000 -> 0x6000 */
			...
			case 4: {
				/* 0x8000 -> 0xA000 */
				__cpu__addr_base4 =
							__cpu__rom[(__cpu__addr_base3 >> 10) & 31][
								__cpu__addr_base3 & 0x3ff
							];
				break;
			}
			case 5: {
			...
			var __cpu__addr_base5 =
					(__cpu__addr_base3 & 0xff00) |
					((__cpu__addr_base3 + 1) & 0x00ff); /* bug of NES */

			switch ((__cpu__addr_base5 & 0xe000) >> 13) {
			case 0: {
				/* 0x0000 -> 0x2000 */
				__cpu__addr_base5 =
							__cpu__ram[__cpu__addr_base5 & 0x7ff];
				break;
			}
			case 1: {
				/* 0x2000 -> 0x4000 */
				__cpu__addr_base5 =
							this.__video__readReg(__cpu__addr_base5);
				break;
			}
			case 2: {
				/* 0x4000 -> 0x6000 */
			...
			case 4: {
				/* 0x8000 -> 0xA000 */
				__cpu__addr_base5 =
							__cpu__rom[(__cpu__addr_base5 >> 10) & 31][
								__cpu__addr_base5 & 0x3ff
							];
				break;
			}
			case 5: {
		...
		case 8: {
			...
			/**
				 ...
				 */
			var __cpu__addr =
					__cpu__ram[__cpu__addr_base] |
					(__cpu__ram[(__cpu__addr_base + 1) & 0xff] << 8);
		...
		case 10: {
			...
			/**
				 ...
				 */
			var __cpu__addr =
					(__cpu__addr_base >= 128
						? __cpu__addr_base - 256
						: __cpu__addr_base) +
					__cpu__pc +
					2;
		...
		case 0: {
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = tmpA)];
			break;
		}
		case 1: {
			/* LDX */
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.X = tmpX)];
			break;
		}
		case 2: {
			/* LDY */
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.Y = tmpY)];
			break;
		}
		case 3: {
			/* STA */
			switch ((__cpu__addr & 0xe000) >> 13) {
			case 0: {
				/* 0x0000 -> 0x2000 */ __cpu__ram[
					__cpu__addr & 0x1fff
				] = this.A;
				break;
			}
			case 1: {
				/* 0x2000 -> 0x4000 */ this.__video__writeReg(
					__cpu__addr,
					this.A
				);
				break;
			...
			case 2: {
				...
				case 0x3: {
					...
					this.__rectangle0__lengthCounter =
									this.__audio__LengthCounterConst[
										this.A >> 3
									];
				...
				case 0x4: {
					/* 4004h - APU Volume/Decay Channel 2 (Rectangle) */ this.__rectangle1__decayCounter =
									this.__rectangle1__volumeOrDecayRate =
										this.A & 15;
					this.__rectangle1__decayEnabled =
									(this.A & 16) == 0;
				...
				case 0xa: {
					/* 400Ah - APU Frequency Channel 3 (Triangle) */ this.__triangle__frequency =
									(this.__triangle__frequency & 0x0700) |
									this.A;
					break;
				}
				case 0xb: {
				...
				case 0xe: {
					...
					this.__noize__frequency =
									this.__noize__FrequencyTable[this.A & 15];
					break;
				}
				case 0xf: {
				...
				case 0x14: {
					...
					var __video__spriteAddr =
									this.__video__spriteAddr;
					for (var i = 0; i < 256; ++i) {
						var __audio__dma__addr__ =
										__audio__dma__addrMask | i;
						var __audio_dma__val;
						switch (
							(__audio__dma__addr__ & 0xe000) >>
										13
						) {
						case 0: {
							/* 0x0000 -> 0x2000 */ __audio_dma__val =
												__cpu__ram[
													__audio__dma__addr__ & 0x7ff
												];
							break;
						}
						case 1: {
							/* 0x2000 -> 0x4000 */ __audio_dma__val =
												this.__video__readReg(
													__audio__dma__addr__
												);
							break;
						}
						case 2: {
							/* 0x4000 -> 0x6000 */ if (
								...
								/* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */ __audio_dma__val =
													(this
														.__rectangle0__lengthCounter !=
														0 &&
													this
														.__rectangle0__frequency >=
														0x8 &&
													this
														.__rectangle0__frequency <
														0x800
														...
														: 0) |
													(this
														.__rectangle1__lengthCounter !=
														0 &&
													this
														.__rectangle1__frequency >=
														0x8 &&
													this
														.__rectangle1__frequency <
														0x800
														...
														: 0) |
													(this
														.__triangle__lengthCounter !=
														0 &&
													this
														.__triangle__linearCounter !=
														0
														? 4
														: 0) |
													(this
														.__noize__lengthCounter !=
													0
														? 8
														: 0) |
													(this
														.__digital__sampleLength !=
													0
														? 16
														: 0) |
													(this.IRQ & 1 ? 64 : 0) |
								...
								__audio__dma__addr__ === 0x4016
							) {
								__audio_dma__val =
													(this.__pad__pad1Fairy
														.state >>
														(this.__pad__pad1Idx++ &
															7)) &
													0x1;
							} else if (
								__audio__dma__addr__ === 0x4017
							) {
								__audio_dma__val =
													(this.__pad__pad2Fairy
														.state >>
														(this.__pad__pad2Idx++ &
															7)) &
													0x1;
								...
								throw new cycloa.err.CoreException(
									'[FIXME] Invalid addr: 0x' +
														__audio__dma__addr__.toString(
															16
														)
								);
							} else {
								__audio_dma__val =
													this.readMapperRegisterArea(
														addr
													);
							}
							break;
				...
				/* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
					/* __audio__analyzeStatusRegister */ if (
						!(this.A & 1)
					)
						this.__rectangle0__lengthCounter = 0;
					if (!(this.A & 2))
				...
				default: {
					/* this.writeMapperRegisterArea(__cpu__addr, this.A); */ break;
				}
				}
				break;
			}
			...
			case 4: {
				/* 0x8000 -> 0xA000 */ this.writeMapperCPU(
					__cpu__addr,
					this.A
				);
				break;
			...
			case 5: {
				/* 0xA000 -> 0xC000 */ this.writeMapperCPU(
					__cpu__addr,
					this.A
				);
				break;
			...
			case 6: {
				/* 0xC000 -> 0xE000 */ this.writeMapperCPU(
					__cpu__addr,
					this.A
				);
				break;
			...
			case 7: {
				/* 0xE000 -> 0xffff */ this.writeMapperCPU(
					__cpu__addr,
					this.A
				);
				break;
			...
			case 2: {
				...
				case 0xe: {
					/* 400Eh - APU Frequency Channel 4 (Noise) */ this.__noize__modeFlag =
									(this.X & 128) == 128;
					this.__noize__frequency =
									this.__noize__FrequencyTable[this.X & 15];
					break;
				}
				case 0xf: {
					/* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
				...
				default: {
					/* this.writeMapperRegisterArea(__cpu__addr, this.X); */ break;
				}
				}
				break;
			}
			...
			case 2: {
				...
				case 0xe: {
					/* 400Eh - APU Frequency Channel 4 (Noise) */ this.__noize__modeFlag =
									(this.Y & 128) == 128;
					this.__noize__frequency =
									this.__noize__FrequencyTable[this.Y & 15];
					break;
				}
				case 0xf: {
					/* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
				...
				default: {
					/* this.writeMapperRegisterArea(__cpu__addr, this.Y); */ break;
				}
				}
				break;
			}
		...
		case 6: {
			/* TAX */
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.X = this.A)];
			break;
		}
		case 7: {
			/* TAY */
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.Y = this.A)];
			break;
		}
		case 8: {
			/* TSX */
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.X = this.SP)];
			break;
		}
		case 9: {
			/* TXA */
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = this.X)];
			break;
		}
		case 10: {
			/* TXS */
		...
		case 11: {
			/* TYA */
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.A = this.Y)];
			break;
		}
		case 12: {
			/* ADC */
			...
			/**
				 * @type {number}
				 */
			var __cpu__adc_result =
					(__cpu__adc_a + __cpu__adc_val + (__cpu__adc_p & 0x1)) &
					0xffff;
				/**
				 * @type {number}
				 */
			...
			this.P =
					(__cpu__adc_p & 0xbe) |
					(((((__cpu__adc_a ^ val) & 0x80) ^ 0x80) &
						((__cpu__adc_a ^ __cpu__adc_newA) & 0x80)) >>
						1) | //set V flag //いまいちよくわかってない（
					((__cpu__adc_result >> 8) & 0x1); //set C flag
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) |
					__cpu__ZNFlagCache[(this.A = __cpu__adc_newA)];
			break;
		}
		case 13: {
			/* AND */
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.A &= mem)];
			break;
		}
		case 14: {
			/* ASL */
			...
			case 2: {
				...
				case 0xe: {
					/* 400Eh - APU Frequency Channel 4 (Noise) */ this.__noize__modeFlag =
									(shifted & 128) == 128;
					this.__noize__frequency =
									this.__noize__FrequencyTable[shifted & 15];
					break;
				}
				case 0xf: {
					/* 400Fh - APU Length Channel 4 (Noise) */ /* Writing to the length registers restarts the length (obviously), */ this.__noize__lengthCounter =
				...
				default: {
					/* this.writeMapperRegisterArea(__cpu__addr, shifted); */ break;
				}
				}
				break;
			}
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[shifted & 0xff];
			break;
		}
		case 15: {
			/* ASL_ */
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) |
					__cpu__ZNFlagCache[(this.A = (a << 1) & 0xff)];
			break;
		}
		case 16: {
			/* BIT */
		...
		case 17: {
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[val & 0xff];
		...
		case 20: {
			...
			var val = (mem - 1) & 0xff;
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[val];
			switch ((__cpu__addr & 0xe000) >> 13) {
			case 0: {
				/* 0x0000 -> 0x2000 */ __cpu__ram[
					__cpu__addr & 0x1fff
			...
			case 2: {
				...
				default: {
					/* this.writeMapperRegisterArea(__cpu__addr, val); */ break;
				}
				}
				break;
			}
		...
		case 21: {
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) |
					__cpu__ZNFlagCache[(this.X = (this.X - 1) & 0xff)];
			break;
		}
		case 22: {
			/* DEY */
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) |
					__cpu__ZNFlagCache[(this.Y = (this.Y - 1) & 0xff)];
			break;
		}
		case 23: {
			/* EOR */
		...
		case 27: {
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[shifted];
			break;
		}
		case 28: {
			/* LSR_ */
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) | __cpu__ZNFlagCache[(this.A >>= 1)];
			break;
		}
		case 29: {
			/* ORA */
		...
		case 31: {
			...
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) |
					__cpu__ZNFlagCache[(this.A = (a << 1) | (p & 0x01))];
			break;
		}
		case 32: {
			/* ROR */
		...
		case 34: {
			...
			/**
				 * @type {number}
				 */
			var __cpu__sbc_result =
					(__cpu__sbc_a -
						__cpu__sbc_val -
						((__cpu__sbc_p & 0x1) ^ 0x1)) &
					0xffff;
				/**
				 * @type {number}
				 */
			...
			this.P =
					(__cpu__sbc_p & 0xbe) |
					(((__cpu__sbc_a ^ __cpu__sbc_val) &
						(__cpu__sbc_a ^ __cpu__sbc_newA) &
						0x80) >>
						1) | //set V flag //いまいちよくわかってない（
					(((__cpu__sbc_result >> 8) & 0x1) ^ 0x1);
			/* UpdateFlag */ this.P =
					(this.P & 0x7d) |
					__cpu__ZNFlagCache[(this.A = __cpu__sbc_newA)];
			break;
		}
		case 35: {
			/* PHA */
		...
		case 38: {
			...
			/**
				 ...
				 */
			var val =
			/* ::CPU::Pop */ __cpu__ram[0x0100 | (++this.SP & 0xff)];
		...
		case 51: {
			...
			/* ::CPU::Push */ __cpu__ram[0x0100 | (this.SP-- & 0xff)] =
					__cpu__jsr_stored_pc >> 8;
			/* ::CPU::Push */ __cpu__ram[0x0100 | (this.SP-- & 0xff)] =
					__cpu__jsr_stored_pc;
			this.PC = __cpu__addr;
			break;
		}
		case 52: {
			...
			if (!(this.P & 0x1)) {
				__vm__clockDelta +=
						((this.PC ^ __cpu__addr) & 0x0100) !== 0 ? 2 : 1;
				this.PC = __cpu__addr;
			}
			break;
		}
...
cycloa.VirtualMachine.prototype.write = function (addr, val) {
	...
	switch ((addr & 0xe000) >> 13) {
	case 0: {
		/* 0x0000 -> 0x2000 */ __cpu__ram[addr & 0x1fff] = val;
		break;
	}
	case 1: {
		/* 0x2000 -> 0x4000 */ this.__video__writeReg(addr, val);
		break;
	}
	case 2: {
		/* 0x4000 -> 0x6000 */ switch (addr & 0x1f) {
		case 0x0: {
			/* 4000h - APU Volume/Decay Channel 1 (Rectangle) */ this.__rectangle0__decayCounter =
		...
		/* ------------------------------ CTRL -------------------------------------------------- */ case 0x15: {
			/* __audio__analyzeStatusRegister */ if (!(val & 1))
				this.__rectangle0__lengthCounter = 0;
		...
		default: {
			/* this.writeMapperRegisterArea(addr, val); */ break;
		}
		}
		break;
	}
	...
	case 4: {
		/* 0x8000 -> 0xA000 */ this.writeMapperCPU(addr, val);
		break;
	}
	case 5: {
		/* 0xA000 -> 0xC000 */ this.writeMapperCPU(addr, val);
		break;
	}
	case 6: {
		/* 0xC000 -> 0xE000 */ this.writeMapperCPU(addr, val);
		break;
	}
	case 7: {
		/* 0xE000 -> 0xffff */ this.writeMapperCPU(addr, val);
		break;
	}
	}
};
...
cycloa.VirtualMachine.TransTable = new Uint32Array([
...
cycloa.VirtualMachine.prototype.__video__writeReg = function (
	/* uint16_t */ addr,
	/* uint8_t */ value
) {
	var __video__palette = this.__video__palette;
...
cycloa.VirtualMachine.prototype.__video__readReg = function (
	/* uint16_t */ addr
) {
	var __video__palette = this.__video__palette;
	var __video__vramMirroring = this.__video__vramMirroring;
...
cycloa.VirtualMachine.prototype.__video__writeVramExternal = function (
	/* uint16_t */ addr,
	/* uint8_t */ value
) {
	if (addr < 0x2000) {
...
cycloa.VirtualMachine.prototype.__video__writeVram = function (
	/* uint16_t */ addr,
	/* uint8_t */ value
) {
 ...
 */
cycloa.VirtualMachine.prototype.__video__changeMirrorType = function (
...
cycloa.VirtualMachine.Mapper[0] = function (self) {
	...
	for (var i = 0; i < 0x10; ++i) {
		self.__video__pattern[i] = self.__mapper__chrRom.subarray(
			cidx,
			(cidx += 512)
		);
	}
...
cycloa.VirtualMachine.prototype.load = function (rom) {
	...
	if (!mapperInit) {
		throw new cycloa.err.NotSupportedException(
			'Not supported mapper: ' + this.__mapper__mapperNo
		);
	}
	mapperInit(this);
...
cycloa.VirtualMachine.prototype.__mapper__parseROM = function (data) {
	...
	if (this.__mapper__trainerFlag) {
		if (fptr + 512 > data.byteLength)
			throw new cycloa.err.CoreException(
				'[FIXME] Invalid file size; too short!'
			);
		this.__mapper__trainer = new Uint8Array(data, fptr, 512);
		fptr += 512;
	}
	/* read PRG __cpu__rom */
	if (fptr + this.__mapper__prgSize > data.byteLength)
		throw new cycloa.err.CoreException(
			'[FIXME] Invalid file size; too short!'
		);
	...
	if (fptr + this.__mapper__chrSize > data.byteLength)
		throw new cycloa.err.CoreException(
			'[FIXME] Invalid file size; too short!'
		);
	else if (fptr + this.__mapper__chrSize < data.byteLength)
...
function NesController() {
	...
	this.machine_ = new cycloa.VirtualMachine(
		this.videoFairy_,
		this.audioFairy_,
		this.padFairy_
	);
...
NesController.prototype.start = function () {
	if (this.running_) {
		$('#state').text(
			'VM already running! Please stop the machine before loading another game.'
		);
		return false;
	}
	if (!this.loaded_) {
				...
				xhr.onreadystatechange = function () {
					if (this.readyState === this.DONE) {
						if (this.status === 200) {
							...
							$('#state').text(
								'oops. Failed to load game... Status: ' +
									this.status
							);
						}
					}
