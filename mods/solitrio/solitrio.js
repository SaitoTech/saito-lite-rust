...
class Solitrio extends GameTemplate {
  ...
  returnGameRulesHTML(){
    return `<div class="rules-overlay">
            <h1>Solitrio</h1>
            <h4>The Objective</h4>
            <p>The goal is to arrange the cards in sequential order with one suit per row</p>
            <h4>The Play</h4>
            <ul>
            ...
            <h4>References</h4>
            <p>1. <a href="https://www.youtube.com/watch?v=oAB5fsN2uA8" target="_blank">Video Tutorial</a></p>
