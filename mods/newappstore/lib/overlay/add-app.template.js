  ...
  <style>
    ...
    <div class="saito-overlay-form saito-app-overlay" id="saito-app-overlay">
        <div class="saito-overlay-form-header">
          <div class="saito-overlay-form-header-title">Add new app</div>
        </div>

        <div class="saito-app-body">
          
          <div class="saito-app-upload active-tab paste_event" id="saito-app-upload">drag and drop file or click to select one to upload
          </div>
