	...
	return `
      ...
      <div class="saito-overlay-form">
	      <div class="saito-overlay-form-header">
	        <div class="saito-overlay-form-header-title">Add Key to Whitelist</div>
	      </div>
	      ...
	      <div class="saito-overlay-form-submitline">
          	<button type="button" class="saito-button-primary saito-overlay-form-submit" id="saito-overlay-submit">Register Username</button> 
        </div>
      </div>
		</form>
  `;
