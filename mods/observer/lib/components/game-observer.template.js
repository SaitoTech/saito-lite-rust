  ...
  return `
    <div id="game-observer-hud" class="game-observer-hud">
      ...
      <div id="game-observer-controls" class="game-observer-controls">
        <div id="game-observer-first-btn" class="game-observer-btn"><i class="fas fa-fast-backward" title="Reset game to beginning state"></i></div>
        <div id="game-observer-last-btn" class="game-observer-btn"><i class="fas fa-step-backward" title="Rewind one game move"></i></div>
