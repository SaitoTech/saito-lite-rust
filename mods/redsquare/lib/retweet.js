...
class Retweet {
  ...
  attachEvents(app, mod) {
    ...
    document.getElementById(divid).onclick = (e) => {
      ...
      let data = { text: text, thread_creation_date: this.tweet_creation_date, retweet_tx: retweet_tx, retweet_link_properties: this.tweet.link_properties, retweet_link: this.tweet.link };
