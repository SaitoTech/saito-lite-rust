...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
    ...
    if (thread) {
      ...
      this.app.browser.addElementAfterSelector(
        `<div id="redsquare-appspace-tweet-body" class="redsquare-appspace-body"></div>`,
        ".redsquare-appspace-header"
      );
    } else {
      document.querySelector(
        ".saito-main"
      ).innerHTML = `<div id="redsquare-appspace-tweet-body" class="redsquare-appspace-body"></div>`;
    }
      ...
      document.querySelectorAll(".redsquare-page-header-title").forEach((el) => {
        el.addEventListener("click", (e) => {
          ...
          if (window.holder.querySelector(".redsquare-appspace-body")) {
            document
              .querySelector(".redsquare-home")
              .querySelector(".redsquare-appspace-body")
              .remove();
            document
              .querySelector(".redsquare-home")
              .append(window.holder.querySelector(".redsquare-appspace-body"));
            document
              .querySelector(".redsquare-home")
              .append(document.querySelector("#redsquare-intersection"));
            document.querySelector(".tweet-" + sig).scrollIntoView();
        ...
        document.querySelectorAll('.redsquare-page-header-title').forEach(el => {
          el.addEventListener('click', (e) => {
            ...
            if (window.holder.querySelector('.redsquare-appspace-body')) {
              ...
              document.querySelector('.tweet-' + sig).scrollIntoView(); 
              this_self.intersectionObserver.observe(document.querySelector('#redsquare-intersection'));
            }
