  ...
  for (let i = 0; i < invite.players.length; i++) {
    html += `
          ...
          invite.players[i]
		    ...
		    <div class="saito-address saito-address-${invite.players[i]}" data-id="${invite.players[i]}">${
      invite.players[i]
    }</div>
		  </div>					  	  
			`;
    ...
    html += `
      ...
      <div class="arcade-game-playerbox empty saito-table-row requested_player">
          ...
          invite.desired_opponent_publickeys[i]
 	      ...
 	      <div class="saito-address saito-address-${invite.players[i]}" data-id="${
      invite.players[i]
    }">${invite.desired_opponent_publickeys[i]}</div>
	    </div>
