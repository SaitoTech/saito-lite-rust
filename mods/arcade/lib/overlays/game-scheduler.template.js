...
module.exports = (app, tx = {}) => {
  ...
  let user = 
  `<div class="saito-user saito-user-${publickey}" data-id="${publickey}" data-disable="true">
    ...
    <div class="saito-userline" data-id="${publickey}">${tx.msg.options.game} Invitation</div>
  </div>`;
