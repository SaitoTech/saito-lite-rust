  ...
  handleGameLoop(msg = null) {
    ...
    if (this.game.queue.length > 0) {
      ...
      if (mv[0] == "defcon_check") {
        ...
        if (this.game.state.defcon1_us > 6 || this.game.state.defcon2_us > 6 || this.game.state.defcon3_us > 6) {
          us_loses = 1;
        }
        if (this.game.state.defcon1_us > 3 && this.game.state.defcon2_us > 3 && this.game.state.defcon3_us > 3) {
          us_loses = 1;
        }

        if (this.game.state.defcon1_ussr > 6 || this.game.state.defcon2_ussr > 6 || this.game.state.defcon3_ussr > 6) {
          ussr_loses = 1;
        }
        if (this.game.state.defcon1_ussr > 3 && this.game.state.defcon2_ussr > 3 && this.game.state.defcon3_ussr > 3) {
          ussr_loses = 1;
        }
  ...
  returnStrategyCards() {
    ...
    deck['s03b'] = {
      ...
      event: function(player) {
        ...
        let who_goes = 0;
        if (thirteen_self.game.arenas['television'].us > thirteen_self.game.arenas['television'].ussr) {
          who_goes = 2;
        }
        if (thirteen_self.game.arenas['television'].us < thirteen_self.game.arenas['television'].ussr) {
          who_goes = 1;
