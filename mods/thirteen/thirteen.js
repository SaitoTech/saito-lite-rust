...
class Thirteen extends GameTemplate {
  ...
  async handleGameLoop(msg = null) {
    ...
    if (this.game.queue.length > 0) {
      ...
      if (mv[0] == "scoring_phase") {
        ...
        let agenda_card =
          scorer === 1 ? this.game.state.ussr_agenda_selected : this.game.state.us_agenda_selected;
      ...
      if (mv[0] == "world_opinion_phase") {
        ...
        if (segment == "television") {
          ...
          if (this.game.arenas["television"].us > this.game.arenas["television"].ussr) {
            television_bonus = 2;
          }
          if (this.game.arenas["television"].us < this.game.arenas["television"].ussr) {
            television_bonus = 1;
        ...
        if (segment == "un") {
          let un_bonus = 0;
          if (this.game.arenas["un"].us > this.game.arenas["un"].ussr) {
            un_bonus = 2;
          }
          if (this.game.arenas["un"].us < this.game.arenas["un"].ussr) {
            un_bonus = 1;
        ...
        if (segment == "alliances") {
          ...
          if (this.game.arenas["alliances"].us > this.game.arenas["alliances"].ussr) {
            alliances_bonus = 2;
          }
          if (this.game.arenas["alliances"].us < this.game.arenas["alliances"].ussr) {
            alliances_bonus = 1;
    ...
    $(".active_battleground").on("click", function () {
      ...
      if (thirteen_self.addInfluence(player_added, arena_id, 1)) {
        ...
        let hit_influence_limit =
          (player_added == 1 && thirteen_self.game.state.influence_on_board_ussr == 17) ||
          (player_added == 2 && thirteen_self.game.state.influence_on_board_us == 17);
      ...
      if (direction == "addtokens") {
        ...
        thirteen_self.attachCardboxEvents(function (number) {
          ...
          if (thirteen_self.addInfluence(thirteen_self.game.player, arena, parseInt(number))) {
            thirteen_self.addMove(
              `notify\t${thirteen_self.roles[thirteen_self.game.player]} adds ${number} cubes to ${
  ...
  showDefconTracks() {
    ...
    //Place them anew
    $('<img src="/thirteen/img/Blue%20Disc.png" class="defcon_disc_us" />').appendTo(
      $(`#defcon_track_1_${this.game.state.defcon1_us}`)
    );
    $('<img src="/thirteen/img/Red%20Disc.png" class="defcon_disc_ussr" />').appendTo(
      $(`#defcon_track_1_${this.game.state.defcon1_ussr}`)
    );

    $('<img src="/thirteen/img/Blue%20Disc.png" class="defcon_disc_us" />').appendTo(
      $(`#defcon_track_2_${this.game.state.defcon2_us}`)
    );
    $('<img src="/thirteen/img/Red%20Disc.png" class="defcon_disc_ussr" />').appendTo(
      $(`#defcon_track_2_${this.game.state.defcon2_ussr}`)
    );

    $('<img src="/thirteen/img/Blue%20Disc.png" class="defcon_disc_us" />').appendTo(
      $(`#defcon_track_3_${this.game.state.defcon3_us}`)
    );
    $('<img src="/thirteen/img/Red%20Disc.png" class="defcon_disc_ussr" />').appendTo(
      $(`#defcon_track_3_${this.game.state.defcon3_ussr}`)
    );
  }
    ...
    deck["a07b"] = {
      ...
      score: function () {
        ...
        if (thirteen_self.game.arenas["turkey"].us > thirteen_self.game.arenas["turkey"].ussr) {
          winner = 2;
          difference =
            thirteen_self.game.arenas["turkey"].us - thirteen_self.game.arenas["turkey"].ussr;
        }
        if (thirteen_self.game.arenas["turkey"].us < thirteen_self.game.arenas["turkey"].ussr) {
          winner = 1;
          difference =
            thirteen_self.game.arenas["turkey"].ussr - thirteen_self.game.arenas["turkey"].us;
        }
    ...
    deck["a08b"] = {
      ...
      score: function () {
        ...
        if (thirteen_self.game.arenas["berlin"].us > thirteen_self.game.arenas["berlin"].ussr) {
          winner = 2;
          difference =
            thirteen_self.game.arenas["berlin"].us - thirteen_self.game.arenas["berlin"].ussr;
        }
        if (thirteen_self.game.arenas["berlin"].us < thirteen_self.game.arenas["berlin"].ussr) {
          winner = 1;
          difference =
            thirteen_self.game.arenas["berlin"].ussr - thirteen_self.game.arenas["berlin"].us;
        }
    ...
    deck["a09b"] = {
      ...
      score: function () {
        ...
        if (thirteen_self.game.arenas["italy"].us > thirteen_self.game.arenas["italy"].ussr) {
          winner = 2;
          difference =
            thirteen_self.game.arenas["turkey"].us - thirteen_self.game.arenas["italy"].ussr;
        }
        if (thirteen_self.game.arenas["italy"].us < thirteen_self.game.arenas["italy"].ussr) {
          winner = 1;
          difference =
            thirteen_self.game.arenas["italy"].ussr - thirteen_self.game.arenas["italy"].us;
        }
    ...
    deck["a10b"] = {
      ...
      score: function () {
        ...
        if (thirteen_self.game.arenas["cuba_pol"].us > thirteen_self.game.arenas["cuba_pol"].ussr) {
          winner = 2;
          difference =
            thirteen_self.game.arenas["cuba_pol"].us - thirteen_self.game.arenas["cuba_pol"].ussr;
        }
        if (thirteen_self.game.arenas["cuba_pol"].us < thirteen_self.game.arenas["cuba_pol"].ussr) {
          winner = 1;
          difference =
            thirteen_self.game.arenas["cuba_pol"].ussr - thirteen_self.game.arenas["cuba_pol"].us;
        }

        if (winner == 1) {
          if (
            thirteen_self.game.arenas["cuba_mil"].ussr > thirteen_self.game.arenas["cuba_mil"].us
          ) {
            difference++;
          }
          if (
            thirteen_self.game.arenas["atlantic"].ussr > thirteen_self.game.arenas["atlantic"].us
          ) {
            difference++;
          }
        }
    ...
    deck["a11b"] = {
      ...
      score: function () {
        ...
        if (thirteen_self.game.arenas["cuba_mil"].us > thirteen_self.game.arenas["cuba_mil"].ussr) {
          winner = 2;
          difference =
            thirteen_self.game.arenas["cuba_mil"].us - thirteen_self.game.arenas["cuba_mil"].ussr;
        }
        if (thirteen_self.game.arenas["cuba_mil"].us < thirteen_self.game.arenas["cuba_mil"].ussr) {
          winner = 1;
          difference =
    ...
    deck["a12b"] = {
      ...
      score: function () {
        ...
        if (thirteen_self.game.arenas["atlantic"].us > thirteen_self.game.arenas["atlantic"].ussr) {
          winner = 2;
          difference =
            thirteen_self.game.arenas["atlantic"].us - thirteen_self.game.arenas["atlantic"].ussr;
        }
        if (thirteen_self.game.arenas["atlantic"].us < thirteen_self.game.arenas["atlantic"].ussr) {
          winner = 1;
          difference =
  ...
  returnStrategyCards() {
    ...
    deck["s03b"] = {
      ...
      event: function (player) {
        let who_goes = 0;
        if (
          thirteen_self.game.arenas["television"].us > thirteen_self.game.arenas["television"].ussr
        ) {
          who_goes = 2;
        }
        if (
        ...
        if (who_goes == 0) {
          ...
          thirteen_self.addMove(
            "event_shift_defcon\t" + who_goes + "\t" + who_goes + "\t" + options + "\t1"
          );
          thirteen_self.addMove(
            "event_shift_defcon\t" + who_goes + "\t" + who_goes + "\t" + options + "\t1"
          );
    ...
    deck["s08b"] = {
      ...
      event: function (player) {
        ...
        thirteen_self.addMove(
          `setvar\tremove_command_token_bonus\t${3 - thirteen_self.game.player}`
        );
        thirteen_self.addMove(
    ...
    deck["s11b"] = {
      ...
      event: function (player) {
        ...
        let opponentn = thirteen_self.game.player == 1 ? "US" : "USSR";
        thirteen_self.addMove(
          `setvar\tcannot_deflate_defcon_from_events\t${3 - thirteen_self.game.player}`
        );
        thirteen_self.addMove(
    ...
    deck["s22b"] = {
      ...
      event: function (player) {
        ...
        thirteen_self.eventShiftDefcon(player, 2, [1], 2, "increase", function (arg) {
