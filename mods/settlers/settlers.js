...
***/
  ...
  */
  ...
  <h4 style="text-transform:capitalize">${skin.b.name}</h4>
  ...
  <h4 style="text-transform:capitalize">${skin.card.name} cards</h4>
  ...
  <h4>FAQ</h4>
  <ul>
  <li>Why can't I build a ${skin.c1.name}?</li>
  <p>In order to build a ${skin.c1.name}, you have to satisfy several requirements. Firstly, you must have all the resources required to build. Secondly, you must have an available spot on the board, which is both connected to one of your roads and not adjacent to any other ${skin.c1.name}s or ${skin.c2.name}s. Thirdly, you many only have up to 5 ${skin.c1.name}s on the board at any time. Try upgrading one of your ${skin.c1.name}s to a ${skin.c2.name}. </p>
  <li>Why can't I build a ${skin.c2.name}?</li>
  <p>See the above answer, but note that you are limited to 4 ${skin.c2.name}s on the board.</p>
  </ul>
  </div>
   `;
