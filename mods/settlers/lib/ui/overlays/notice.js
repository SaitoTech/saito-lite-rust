...
class NoticeOverlay {
	...
	template(){
		...
		<li>if a player is losing by 2 or more points, our bandit (the famous Robin Hood, who has a sense of justice) will come to their aid whenever the 7 is rolled.</li>
		</ul>
		</div>
		`;
	}
