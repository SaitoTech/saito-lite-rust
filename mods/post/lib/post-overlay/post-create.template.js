module.exports = PostCreateTemplate = (app, mod) => {
  ...
  let subforum = app.browser.returnURLParameter("forum") || app.browser.returnURLParameter("game") || "saito";
  
  return `
  <div id="post-create-container" class="post-create-container">
    <div id="post-create" class="post-create">
      <input type="text" class="post-create-title" name="post-create-title" placeholder="Title (optional)" style="display:none;" value="">
...
<div id="post-create-header" class="post-create-header">
  ...
  <div id="post-create-header-link" class="post-create-header-item post-create-header-link">Link</div>
      ...
      <div id="post-create-image-link-container" class="post-create-image-link-container"><i class="fas fa-link"></i></div>
