    ...
    if (imperium_self.game.player == player && imperium_self.game.player != strategy_card_player) {
      ...
      if (
        ...
        (imperium_self.returnAvailableResources(player) == 0 &&
          imperium_self.game.state.players_info[player - 1].goods == 0 &&
          imperium_self.game.state.players_info[player - 1].sarween_tools != 1)
      ) {
      ...
      $(".option").on("click", function () {
        ...
        if (id == "yes") {
          imperium_self.playerProduceUnits(
            imperium_self.game.state.players_info[imperium_self.game.player - 1].homeworld,
            0,
            0,
            2,
            1
