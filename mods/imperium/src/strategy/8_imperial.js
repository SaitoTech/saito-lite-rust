this.importStrategyCard('imperial', {
	...
	strategyPrimaryEvent: function (
		...
		if (
											...
											function () {
												...
												imperium_self.game.state.players_info[
													imperium_self.game.player -
														1
												].objectives_scored_this_round.push(
													objective
												);
			...
			if (
				imperium_self.game.planets['new-byzantium'].owner ==
				strategy_card_player
			) {
				imperium_self.playerAcknowledgeNotice(
	...
	strategyTertiaryEvent: function (
		...
		if (player == imperium_self.game.player) {
			...
			imperium_self.playerScoreSecretObjective(
				imperium_self,
				function (x, vp, objective) {
					...
					imperium_self.playerScoreVictoryPoints(
						...
						function (x, vp, objective) {
							...
							if (my_secret_vp > 0) {
								if (
									imperium_self.secret_objectives[
										my_secret_objective
									] != undefined
								) {
									imperium_self.secret_objectives[
