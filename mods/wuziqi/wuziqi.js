    ...
    */
    ...
    returnGameRulesHTML() {
        ...
        let overlay_html = `<div class="rules-overlay intro">
           ...
           <h4>The Objective</h4>
           <p> The first player to place five of their own tokens in a continuous line--vertical, horizontal or diagonally--wins the round. The player who wins the most rounds, wins the match.</p>
           <h4>The Play</h4>
           <p> During the game, two players alternate their turns; each placing one of their stones on the board. Matches are best out of three by default, but you can change this in the advanced options in the arcade. You may also specify the size of the board for added challenge.</p>
           <h4>References</h4>
           <p>1. <a href="https://www.youtube.com/watch?v=nenFRLFY7yc" target="_blank">Video Tutorial</a></p>
           </div>`;
        return overlay_html;
