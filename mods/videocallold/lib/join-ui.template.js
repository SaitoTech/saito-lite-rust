  ...
  <div class="welcome-modal-wrapper">
    <div class="welcome-modal-action">
      <div class="welcome-modal-left">
        <div class="welcome-modal-header">Join Video Chat</h1></div>
        <div class="welcome-modal-main">
          <div style="margin:1em 0">Please enter your invite number:</div>
          <div style="">
          ...
          <div class="welcome-modal-info">
            <div style="margin-top:20px" class="welcome-modal-explanation">
              <div class="tip">
                <div><b>What happens when I join a video chat with someone? <i class="fas fa-info-circle"></i></b></div>
                <div class="tiptext">Your browser will use Saito to create a direct peer-to-peer connection with the other chat members and then open a video chat with them.</div>
              </div>
            </div>
          </div>
        </div>
