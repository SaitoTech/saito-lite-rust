const questions = [
  ...
  {
    question: "Which is one of the two economic problems in blockchain design the Saito whitepaper discusses?",
    answers: [
      {
  ...
  {
    question: "Saito’s founding team holds various patents. What was the first thing patented by a Saito founder?",
    answers: [
      {
  ...
  {
    question: "Where did the team get the inspiration for the name “Saito” from?",
    answers: [
      {
  ...
  {
    question: "How does Saito use a 'fee market' to incentivize nodes to process transactions?",
    answers: [
      {
  ...
  {
    question: "How does Saito incentivize nodes to rebroadcast transactions?",
    answers: [
      {
  ...
  {
    question: "What is the difference between a 'full node' and a 'lite node' in Saito blockchain?",
    answers: [
      {
  ...
  {
    question: "At what percentage of network control can an attacker execute a profitable attack?",
    answers: [
      {
  ...
  {
    question: "Which cryptographic method does Saito use to generate a shared-secret between peers over the blockchain?",
    answers: [
      {
  ...
  {
    question: "What is the main problem with the transaction fee distribution model in POW / POS?",
    answers: [
      {
  ...
  {
    question: "What is not a key innovation introduced by the Saito network?",
    answers: [
      {
  ...
  {
    question: "Saito uses the most performance data-structure for UTXO storage. What is that?",
    answers: [
      {
  ...
  {
    question: "One of the games on the Saito Arcade was once a top-10 Ranked Boardgame on BoardGameGeeks. Which game?",
    answers: [
      {
        answer: "Twilight Struggle",
        correct: true
  ...
  {
    question: "Which type of nodes are rewarded with SAITO tokens for relaying transactions on the Saito network?",
    answers: [
      {
  ...
  {
    question: "What is the role of the users in the network governance protocol?",
    answers: [
      {
  ...
  {
    question: "What is the school of economics concerned with the scalability problems in blockchain?",
    answers: [
      {
  ...
  {
    question: "What are the technical terms in economics that best describe openness?",
    answers: [
      {
  ...
  {
    question: "How does Saito ensure that the network remains decentralized?",
    answers: [
      {
  ...
  {
    question: "How does Saito ensure that blocks are propagated quickly throughout the network?",
    answers: [
      {
  ...
  {
    question: "What novel property do key exchanges get running atop Saito?",
    answers: [
      {
  ...
  {
    question: "How does Saito solve the 'Tragedy of the Commons' problem in permanent ledgers?",
    answers: [
      {
  ...
  {
    question: "What three structures can free markets use to defeat free-riding pressures in blockchain networks?",
    answers: [
      {
  ...
  {
    question: "What is a problem with asking outside markets to incentivize P2P network provision?",
    answers: [
      {
  ...
  {
    question: "What happens to the fees in a block if the very next block does not contain a golden ticket and our difficulty mechanism is targeting one solution every two blocks?",
    answers: [
      {
  ...
  {
    question: "How does Saito Consensus differ from other consensus mechanisms in terms of cost-of-attack?",
    answers: [
      {
  ...
  {
    question: "What is the purpose of adjusting mining difficulty in the Saito Consensus?",
    answers: [
      {
  ...
  {
    question: "What happens to the payment for both miner and router if the block reward is seriously in excess of the smoothed average?",
    answers: [
      {
  ...
  {
    question: "Why doesn't giving a transaction to another node allow it to compete with you producing blocks?",
    answers: [
      {
  ...
  {
    question: "What happens to the profitability of routing nodes when they hoard transactions?",
    answers: [
      {
        answer: "It decreases",
        correct: true
  ...
  {
    question: "What incentive does a first-hop node have to broadcast a fee-bearing transaction it wants to include in the blockchain?",
    answers: [
      {
  ...
  {
    question: "What is the benefit of using Saito for data transfers instead of web2 platforms?",
    answers: [
      {
  ...
  {
    question: "What is the Saito team's stance on scheduled network upgrades?",
    answers: [
      {
...
export function getRandomQuestion () {
  ...
  for (let index = 0; index < questions[questionIndex].answers.length; index++) {
    if (correctAnswerPlacement === index) {
      rearrangedAnswers.push(questions[questionIndex].answers[correctAnswerIndex]);
    } else {
      rearrangedAnswers.push(questions[questionIndex].answers[availableAnswers[0]]);
