...
class Twilight extends GameTemplate {
	constructor(app) {
      ...
      One player plays the United States (US), and the other plays the Soviet Union (USSR).`;
		this.publisher_message =
			'Twilight Struggle is owned by GMT Games. This module is made available under an open source license provided by GMT Games for usage in open source game engines. Publisher requirements is that at least one player per game has purchased a copy of the game.';
    ...
    `;
		...
		$('.menu-item').on('click', function () {
			...
			twilight_self.overlay.show(
				'All players are backing up their game...'
			);
		});
	}
	...
	handleDisplayMenu() {
		let twilight_self = this;
		let use_clock_html = '';
		if (twilight_self.useClock == 1) {
			use_clock_html =
				'<li class="menu-item" id="move_clock">Move Clock</li>';
		}
		...
		$('.menu-item').on('click', function () {
			...
			if (action2 === 'text') {
				twilight_self.displayModal(
					'Card Menu options changed to text-mode. Please reload.'
				);
			...
			if (action2 === 'graphics') {
				twilight_self.displayModal(
					'Card Menu options changed to graphical mode. Please reload.'
				);
	...
	async render(app) {
			...
			callback: function (app, game_mod) {
				if (game_mod.confirm_moves == 0) {
					game_mod.displayModal(
						'Game Settings',
						'Will confirm moves before committing'
					);
		...
		this.menu.addSubMenuOption('game-cards', {
			...
			callback: function (app, game_mod) {
				game_mod.menu.hideSubMenus();
				game_mod.showCardOverlay(
					Object.keys(game_mod.game.deck[0].discards),
					'Discards'
				);
			}
		});
		this.menu.addSubMenuOption('game-cards', {
			...
			callback: function (app, game_mod) {
				game_mod.menu.hideSubMenus();
				game_mod.showCardOverlay(
					Object.keys(game_mod.game.deck[0].removed),
					'Removed Cards'
				);
			}
		});
		this.menu.addSubMenuOption('game-cards', {
			...
			callback: function (app, game_mod) {
				game_mod.menu.hideSubMenus();
				game_mod.showCardOverlay(
					Object.keys(game_mod.returnUnplayedCards()),
					'Unplayed Cards'
				);
			}
		});
		...
		this.menu.addSubMenuOption('game-language', {
			...
			callback: function (app, game_mod) {
				game_mod.displayModal(
					'Language Settings',
					'Card settings changed to English'
				);
				game_mod.lang = 'en';
	...
	initializeGame(game_id) {
		...
		if (this.app?.options?.gameprefs) {
			this.interface =
				this.app.options.gameprefs.interface || this.interface;
      ...
      this.confirm_moves = 1;
		...
		if (!this.game.state) {
			...
			if (this.game.options.usbonus != undefined) {
				if (
					this.game.options.usbonus > 0 &&
					this.game.options.deck !== 'late-war'
				) {
					this.game.queue.push(
						'placement_bonus\t2\t' + this.game.options.usbonus
					);
				}
			}
...
***/
				...
				if (this.game.options.deck === 'late-war') {
					...
					this.game.queue.push(
						'DECK\t1\t' + JSON.stringify(early_war_deck)
					);
				}
			}
		...
		try {
			...
			$('.formosan_resolution').css(
				'top',
				this.scale(this.countries['taiwan'].top - 32) + 'px'
			);
			$('.formosan_resolution').css(
				'left',
				this.scale(this.countries['taiwan'].left) + 'px'
			);
			...
			$('.civil_war_sudan').css(
				'top',
				this.scale(this.countries['sudan'].top - 32) + 'px'
			);
			$('.civil_war_sudan').css(
				'left',
				this.scale(this.countries['sudan'].left) + 'px'
			);

			$('.kissinger_colombia').css('width', this.scale(202) + 'px');
			$('.kissinger_colombia').css('height', this.scale(132) + 'px');
			$('.kissinger_colombia').css(
				'top',
				this.scale(this.countries['colombia'].top - 32) + 'px'
			);
			$('.kissinger_colombia').css(
				'left',
				this.scale(this.countries['colombia'].left) + 'px'
			);

			$('.kissinger_guatemala').css('width', this.scale(202) + 'px');
			$('.kissinger_guatemala').css('height', this.scale(132) + 'px');
			$('.kissinger_guatemala').css(
				'top',
				this.scale(this.countries['guatemala'].top - 32) + 'px'
			);
			$('.kissinger_guatemala').css(
				'left',
				this.scale(this.countries['guatemala'].left) + 'px'
			);

			$('.kissinger_elsalvador').css('width', this.scale(202) + 'px');
			$('.kissinger_elsalvador').css('height', this.scale(132) + 'px');
			$('.kissinger_elsalvador').css(
				'top',
				this.scale(this.countries['elsalvador'].top - 32) + 'px'
			);
			$('.kissinger_elsalvador').css(
				'left',
				this.scale(this.countries['elsalvador'].left) + 'px'
			);

			$('.kissinger_nicaragua').css('width', this.scale(202) + 'px');
			$('.kissinger_nicaragua').css('height', this.scale(132) + 'px');
			$('.kissinger_nicaragua').css(
				'top',
				this.scale(this.countries['nicaragua'].top - 32) + 'px'
			);
			$('.kissinger_nicaragua').css(
				'left',
				this.scale(this.countries['nicaragua'].left) + 'px'
			);
			...
			$('.kissinger_haiti').css(
				'top',
				this.scale(this.countries['haiti'].top - 32) + 'px'
			);
			$('.kissinger_haiti').css(
				'left',
				this.scale(this.countries['haiti'].left) + 'px'
			);

			$('.kissinger_dominicanrepublic').css(
				'width',
				this.scale(202) + 'px'
			);
			$('.kissinger_dominicanrepublic').css(
			...
			$('.kissinger_dominicanrepublic').css(
				'top',
				this.scale(this.countries['dominicanrepublic'].top - 32) + 'px'
			);
			$('.kissinger_dominicanrepublic').css(
				'left',
				this.scale(this.countries['dominicanrepublic'].left) + 'px'
			);

			$('.kissinger_saharanstates').css('width', this.scale(202) + 'px');
			$('.kissinger_saharanstates').css('height', this.scale(132) + 'px');
			$('.kissinger_saharanstates').css(
				'top',
				this.scale(this.countries['saharanstates'].top - 32) + 'px'
			);
			$('.kissinger_saharanstates').css(
				'left',
				this.scale(this.countries['saharanstates'].left) + 'px'
			);
			...
			$('.kissinger_ethiopia').css(
				'top',
				this.scale(this.countries['ethiopia'].top - 32) + 'px'
			);
			$('.kissinger_ethiopia').css(
				'left',
				this.scale(this.countries['ethiopia'].left) + 'px'
			);

			$('.kissinger_cameroon').css('width', this.scale(202) + 'px');
			$('.kissinger_cameroon').css('height', this.scale(132) + 'px');
			$('.kissinger_cameroon').css(
				'top',
				this.scale(this.countries['cameroon'].top - 32) + 'px'
			);
			$('.kissinger_cameroon').css(
				'left',
				this.scale(this.countries['cameroon'].left) + 'px'
			);

			$('.kissinger_seafricanstates').css(
				'width',
				this.scale(202) + 'px'
			);
			$('.kissinger_seafricanstates').css(
			...
			$('.kissinger_seafricanstates').css(
				'top',
				this.scale(this.countries['seafricanstates'].top - 32) + 'px'
			);
			$('.kissinger_seafricanstates').css(
				'left',
				this.scale(this.countries['seafricanstates'].left) + 'px'
			);

			$('.kissinger_zimbabwe').css('width', this.scale(202) + 'px');
			$('.kissinger_zimbabwe').css('height', this.scale(132) + 'px');
			$('.kissinger_zimbabwe').css(
				'top',
				this.scale(this.countries['zimbabwe'].top - 32) + 'px'
			);
			$('.kissinger_zimbabwe').css(
				'left',
				this.scale(this.countries['zimbabwe'].left) + 'px'
			);

			$('.kissinger_lebanon').css('width', this.scale(202) + 'px');
			$('.kissinger_lebanon').css('height', this.scale(132) + 'px');
			$('.kissinger_lebanon').css(
				'top',
				this.scale(this.countries['lebanon'].top - 32) + 'px'
			);
			$('.kissinger_lebanon').css(
				'left',
				this.scale(this.countries['lebanon'].left) + 'px'
			);
			...
			$('.kissinger_laos').css(
				'top',
				this.scale(this.countries['laos'].top - 32) + 'px'
			);
			$('.kissinger_laos').css(
				'left',
				this.scale(this.countries['laos'].left) + 'px'
			);

			$('.kissinger_vietnam').css('width', this.scale(202) + 'px');
			$('.kissinger_vietnam').css('height', this.scale(132) + 'px');
			$('.kissinger_vietnam').css(
				'top',
				this.scale(this.countries['vietnam'].top - 32) + 'px'
			);
			$('.kissinger_vietnam').css(
				'left',
				this.scale(this.countries['vietnam'].left) + 'px'
			);

			$('.kissinger_indonesia').css('width', this.scale(202) + 'px');
			$('.kissinger_indonesia').css('height', this.scale(132) + 'px');
			$('.kissinger_indonesia').css(
				'top',
				this.scale(this.countries['indonesia'].top - 32) + 'px'
			);
			$('.kissinger_indonesia').css(
				'left',
				this.scale(this.countries['indonesia'].left) + 'px'
			);
		...
		for (var i in this.countries) {
			...
			try {
				...
				$(divname).css(
					'left',
					this.scale(this.countries[i].left) + 'px'
				);
		...
		try {
			...
			$('.scoring_card')
				.mouseover(function () {
					...
					if (
						total_vp > twilight_self.game.vp_needed ||
						total_vp < twilight_self.game.vp_needed * -1
					) {
						total_vp = 'WIN';
					}
		...
		if (this.game.queue.length > 0) {
			...
			if (mv[0] == 'bgs') {
				...
				if (cmd === 'reset') {
					...
					for (let i in this.game.countries) {
						this.game.countries[i].bg = parseInt(
							this.game.countries[i].bg
						);
					}
				}
			}
			...
			if (mv[0] === 'update_observers') {
				...
				if (this.game.player == p) {
					this.addMove(
						'observer_cards_update\t' +
							this.game.player +
							'\t' +
							JSON.stringify(this.game.deck[0].hand)
					);
					this.endTurn();
				}
			...
			if (mv[0] === 'discard') {
				if (mv[2] === 'china') {
					...
					if (
						mv[2] == 'missileenvy' &&
						this.game.state.events.missile_envy != this.game.player
					) {
					...
					for (var i in this.game.deck[0].cards) {
						if (mv[2] == i) {
							if (this.game.deck[0].cards[mv[2]] != undefined) {
								...
								this.updateLog(
									`${mv[1].toUpperCase()} discards ${this.cardToText(
										mv[2]
									)}`
								);

								// discard pile is parallel to normal
								this.game.deck[0].discards[i] =
									this.game.deck[0].cards[i];
							}
						}
					}
				}
			...
			if (mv[0] === 'undiscard') {
				...
				if (this.game.deck[0].discards[cardkey]) {
					...
					this.updateLog(
						`${this.cardToText(cardkey)} removed from discard pile`
					);
					if (this.game.deck[0].discards[cardkey]) {
						this.game.deck[0].cards[cardkey] =
							this.game.deck[0].discards[cardkey];
			...
			if (mv[0] == 'wargames') {
				...
				if (activate == 0) {
					...
					if (mv[1] == 'us') {
						this.game.state.vp -=
							this.game.state.wargames_concession;
					} else {
						this.game.state.vp +=
							this.game.state.wargames_concession;
					}
			...
			if (mv[0] === 'grainsales') {
				...
				if (mv[1] == 'ussr') {
					...
					if (this.game.player == 2) {
						...
						let user_message = `${this.cardToText(
							mv[0]
						)} pulls ${this.cardToText(
							mv[2]
						)} from USSR. Do you want to play this card?`;
						let html = '<ul>';
						if (
							mv[2] == 'unintervention' &&
							this.game.state.headline == 1
							...
							html +=
								'<li class="option noncard" id="play">play card</li>';
						}
						html +=
							'<li class="option noncard" id="nope">return card</li>';
						html += '</ul>';
				...
				twilight_self.playCoup('ussr', mv[2], couppower, function () {
					...
					if (twilight_self.countries[mv[2]].us < original_us) {
						...
						for (let c in twilight_self.countries) {
							if (
								twilight_self.game.countries[c].bg == 0 &&
								(twilight_self.countries[c].region ===
									'africa' ||
									twilight_self.countries[c].region ===
										'camerica' ||
									twilight_self.countries[c].region ===
										'samerica') &&
								twilight_self.countries[c].us > 0
							) {
						...
						if (valid_targets == 0) {
							...
							if (twilight_self.game.player == 1) {
								...
								let user_message =
									'Pick second target for coup:';
								let html =
									'<ul><li class="option" id="skipche">or skip coup</li></ul>';
								...
								$('.easterneurope').on('click', function () {
									...
									let c = $(this).attr('id');
									twilight_self.addMove(
										'coup\tussr\t' + c + '\t' + couppower
									);
									twilight_self.addMove(
										'NOTIFY\tChe launches coup in ' +
											twilight_self.countries[c].name
									);
									twilight_self.endTurn();
								});
							} else {
								...
								twilight_self.updateStatus(
									`Waiting for USSR to play second ${twilight_self.cardToText(
										'che'
									)} coup`
								);
								return 0;
			...
			if (mv[0] === 'missileenvy') {
				...
				let opponent_card = 0;
				if (
					this.game.deck[0].cards[card].player == 'us' &&
					sender == 2
				) {
					opponent_card = 1;
				}
				if (
					this.game.deck[0].cards[card].player == 'ussr' &&
					sender == 1
				) {
					opponent_card = 1;
				}
				...
				if (opponent_card == 1) {
					...
					this.game.queue.push(
						'ops\t' +
							...
							card +
							'\t' +
							this.game.deck[0].cards[card].ops
					);
					this.game.queue.push(
						'NOTIFY\t' +
							discarder.toUpperCase() +
							' offers ' +
			...
			if (mv[0] === 'quagmire') {
				...
				if (roll < 5) {
					...
					this.displayModal(
						`${mv[1].toUpperCase()} extricates itself from ${this.cardToText(
							sticker
						)}`
					);
				} else {
					...
					this.displayModal(
						`${mv[1].toUpperCase()} remains stuck in the ${this.cardToText(
							sticker
						)}`
					);
				}
				...
				if (sender == 'ussr') {
					...
					if (this.game.player == 1) {
						...
						for (let i = 0; i < keysnum; i++) {
							...
							cardoptions[i] = this.app.crypto.decodeXOR(
								cardoptions[i],
						...
						for (let i = 0; i < keysnum; i++) {
							cardoptions[i] = this.app.crypto.decodeXOR(
								cardoptions[i],
								this.game.queue[
									this.game.queue.length - keysnum + i
								]
							);
							cardoptions[i] = this.app.crypto.hexToString(
								cardoptions[i]
							);
						}
						for (let i = 0; i < keysnum; i++) {
						...
						twilight_self.updateStatusAndListCards(
							user_message,
							cardoptions,
							function (action2) {
								if (action2 == 'finished') {
									for (
										let i = 0;
										i < pos_to_discard.length;
										i++
									) {
										twilight_self.addMove(
											this.game.deck[0].crypt[
												pos_to_discard[i]
											]
										);
									}
									twilight_self.addMove(
										'tehran\tus\t' + cards_discarded
									);
									twilight_self.endTurn();
								} else {
									pos_to_discard.push(
										cardoptions.indexOf(action2)
									);
									cards_discarded++;
									$(`#${action2}.card`).hide();
									twilight_self.addMove(
			...
			if (mv[0] == 'limit') {
				if (mv[1] == 'china') {
					this.game.state.events.china_card_in_play = 1;
				}
				if (mv[1] == 'coups') {
					this.game.state.limit_coups = 1;
				}
				if (mv[1] == 'spacerace') {
					this.game.state.limit_spacerace = 1;
				}
				if (mv[1] == 'realignments') {
					this.game.state.limit_realignments = 1;
				}
				if (mv[1] == 'placement') {
					this.game.state.limit_placement = 1;
				}
				if (mv[1] == 'milops') {
					this.game.state.limit_milops = 1;
				}
				if (mv[1] == 'ignoredefcon') {
					this.game.state.limit_ignoredefcon = 1;
				}
				if (mv[1] == 'region') {
					this.game.state.limit_region.push(mv[2]);
				}
				this.game.queue.splice(qe, 1);
			}
			...
			if (mv[0] == 'latinamericandebtcrisis') {
				...
				if (this.game.player == 1) {
					...
					if (potCountries.length == 0) {
						this.addMove(
							'NOTIFY\tUSSR has no countries with influence to double'
						);
						this.endTurn();
						return 0;
					}
					...
					this.updateStatus(
						'Select ' +
							countries_to_double +
							' countries in South America to double USSR influence'
					);
					...
					$('.easterneurope').on('click', function () {
						...
						if (twilight_self.countries[countryname].place == 1) {
							let ops_to_place =
								twilight_self.countries[countryname].ussr;
							...
							twilight_self.displayModal(
								'Invalid Target',
								'Already doubled influence'
							);
						}
					});
				} else {
					this.updateStatus(
						'USSR is deciding which country to double their influence'
					);
				}
				return 0;
			}
			...
			if (mv[0] == 'northsea') {
				if (this.game.player == 2) {
					...
					this.updateStatus(
						'US determining whether to take extra turn'
					);
				}
				shd_continue = 0;
			}
			...
			if (mv[0] == 'space') {
				...
				if (mv[2] != 'china') {
					this.game.deck[0].discards[mv[2]] =
						this.game.deck[0].cards[mv[2]];
				}
				this.game.queue.splice(qe, 1);
			}
			...
			if (mv[0] == 'unlimit') {
				if (mv[1] == 'china') {
					this.game.state.events_china_card_in_play = 0;
				}
				if (mv[1] == 'cmc') {
				...
				if (mv[1] == 'coups') {
					this.game.state.limit_coups = 0;
				}
				if (mv[1] == 'spacerace') {
					this.game.state.limit_spacerace = 0;
				}
				if (mv[1] == 'realignments') {
					this.game.state.limit_realignments = 0;
				}
				if (mv[1] == 'placement') {
					this.game.state.limit_placement = 0;
				}
				if (mv[1] == 'milops') {
					this.game.state.limit_milops = 0;
				}
				if (mv[1] == 'ignoredefcon') {
					this.game.state.limit_ignoredefcon = 0;
				}
				if (mv[1] == 'region') {
					this.game.state.limit_region = [];
				}
				this.game.queue.splice(qe, 1);
			}
			...
			if (mv[0] == 'dynamic_deck_management') {
				...
				if (
					this.game.saito_cards_added.length > 0 &&
					this.game.options.deck === 'saito'
				) {
			...
			if (mv[0] == 'pinochet') {
				...
				if (this.game.player == 1) {
					...
					for (var i in this.countries) {
						if (
							this.countries[i].region == 'camerica' ||
							this.countries[i].region == 'samerica'
						) {
					...
					this.updateStatus(
						'Remove 1 US influence from Central or South America'
					);
            ...
            <li class="option" id="hand">give to opponent</li>
					...
					twilight_self.updateStatusWithOptions(
						...
						function (action2) {
							if (action2 === 'play') {
								twilight_self.addMove(
									`NOTIFY\tUS pulls and plays ${twilight_self.cardToText(
										card
									)}`
								);
							...
							if (action2 == 'hand') {
								twilight_self.addMove(
									`NOTIFY\tUS hands ${twilight_self.cardToText(
										card
									)} to USSR`
								);
								twilight_self.addMove(
			...
			if (mv[0] == 'chernobyl') {
				...
				if (this.game.player == 1) {
					this.displayModal(
						'Chernobyl',
						`Influence placements restricted in ${
							this.region_key[mv[1]]
						}`
					);
				}
			}
			...
			if (mv[0] == 'aldrichreveal') {
				if (this.game.player == 2) {
					...
					for (let i = 0; i < this.game.deck[0].hand.length; i++) {
						...
						revealed +=
							this.game.deck[0].cards[this.game.deck[0].hand[i]]
								.name;
			...
			if (mv[0] == 'aldrich') {
				...
				if (mv[1] == 'us') {
					...
					let user_message = `${this.cardToText(
						'aldrichames'
					)}: USSR discard card from US hand:`;
					let uscards = [];
					this.game.queue.splice(qe, 1);
				...
				if (mv[1] == 'ussr') {
					...
					this.game.queue.splice(qe, 1);
					this.updateLog(
						`USSR forces US to discard ${this.cardToText(mv[2])}`
					);
					shd_continue = 1;
				}
			}
			...
			if (mv[0] === 'cambridge') {
				if (this.game.player == 1) {
					...
					let placetxt = `${this.cardToText(
						'cambridge'
					)}: ${player.toUpperCase()} place 1 OP in`;
			...
			if (mv[0] === 'teardownthiswall') {
				if (this.game.player == 2) {
					...
					let user_message =
						'Tear Down this Wall is played -- US may make 3 OP free Coup Attempt or Realignments in Europe.';
					let html = `<ul>
            ...
            <li class="option" id="skiptear">skip coup</li>
					...
					twilight_self.updateStatusWithOptions(
						...
						function (action2) {
							if (action2 == 'skiptear') {
								twilight_self.updateStatus(
									'Skipping Tear Down this Wall...'
								);
								twilight_self.addMove(
									'resolve\tteardownthiswall'
								);
								twilight_self.endTurn();
							}
							...
							if (action2 == 'taketear') {
								...
								twilight_self.addMove(
									'limit\tregion\tsamerica'
								);
								twilight_self.addMove(
									'limit\tregion\tcamerica'
								);
			...
			if (mv[0] === 'deal') {
				if (this.game.player == mv[1]) {
					let cards_needed_per_player =
						this.game.state.round >= 4 ? 9 : 8;
					...
					for (let z = 0; z < this.game.deck[0].hand.length; z++) {
						if (this.game.deck[0].hand[z] == 'china') {
							my_cards--;
							console.log(
								'REDUCING CARDS NEEDED BECAUSE I HOLD CHINA to: ' +
									my_cards
							);
						}
					}
					...
					console.log(
						'CARDS NEEDED PER PLAYER: ' +
							cards_needed_per_player +
							' - ' +
							my_cards
					);
				...
				this.updateStatus(
					player.toUpperCase() + ' is fetching new cards'
				);
				return 0;
			}
			...
			if (mv[0] === 'reshuffle') {
				...
				if (this.game.deck[0].crypt.length < reshuffle_limit) {
					...
					if (
						...
						console.log(
							'deck has discards 1:    ' +
								this.game.deck[0].discards.length
						);
						console.log(
							'deck has discards 2: ' +
								Object.keys(discarded_cards).length
						);
						...
						if (player1_cards > 0) {
							this.game.queue.push(
								'DEAL\t1\t2\t' + player2_cards
							);
							this.game.queue.push(
								'DEAL\t1\t1\t' + player1_cards
							);
						}
						this.updateStatus(
							'Dealing remaining cards from draw deck before reshuffling...'
						);
						this.updateLog(
							`Dealing ${cards_available} remaining cards from draw deck before reshuffling...`
						);
					}
				}
			}
			...
			if (mv[0] === 'ops') {
				...
				if (mod_ops > orig_ops) {
					this.updateLog(
						mv[1].toUpperCase() +
							` plays ${this.game.state.event_name} for ${
								mv[3]
							} OPS (+${mod_ops - orig_ops} bonus)`
					);
					...
					this.updateLog(
						mv[1].toUpperCase() +
							` plays ${this.game.state.event_name} for ${
								mv[3]
							} OPS (-${orig_ops - mod_ops} penalty)`
					);
				} else {
					this.updateLog(
						mv[1].toUpperCase() +
							` plays ${this.game.state.event_name} for ${mv[3]} OPS`
					);
				}
				...
				if (this.game.deck[0].cards[mv[2]] != undefined) {
					if (this.game.deck[0].cards[mv[2]].player === 'us') {
						if (mv[1] === 'ussr') {
							this.game.state.stats.ussr_us_ops += parseInt(
								mv[3]
							);
						}
						if (mv[1] === 'us') {
					...
					if (this.game.deck[0].cards[mv[2]].player === 'ussr') {
						if (mv[1] === 'ussr') {
							this.game.state.stats.ussr_ussr_ops += parseInt(
								mv[3]
							);
						}
						if (mv[1] === 'us') {
							this.game.state.stats.us_ussr_ops += parseInt(
								mv[3]
							);
						}
					}
					if (this.game.deck[0].cards[mv[2]].player == 'both') {
						if (mv[1] == 'ussr') {
							this.game.state.stats.ussr_neutral_ops += parseInt(
								mv[3]
							);
						}
						if (mv[1] == 'us') {
							this.game.state.stats.us_neutral_ops += parseInt(
								mv[3]
							);
						}
					}
			...
			if (mv[0] === 'milops') {
				this.updateLog(
					mv[1].toUpperCase() + ' receives ' + mv[2] + ' milops'
				);
				if (mv[1] === 'us') {
			...
			if (mv[0] === 'vp') {
				if (mv.length > 3) {
					if (parseInt(mv[3]) == 1) {
						this.updateLog(
							mv[1].toUpperCase() + ' receives ' + mv[2] + ' VP',
							1
						);
						if (mv[1] === 'us') {
			...
			if (mv[0] === 'coup') {
				...
				if (this.game.state.limit_milops != 1) {
					...
					//
					if (mv[1] == 'us') {
						this.game.state.milops_us += this.modifyOps(
							parseInt(mv[3]),
							card,
							'us'
						);
					...
					if (mv[1] == 'ussr') {
						this.game.state.milops_ussr += this.modifyOps(
							parseInt(mv[3]),
							card,
							'ussr'
						);
			...
			if (mv[0] === 'event') {
				...
				this.updateLog(
					mv[1].toUpperCase() +
						` triggers ${this.game.state.event_name} as an event`
				);
				...
				if (shd_continue == 0) {
					...
					//
					if (mv[1] != 'china') {
						//China card gets processed seperately
						//
						...
						for (var i in this.game.deck[0].cards) {
							if (mv[2] == i) {
								if (this.game.deck[0].cards[i].recurring != 1) {
									...
									//
									if (
										this.game.state.events.johnpaul == 0 &&
										mv[2] == 'solidarity'
									) {
										event_removal = 0;
									}
									...
									//
									if (
										this.game.state.events.starwars == 0 &&
										mv[2] == 'starwars'
									) {
										event_removal = 0;
									}
									...
									//
									if (
										this.game.state.events.ourmanintehran ==
											0 &&
										mv[2] == 'ourmanintehran'
									) {
										event_removal = 0;
									...
									//
									if (
										this.game.state.events.kitchendebates ==
											0 &&
										mv[2] == 'kitchendebates'
									) {
										event_removal = 0;
			...
			if (mv[0] === 'stability') {
				...
				if (this.countries[c] != undefined) {
					...
					this.updateLog(
						this.countries[c].name +
							' stability is now ' +
							this.countries[c].control
					);
				}
				this.game.queue.splice(qe, 1);
			}
			...
			if (mv[0] === 'setvar') {
				...
				if (this.game.player != mv[1]) {
					if (mv[2] == 'opponent_cards_in_hand') {
						this.game.state.opponent_cards_in_hand = parseInt(
							mv[3]
						);
					}
					if (mv[3]) {
						if (mv[3] == 'back_button_cancelled') {
							this.game.state.back_button_cancelled = parseInt(
								mv[4]
							);
						}
					}
			...
			if (mv[0] === 'remove') {
				if (player != mv[1]) {
					this.removeInfluence(mv[3], parseInt(mv[4]), mv[2]);
				}
				this.game.queue.splice(qe, 1);
			}
			...
			if (mv[0] === 'resolve') {
				...
				//
				if (mv[1] === 'junta') {
					this.game.state.events.junta = 0;
				}
				...
				if (qe == 0) {
					...
					if (mv[1] == 'unintervention') {
						...
						if (this.game.state.events.u2 == 1) {
							this.updateLog(
								'USSR gains +1 VP bonus from U2 Intervention'
							);
							this.game.state.vp--;
							this.updateVictoryPoints();
						}
					...
					if (le <= 0) {
						...
						if (
							lmv[0] == 'placement_bonus' &&
							mv[1] == 'placement_bonus'
						) {
							this.game.queue.splice(le, 2);
							rmvd = 1;
						}
				...
				for (var i in this.game.deck[0].cards) {
					if (mv[1] == i) {
						if (this.game.deck[0].cards[i].recurring != 1) {
							this.updateLog(
								this.cardToText(i) + ' removed from game'
							);
							this.game.deck[0].removed[i] =
								this.game.deck[0].cards[i];
							delete this.game.deck[0].cards[i];
			...
			if (mv[0] === 'placement') {
				...
				if (this.game.player == mv[1]) {
					...
					this.updateStatusAndListCards(
						`${
							mv[1] == 1 ? 'USSR' : 'US'
						} is making its initial placement of influence:`
					);
				}
			...
			if (mv[0] === 'placement_bonus') {
				...
				if (this.game.player == mv[1]) {
					...
					this.updateStatusAndListCards(
						`${
							mv[1] == 1 ? 'USSR' : 'US'
						} is making its bonus placement of ${mv[2]} influence`
					);
				}
			...
			if (mv[0] === 'round') {
				...
				try {
					...
					if (this.game.state.us_defcon_bonus == 1) {
						...
						if (this.isControlled('us', 'canada') == 1) {
							this.updateLog(
								'NORAD triggers: US places 1 influence in country with US influence'
							);
				...
				if (this.game.state.events.khruschev_thaw) {
					...
					if (this.game.player == 1) {
                      ...
                      <li class="option" id="nope">do not play</li>
						...
						this.updateStatusWithOptions(
							'Do you want to take an extra turn? (Khruschev Thaw)',
							html,
							function (action2) {
								if (action2 == 'play') {
								...
								if (action2 == 'nope') {
									twilight_self.addMove(
										'NOTIFY\tUSSR does not play extra turn'
									);
									twilight_self.endTurn(1);
								}
							}
						...
						this.updateStatus(
							'USSR is deciding whether to take extra turn'
						);
					}
					return 0;
				}
				...
				if (this.game.state.events.northseaoil_bonus == 1) {
					...
					if (this.game.player == 2) {
                      ...
                      <li class="option" id="nope">do not play</li>
						...
						this.updateStatusWithOptions(
							'Do you want to take an extra turn? (North Sea Oil)',
							html,
							function (action2) {
								if (action2 == 'play') {
									twilight_self.addMove('play\t2');
								...
								if (action2 == 'nope') {
									twilight_self.addMove(
										'NOTIFY\tUS does not play extra turn'
									);
									twilight_self.endTurn(1);
								}
							}
						...
						this.updateStatus(
							'US is deciding whether to take extra turn'
						);
					}
				...
				if (
					...
					try {
						...
						let bonus_player =
							this.game.state.eagle_has_landed == 'us' ? 2 : 1;

						if (this.game.player != bonus_player) {
							this.updateStatus(
								this.game.state.eagle_has_landed.toUpperCase() +
									' is deciding whether to discard a card'
							);
							return 0;
						}
						...
						if (available_cards.length == 0) {
							this.updateLog(
								'No cards in hand, skipping end-of-turn discard'
							);
							this.addMove(
								'NOTIFY\tSkipping Eagle / Bear has Landed'
							);
							this.endTurn();
						} else {
							let user_message = `${this.game.state.eagle_has_landed.toUpperCase()} may discard a card: (${
								bonus_player == 1 ? 'Bear' : 'Eagle'
							} Has Landed)`;
							let html = '<ul>';
							for (let i = 0; i < available_cards.length; i++) {
								html += `<li class="option" id="${
									...
									twilight_self.game.deck[0].cards[
										available_cards[i]
									].name
								}</li>`;
							}
							...
							this.updateStatusWithOptions(
								...
								function (action2) {
									if (action2 == 'nope') {
										twilight_self.addMove(
											'NOTIFY\t' +
												twilight_self.game.state.eagle_has_landed.toUpperCase() +
										...
										twilight_self.removeCardFromHand(
											action2
										);
										twilight_self.addMove(
											'discard\t' +
												twilight_self.game.state
													.eagle_has_landed +
												'\t' +
												action2
										);
										twilight_self.addMove(
											'NOTIFY\t' +
												twilight_self.game.state.eagle_has_landed.toUpperCase() +
												` discards ${twilight_self.cardToText(
													action2
												)}`
										);
										twilight_self.endTurn(1);
				...
				if (
					...
					let bonus_player =
						this.game.state.space_station == 'us' ? 2 : 1;

					if (this.game.player != bonus_player) {
						this.updateStatus(
							this.game.state.space_station.toUpperCase() +
								' is deciding whether to take extra turn'
						);
						return 0;
					}
					...
					this.updateStatusWithOptions(
						'Do you want to take an extra turn: (Space Shuttle)',
						html,
						function (action2) {
							if (action2 == 'play') {
							...
							if (action2 == 'nope') {
								twilight_self.addMove(
									'NOTIFY\t' +
										twilight_self.game.state.space_station.toUpperCase() +
										' does not play extra turn'
								);
								twilight_self.endTurn(1);
							}
						}
				...
				if (this.game.state.round > 1) {
					while (
						this.game.state.stats.round.length <
						this.game.state.round - 1
					) {
						this.game.state.stats.round.push({});
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].us_scorings = this.game.state.stats.us_scorings;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].ussr_scorings = this.game.state.stats.ussr_scorings;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].us_ops = this.game.state.stats.us_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].ussr_ops = this.game.state.stats.ussr_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].us_modified_ops =
						...
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].us_us_ops = this.game.state.stats.us_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].ussr_us_ops = this.game.state.stats.ussr_ussr_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].us_ussr_ops = this.game.state.stats.us_ussr_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].ussr_ussr_ops = this.game.state.stats.ussr_ussr_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].us_neutral_ops = this.game.state.stats.us_neutral_ops;
						this.game.state.stats.round[
							this.game.state.stats.round.length - 1
						].ussr_neutral_ops =
				...
				this.updateStatus(
					'Preparing for round ' + this.game.state.round
				);
				...
				if (this.game.state.round > 1) {
					...
					if (this.game.state.round == 4) {
						...
						if (this.game.options.deck === 'saito') {
							...
							// remove
							//
							this.removeCardFromDeckNextDeal(
								'summit',
								'Removed'
							);
							if (
							...
							//
							if (
								this.game.state.events.cia_created == 1 &&
						...
						this.game.queue.push(
							'DECK\t1\t' + JSON.stringify(mid_war_cards)
						);
						//this.game.queue.push("HANDBACKUP\t1");
						this.game.queue.push('DECKBACKUP\t1');
					...
					if (this.game.state.round == 4) {
						if (this.game.options.deck === 'saito') {
							if (
								...
								this.game.state.events.bayofpigs != 1 &&
							...
							if (
								this.game.state.events.vietname_revolts == 1 &&
								this.game.state.events.fallofsaigon_added == 0
							) {
					...
					if (this.game.state.round == 8) {
						...
						if (this.game.options.deck === 'saito') {
							...
							//
							if (
								this.isControlled('ussr', 'southkorea') == 1 &&
								this.game.state.events
									.revolutionsof1989_added != 1
							) {
							...
							//
							if (
								this.game.state.events.rustinredsquare_added !=
								1
							) {
								this.game.state.events.rustinredsquare_added = 1;
								this.addCardToDeck(
									'rustinredsquare',
									'Replace Cambridge Five'
								);
							}
							//
							// KAL007 or 1989
						...
						this.game.queue.push(
							'DECK\t1\t' + JSON.stringify(late_war_cards)
						);
						this.game.queue.push('DECKBACKUP\t1');
					...
					if (this.game.options.deck === 'saito') {
						if (
							this.game.saito_cards_added.length > 0 ||
							this.game.saito_cards_removed.length > 0
						) {
							if (this.game.saito_cards_added.length > 0) {
								this.deck_overlay.render();
							}
							this.game.saito_cards_added = [];
							this.game.saito_cards_added_reason = [];
			...
			if (mv[0] === 'play') {
				...
				//
				try {
					start_turn_game_state = JSON.parse(
						JSON.stringify(this.game.state)
					);
					start_turn_game_queue = JSON.parse(
	...
	playHeadlinePostModern(stage, hash = '', xor = '', card = '') {
		...
		if (this.game.state.man_in_earth_orbit == '') {
			if (stage == 'headline1') {
				...
				this.game.state.headline_opponent_card =
					this.game.state.sp[2 - this.game.player];
				stage = 'headline6';
			}
		} else {
			...
			if (stage == 'headline1') {
				...
				if (this.game.player == first_picker) {
					...
					this.updateStatusAndListCards(
						playerside + ' picks headline card first'
					);
				}
				return 0;
			}
			...
			if (stage == 'headline2') {
				this.updateLog(
					this.game.state.man_in_earth_orbit.toUpperCase() +
						' selecting headline card second'
				);
				...
				if (this.game.player == second_picker) {
					...
					this.updateStatusAndListCards(
						`${this.game.state.man_in_earth_orbit.toUpperCase()} picking headline card second`
					);
				}
				return 0;
			}
		...
		if (stage == 'headline6') {
			console.log(
				'THESE ARE OUR HEADLINES: ' + uscard + ' -- ' + ussrcard
			);
			...
			if (
				...
				this.updateLog(
					`US headlines ${this.cardToText(
						'defectors'
					)} and cancels USSR headline.`
				);
				...
				this.updateStatus(
					`>${this.cardToText(
						'defectors'
					)} cancels USSR headline. Moving into first turn...`
				);
			} else {
				let statusMsg = '';
				if (this.game.state.player_to_go == 1) {
					statusMsg = `USSR headlines ${this.cardToText(
						ussrcard
					)}. US headlines ${this.cardToText(uscard)}`;
					this.updateLog(
						`USSR headlines ${this.cardToText(ussrcard)}.`
					);
					this.updateLog(`US headlines ${this.cardToText(uscard)}`);
				} else {
					statusMsg = `US headlines ${this.cardToText(
						uscard
					)}. USSR headlines ${this.cardToText(ussrcard)}`;
					this.updateLog(`US headlines ${this.cardToText(uscard)}.`);
					this.updateLog(
				...
				if (this.game.state.player_to_go == this.game.player) {
					this.addMove('resolve\theadline');
					this.addMove(
						'headline\theadline7\t' + this.game.state.player_to_go
					);
		...
		if (stage == 'headline7') {
			...
			if (
				...
				this.updateLog(
					`USSR headlines ${this.cardToText(
						ussrcard
					)}, but it is cancelled by ${this.cardToText('defectors')}`
				);
				...
				let statusMsg = '';
				if (this.game.state.player_to_go == 1) {
					statusMsg = `Resolving USSR headline: ${this.cardToText(
						ussrcard
					)}`;
				} else {
					statusMsg = `Resolving US headline: ${this.cardToText(
						uscard
					)}`;
				}
	...
	playerPickHeadlineCard() {
		...
		if (this.game.state.man_in_earth_orbit) {
			if (this.game.state.man_in_earth_orbit === player) {
				x = `${player.toUpperCase()} pick your headline card second (opponent selected: ${twilight_self.cardToText(
					twilight_self.game.state.headline_opponent_card
				)})`;
			} else {
		...
		if (twilight_self.confirm_moves == 1) {
			twilight_self.cardbox.skip_card_prompt = 0;
		}
		twilight_self.hud.attachControlCallback(async function (card) {
			if (twilight_self.confirm_moves == 1) {
				twilight_self.cardbox.skip_card_prompt = 1;
			} //You want to skip confirmations after Headline???
	...
	async playerTurnHeadlineSelected(card, player) {
		...
		if (card == 'unintervention') {
			this.displayModal(
				'Invalid Headline',
				'You cannot headline UN Intervention'
			);
			return;
		}

		twilight_self.game.state.headline_card = card;
		twilight_self.game.state.headline_xor = twilight_self.app.crypto.hash(
			Math.random().toString()
		);
		twilight_self.game.state.headline_hash =
			twilight_self.app.crypto.encodeXOR(
				twilight_self.app.crypto.stringToHex(
					twilight_self.game.state.headline_card
				),
				twilight_self.game.state.headline_xor
			);
		...
		if (this.game.state.man_in_earth_orbit) {
			...
			let card_sig = twilight_self.app.crypto.signMessage(
				card,
				privateKey
			);
			let hash2_sig = twilight_self.app.crypto.signMessage(
				hash2,
				privateKey
			);
			...
			let hash3_sig = twilight_self.app.crypto.signMessage(
				hash3,
				privateKey
			);
		...
		//
		twilight_self.updateStatus(
			'simultaneous blind pick... encrypting selected card'
		);
	...
	playMove() {
		...
		for (i = 0; i < this.game.deck[0].hand.length; i++) {
			if (
				this.game.deck[0].cards[this.game.deck[0].hand[i]]?.scoring == 1
			) {
						...
						function (action2) {
							...
							if (
								...
								if (action2 === 'skip_w_card') {
									...
									twilight_self.addMove(
										'NOTIFY\tUS is drawing a bonus card'
									);
								}
								twilight_self.addMove('vp\tus\t1\t0');
								twilight_self.addMove(
									'NOTIFY\tUS skips a turn for 1 VP as a Great Society'
								);
								twilight_self.endTurn();
							}
							if (
								action2 === 'scoring' ||
								action2 === 'scoring_w_card'
							) {
								twilight_self.addMove('resolve\tplay');
								twilight_self.addMove('vp\tus\t1\t0');
								twilight_self.addMove(
									'NOTIFY\tUS plays a scoring card for 1 VP as a Great Society'
								);
	...
	playerTurn(selected_card = null) {
			...
			if (this.game.deck[0].hand.length == 1) {
				if (this.game.deck[0].hand[0] == 'china') {
					if (is_player_skipping_playing_china_card) {
						...
						let user_message = `You only have the ${this.cardToText(
							'china'
						)} card remaining. Do you wish to play it this turn?`;
						let html =
							'<ul><li class="option" id="play">play card</li><li class="option" id="skipturn">skip turn</li></ul>';
						this.updateStatusWithOptions(
							user_message,
							html,
							function (action) {
								...
								if (action === 'skipturn') {
									...
									if (twilight_self.game.player == 1) {
										twilight_self.addMove(
											'NOTIFY\tUSSR chooses not to play the China Card'
										);
									} else {
										twilight_self.addMove(
											'NOTIFY\tUS chooses not to play the China Card'
										);
									}
									twilight_self.endTurn();
								}
		...
		if (
			(player === 'ussr' && this.game.state.events.missile_envy == 1) ||
			(player === 'us' && this.game.state.events.missile_envy == 2)
		) {
		...
		if (
			this.game.player == this.game.state.events.cubanmissilecrisis &&
			this.game.player > 0
		) {
		...
		if (
			this.game.state.headline == 0 &&
			((this.game.player == 1 && this.game.state.events.beartrap == 1) ||
				(this.game.player == 2 && this.game.state.events.quagmire == 1))
		) {
			//
			...
			let moves_remaining =
				rounds_in_turn - this.game.state.turn_in_round;

			user_message = `Select a card for ${
				this.game.player == 1
					? this.cardToText('beartrap')
					: this.cardToText('quagmire')
			}: `;
			...
			if (playable_cards_handled == 0) {
				...
				if (
					cards_available > 0 &&
					scoring_cards_available <= moves_remaining
				) {
					playable_cards = [];
					for (i = 0; i < this.game.deck[0].hand.length; i++) {
						if (
					...
					if (scoring_cards_available > 0) {
						if (this.game.player == 1) {
							user_message =
								'Bear Trap restricts you to Scoring Cards: ';
						} else {
							user_message =
								'Quagmire restricts you to Scoring Cards: ';
						}
						playable_cards = [];
						for (i = 0; i < this.game.deck[0].hand.length; i++) {
							if (
						...
						if (this.game.state.events.beartrap == 1) {
							user_message =
								'No cards playable due to Bear Trap: ';
						} else {
							user_message =
								'No cards playable due to Quagmire: ';
						}
						playable_cards = [];
		...
		if (selected_card == null && this.game.deck[0].hand.length == 0) {
			...
			this.addMove(
				`NOTIFY\t${player.toUpperCase()} skipping turn... no cards left to play`
			);
			this.endTurn();
	...
	async playerTurnCardSelected(card, player) {
		...
		if (card === 'skipturn') {
			...
			twilight_self.addMove('resolve\tplay');
			twilight_self.addMove(
				'NOTIFY\t' + player.toUpperCase() + ' has no cards playable.'
			);
			twilight_self.endTurn();
			return 0;
		}
		...
		let scoring_cards_available = 0;
		let rounds_in_turn = 6;
		if (twilight_self.game.state.round > 3) {
			rounds_in_turn = 7;
		}
		let moves_remaining =
			rounds_in_turn - twilight_self.game.state.turn_in_round;
		...
		if (
			scoring_cards_available > 0 &&
			scoring_cards_available > moves_remaining &&
			ac[card]?.scoring == 0
		) {
			let c = await sconfirm(
				'Holding a scoring card at the end of the turn will lose you the game. Still play this card?'
			);
			if (c) {
			} else {
				return;
		...
		//
		if (
			twilight_self.game.state.events.wwby == 1 &&
			twilight_self.game.state.headline == 0
		) {
			if (player == 'us') {
				if (card != 'unintervention') {
					if (twilight_self.playerHoldsCard('unintervention')) {
						let c = await sconfirm(
							`If you don't play ${twilight_self.cardToText(
								'unintervention'
							)}, USSR will gain 3 VP. Still play this card?`
						);
						if (c) {
						} else {
							return;
		...
		if (
			twilight_self.game.state.headline == 0 &&
			((twilight_self.game.state.events.quagmire == 1 &&
				twilight_self.game.player == 2) ||
				(twilight_self.game.state.events.beartrap == 1 &&
					twilight_self.game.player == 1))
		) {
			//
		...
		if (ac[card]?.scoring == 1) {
			...
			if (card == 'unintervention') {
				...
				for (
					let b = 0;
					b < twilight_self.game.deck[0].hand.length;
					b++
				) {
					let tmpc = twilight_self.game.deck[0].hand[b];
					if (tmpc != 'china') {
						if (twilight_self.game.player == 1) {
							if (ac[tmpc].player === 'us') {
								opponent_event_in_hand = 1;
							}
						} else {
							if (ac[tmpc].player === 'ussr') {
								opponent_event_in_hand = 1;
							}
						}
					}
				}
				if (opponent_event_in_hand == 0) {
					can_play_event = 0;
				}
			}
			if (card == 'china') {
			...
			if (can_play_event == 1) {
				announcement += '<li class="option" id="event">play event</li>';
			}
			...
			//
			if (
				twilight_self.game.state.events.cubanmissilecrisis &&
				twilight_self.game.state.events.cubanmissilecrisis ===
					twilight_self.game.player
			) {
				if (twilight_self.canCancelCMC()) {
					announcement +=
						'<li class="option" id="cancel_cmc">cancel cuban missile crisis</li>';
				}
			}
			let header_msg = `${player.toUpperCase()} playing <span>${
				ac[card].name
			}</span>`;
		...
		twilight_self.hud.attachControlCallback(async function (action) {
			...
			if (
				(twilight_self.game.player == 2 &&
					twilight_self.game.state.events.missile_envy == 2) ||
				(twilight_self.game.player == 1 &&
					twilight_self.game.state.events.missile_envy == 1)
			) {
				if (card == 'missileenvy') {
			...
			if (action == 'event') {
				...
				if (ac[card].player != 'both' && ac[card].player != player) {
					let fr_header =
						'This is your opponent\'s event. Are you sure you wish to play it for the event instead of the OPS?';
					let fr_msg =
						'<ul><li class="option" id="playevent">play event</li></ul>';
					...
					twilight_self.updateStatusWithOptions(
						...
						function (action) {
							...
							if (action === 'dontshowme') {
								...
								twilight_self.saveGamePreference(
									'confirm_moves',
									0
								);
								try {
									$('.game-confirm').text('Newbie Mode');
								} catch (err) {}
								action = 'playevent';
							}
	...
	playOps(player, ops, card) {
		...
		if (player === me) {
			...
			if (twilight_self.game.state.event_before_ops == 1) {
				bind_back_button_state = false;
			}
			if (twilight_self.game.state.headline == 1) {
				bind_back_button_state = false;
			}
			if (
			...
			let html = '<ul>';
			if (this.game.state.limit_placement == 0) {
				html += '<li class="option" id="place">place influence</li>';
			}
			if (this.game.state.limit_coups == 0) {
				html += '<li class="option" id="coup">launch coup</li>';
			}
			if (this.game.state.limit_realignments == 0) {
				html += '<li class="option" id="realign">realign country</li>';
			}
			if (this.game.state.events.unintervention == 1) {
				html += this.isSpaceRaceAvailable(ops);
			}
			if (
				this.game.player == this.game.state.events.cubanmissilecrisis &&
				this.game.state.events.cubanmissilecrisis > 0
			...
			twilight_self.updateStatusWithOptions(
				`${player.toUpperCase()} plays ${ops} OPS:`,
				html
			);
			...
			twilight_self.hud.attachControlCallback(async function (action2) {
				...
				if (action2 == 'cancel_cmc') {
					...
					if (
						twilight_self.game.queue[
							twilight_self.game.queue.length - 1
						].split('\t')[0] === 'ops'
					) {
                ...
                <li class="option" id="dontshowme">don't confirm (expert mode)...</li>
						...
						twilight_self.bindBackButtonFunction(() => {
							twilight_self.playerOps(player, ops, card);
						});
						twilight_self.updateStatusWithOptions(
							fr_header,
							fr_msg,
				...
				if (action2 == 'place') {
					...
					if (j == 1) {
						twilight_self.uneventOpponentControlledCountries(
							player,
							card
						);
					}

					twilight_self.playerPlaceInfluence(
						player,
						(country, player) => {
							j--;
				...
				if (action2 == 'coup') {
					...
					if (
						...
						let c = await sconfirm(
							'Are you sure you wish to coup during the Cuban Missile Crisis?'
						);
						if (c) {
						} else {
							twilight_self.playOps(player, ops, card);
				...
				if (action2 == 'realign') {
					...
					$('.country').on('click', async function () {
						...
						//
						if (
							twilight_self.game.state.limit_region.indexOf(
								twilight_self.countries[c].region
							) > -1
						) {
						...
						//
						if (
							twilight_self.game.state.limit_ignoredefcon == 0 &&
							twilight_self.game.state.events.inftreaty == 0
						) {
							if (
								twilight_self.countries[c].region == 'europe' &&
								twilight_self.game.state.defcon < 5
							) {
								failureReason =
									'DEFCON prevents realignments in Europe';
							}
							if (
								twilight_self.countries[c].region == 'asia' &&
								twilight_self.game.state.defcon < 4
							) {
								failureReason =
									'DEFCON prevents realignments in Asia';
							}
							if (
								twilight_self.countries[c].region == 'seasia' &&
								twilight_self.game.state.defcon < 4
							) {
								failureReason =
									'DEFCON prevents realignments in Asia';
							...
							if (
								twilight_self.countries[c].region ==
									'mideast' &&
								twilight_self.game.state.defcon < 3
							) {
								// SAITO COMMUNITY CARD - Carter Doctrine
								if (
									twilight_self.game.state.events
										.carterdoctrine != 1
								) {
									failureReason =
										'DEFCON prevents realignments in the Middle-East';
								}
							}
						}

						if (
							twilight_self.game.state.events.usjapan == 1 &&
							c == 'japan' &&
							player == 'ussr'
						) {
							failureReason =
								'US / Japan Alliance prevents realignments in Japan';
						}

						if (
							twilight_self.countries[c].region == 'europe' &&
							twilight_self.game.state.events.nato == 1 &&
							player == 'ussr'
						) {
							if (twilight_self.isControlled('us', c) == 1) {
								if (
									...
									failureReason =
										'NATO prevents realignments of US-controlled countries in Europe';
								}
							}
						}
						...
						if (
							(player == 'us' &&
								twilight_self.countries[c].ussr <= 0) ||
							(player == 'ussr' &&
								twilight_self.countries[c].us <= 0)
						) {
						...
						if (failureReason.length > 0) {
							...
							if (
								...
								twilight_self.game.state.events.china_card_eligible = 0;
							}
							...
							//
							twilight_self.updateStatusWithOptions(
								`Pick a target to realign (${alignment_rolls} rolls), or:`,
								'<ul><li class="option" id="cancelrealign">end turn</li></ul>',
								function (action2) {
									if (action2 == 'cancelrealign') {
										//Not a cancel, keeps realignment rolls so far...
			...
			this.updateStatusAndListCards(
				`${player.toUpperCase()} playing ${
					this.game.state.event_name
				} for ${ops} OPS`
			);
		}
	...
	canCancelCMC() {
		if (this.game.player == 1 && this.countries['cuba'].ussr >= 2) {
			return 1;
		}
		if (this.game.player == 2 && this.countries['turkey'].us >= 2) {
			return 1;
		}
		if (this.game.player == 2 && this.countries['westgermany'].us >= 2) {
			return 1;
		}
		return 0;
	}
  ...
  */
	cancelCubanMissileCrisis() {
		let twilight_self = this;
		if (twilight_self.game.player == 0) {
			return;
		} //just in case

		if (twilight_self.game.player == 1) {
			twilight_self.addMove(
				'setvar\tgame\tstate\tevents\tcubanmissilecrisis\t0'
			);
			twilight_self.addMove(
				'setvar\tgame\tstate\tevents\tcubanmissilecrisis_cancelled\t1'
			);
			twilight_self.addMove(
				'setvar\tgame\tstate\tevents\tcubanmissilecrisis_removal_country\tcuba'
			);
			...
			twilight_self.addMove(
				'NOTIFY\tUSSR has cancelled the Cuban Missile Crisis'
			);
			...
			html += '</ul>';
			twilight_self.updateStatusWithOptions(
				'Select country from which to remove influence:',
				html,
				function (action2) {
					twilight_self.addMove(
						'setvar\tgame\tstate\tevents\tcubanmissilecrisis\t0'
					...
					twilight_self.addMove(
						'setvar\tgame\tstate\tevents\tcubanmissilecrisis_removal_country\t' +
							action2
					);
					...
					twilight_self.addMove(
						'NOTIFY\tUS has cancelled the Cuban Missile Crisis'
					);
					twilight_self.endTurn();
	...
	revertTurn() {
		...
		console.log(
			'CMC 1: ' +
				twilight_self.game.state.events.cubanmissilecrisis_cancelled
		);
		console.log(
			'CMC 2: ' +
				twilight_self.game.state.events
					.cubanmissilecrisis_removal_country
		);
		...
		if (twilight_self.game.state.events.cubanmissilecrisis_cancelled == 1) {
			if (
				...
				if (
					twilight_self.game.state.events
						.cubanmissilecrisis_removal_country === 'cuba'
				) {
					this.placeInfluence('cuba', 2, 'ussr');
				}
				if (
					twilight_self.game.state.events
						.cubanmissilecrisis_removal_country === 'westgermany'
				) {
					this.placeInfluence('westgermany', 2, 'us');
				}
				if (
					twilight_self.game.state.events
						.cubanmissilecrisis_removal_country === 'turkey'
				) {
					this.placeInfluence('turkey', 2, 'us');
				}
			}
		...
		if (
			start_turn_game_state == null ||
			start_turn_game_state == undefined
		) {
		} else {
		...
		for (let i = twilight_self.game.queue.length - 1; i >= 0; i--) {
			...
			if (tmpar[0] === 'discard') {
				...
				twilight_self.updateLog(
					`${tmpar[1].toUpperCase()} second-guesses themselves and takes back their ${twilight_self.cardToText(
						tmpar[2]
					)}...`
				);
			}
	...
	playerTriggerOps(player, card) {
		...
		//
		if (
			twilight_self.game.state.events.flowerpower == 1 &&
			player === 'us'
		) {
			if (
				(card == 'arabisraeli' &&
					twilight_self.game.state.events.campdavid == 0) ||
				card == 'koreanwar' ||
				card == 'brushwar' ||
				card == 'indopaki' ||
				card == 'iraniraq'
				...
				twilight_self.addMove(
					'modal\t' + this.cardToText('flowerpower'),
					'USSR gains 2 VP'
				);
				twilight_self.addMove(
					'NOTIFY\tFlower Power triggered by ' + this.cardToText(card)
				);
		...
		if (ac[card].player == opponent) {
			let html =
				'<ul><li class="option" id="before_ops">event before ops</li><li class="option" id="after_ops">event after ops</li></ul>';
			twilight_self.bindBackButtonFunction(() => {
				twilight_self.playerTurnCardSelected(card, player);
			});
			twilight_self.updateStatusWithOptions(
				'Playing opponent card:',
				html,
				function (action2) {
			...
			//Playing my own or neutral card for ops

			twilight_self.addMove(
				'ops\t' + player + '\t' + card + '\t' + ac[card].ops
			);
			if (card == 'china') {
				twilight_self.addMove('limit\tchina');
			}
			twilight_self.removeCardFromHand(card);
			twilight_self.endTurn();
			return;
		...
		if (twilight_self.game.state.events.flowerpower == 1) {
			if (
				...
				if (player === 'us') {
					...
					twilight_self.addMove(
						'NOTIFY\tFlower Power triggered by ' +
							this.cardToText(card)
					);
					twilight_self.addMove('vp\tussr\t2\t1');
				}
			}
		...
		if (card == 'tehran') {
			...
			if (5 > twilight_self.game.deck[0].crypt.length) {
				...
				if (Object.keys(discarded_cards).length > 0) {
					...
					twilight_self.updateLog(
						'cards remaining: ' +
							twilight_self.game.deck[0].crypt.length
					);
					twilight_self.updateLog(
						'Shuffling discarded cards back into the deck...'
					);
	...
	uneventOpponentControlledCountries(player, card) {
		...
		for (var i in this.countries) {
			...
			if (player == 'us') {
				if (
					this.isControlled('ussr', i) == 1 &&
					bonus_region_applies == 0
				) {
  ...
  */
			...
			for (var i in this.game.countries) {
				if (this.game.countries[i].ussr > 0) {
					...
					if (
						...
						this.game.countries['chile'].ussr < 1 &&
						this.game.countries['uruguay'].ussr < 1 &&
						this.game.countries['paraguay'].ussr < 1 &&
						this.game.countries['argentina'].ussr == 1 &&
						i === 'argentina'
					) {
						place_in_country = 0;
					}
					...
					if (place_in_country == 1) {
						for (
							let n = 0;
							n < this.game.countries[i].neighbours.length;
							n++
						) {
	...
	playerPlaceInitialInfluence() {
		...
		try {
			...
			if (this.game.player == 1) {
				...
				this.updateStatusAndListCards(
					'You are the USSR. Place six additional influence in Eastern Europe.'
				);
				...
				$('.easterneurope').on('click', function () {
					...
					if (twilight_self.countries[countryname].place == 1) {
						...
						if (ops_to_place == 0) {
							...
							twilight_self.updateStatusAndListCards(
								`You are the USSR. Place ${ops_to_place} additional influence in Eastern Europe.`
							);
						}
					} else {
						//Should be impossible to hit here
						twilight_self.displayModal(
							'Invalid Influence Placement',
							`You cannot place there...: ${ops_to_place} influence left`
						);
					}
				});
				...
				this.updateStatusAndListCards(
					'You are the US. Place seven additional influence in Western Europe.'
				);
				...
				$('.westerneurope').on('click', function () {
					...
					if (twilight_self.countries[countryname].place == 1) {
						...
						if (ops_to_place == 0) {
							...
							twilight_self.updateStatusAndListCards(
								`You are the US. Place ${ops_to_place} additional influence in Western Europe.`
							);
						}
					} else {
						//Should be impossible to hit here
			...
			console.log('Error in playerPlaceInitialInfluence: ' + err);
		}
	}
	...
	playerPlaceBonusInfluence(bonus) {
		...
		if (this.game.player == 1) {
			...
			this.updateStatusAndListCards(
				`You are the USSR. Place ${bonus} additional influence in countries with existing Soviet influence.`
			);
			...
			//US -- the only one who actually uses this function

			this.updateStatusAndListCards(
				`You are the US. Place ${bonus} additional influence in countries with existing American influence.`
			);
	...
	removeInfluence(country, inf, player, mycallback = null) {
		if (player == 'us') {
			this.countries[country].us =
				parseInt(this.countries[country].us) - parseInt(inf);
			if (this.countries[country].us < 0) {
				this.countries[country].us = 0;
			}
		} else {
			this.countries[country].ussr =
				parseInt(this.countries[country].ussr) - parseInt(inf);
			if (this.countries[country].ussr < 0) {
				this.countries[country].ussr = 0;
			}
		}
	...
	showInfluence(country, player = '', mycallback = null) {
		...
		if (ussr_i == 0) {
			...
			$(obj_ussr).html(
				'<div class="ussr_uncontrol">' + ussr_i + '</div>'
			);
		}
		...
		if (player) {
			if (
				!(this.game.player == 1 && player == 'ussr') &&
				!(this.game.player == 2 && player == 'us')
			) {
				$(`#${country}`)
					.addClass('shake')
					.delay(1500)
	...
	playerPlaceInfluence(player, mycallback = null) {
		...
		for (var i in this.countries) {
			...
			if (
				...
				if (
					this.countries[i].region == this.game.state.events.chernobyl
				) {
					restricted_country = 1;
				}
				if (
					this.game.state.events.chernobyl == 'asia' &&
			...
			if (
				this.game.state.limit_region.indexOf(this.countries[i].region) >
				-1
			) {
				restricted_country = 1;
			}
				...
				if (player == 'us') {
						...
						if (twilight_self.countries[countryname].place == 1) {
							...
							if (
								twilight_self.countries[
									countryname
								].region.indexOf('asia') < 0
							) {
								twilight_self.game.state.events.china_card_eligible = 0;
							}

							if (
								twilight_self.isControlled(
									'ussr',
									countryname
								) == 1
							) {
								twilight_self.game.break_control = 1;
							}
							...
							if (
								...
								if (
									...
									if (
										twilight_self.countries[countryname]
											.us >= 1
									) {
										//
										// allow player to remove CMC
										//
										let removeinf = await sconfirm(
											'You are placing 1 influence in ' +
												twilight_self.countries[
													countryname
												].name +
												'. Once this is done, do you want to cancel the Cuban Missile Crisis by removing 2 influence in ' +
												twilight_self.countries[
													countryname
												].name +
												'?'
										...
										if (removeinf) {
											...
											twilight_self.removeInfluence(
												countryname,
												2,
												'us'
											);
											twilight_self.addMove(
												`remove\tus\tus\t${countryname}\t2`
											);
											twilight_self.addMove(
												'unlimit\tcmc\t' + countryname
											);
											twilight_self.addMove(
												'NOTIFY\tUS has cancelled the Cuban Missile Crisis'
											);
					...
					$(divname).on('mouseup', async function (e) {
						...
						if (twilight_self.countries[countryname].place == 1) {
							...
							//
							if (
								twilight_self.countries[countryname].region !==
								'seasia'
							) {
								twilight_self.game.state.events.vietnam_revolts_eligible = 0;
							}
							...
							if (
								twilight_self.isControlled('us', countryname) ==
								1
							) {
								twilight_self.game.break_control = 1;
							}
	...
	isSpaceRaceAvailable(ops) {
		...
		if (
			this.game.player == 1 &&
			this.game.state.space_race_ussr_counter >= 1
		) {
			if (
				this.game.state.animal_in_space == 'ussr' &&
				this.game.state.space_race_ussr_counter < 2
			) {
			} else {
				sre = 0;
			}
		...
		if (
			this.game.player == 2 &&
			this.game.state.space_race_us_counter >= 1
		) {
			if (
				this.game.state.animal_in_space == 'us' &&
				this.game.state.space_race_us_counter < 2
			) {
			} else {
				sre = 0;
			}
	...
	playerSpaceCard(card, player) {
		...
		// stats
		if (player == 'us') {
			this.game.state.stats.us_ops_spaced += this.modifyOps(
				card_ops,
				card,
				player
			);
		...
		if (player == 'ussr') {
			this.game.state.stats.ussr_ops_spaced += this.modifyOps(
				card_ops,
				card,
				player
			);
		...
		if (successful == 1) {
			this.updateLog(
				player.toUpperCase() +
					` advances in the Space Race with roll ${roll}`
			);
			this.advanceSpaceRace(player);
		} else {
			this.updateLog(
				player.toUpperCase() +
					` fails in the Space Race with roll ${roll}`
			);
			this.displayModal(
				player.toUpperCase() + ' fails to advance in the Space Race'
			);
		}
	}
	...
	playerCoupCountry(player, ops, card) {
		...
		$('.country').on('click', async function () {
			...
			//
			if (
				twilight_self.game.state.defcon == 2 &&
				twilight_self.game.countries[countryname].bg == 1 &&
				!(
					player == 'us' &&
					twilight_self.game.state.events.nuclearsubs == 1
				)
			) {
				let c = await sconfirm(
					'Are you sure you wish to coup a Battleground State? (DEFCON is 2)'
				);
				if (c) {
				} else {
					twilight_self.playOps(player, ops, card);
			...
			if (twilight_self.game.state.limit_ignoredefcon == 0) {
				if (
					twilight_self.countries[countryname].region == 'europe' &&
					twilight_self.game.state.defcon < 5
				) {
				...
				if (
					(twilight_self.countries[countryname].region == 'asia' ||
						twilight_self.countries[countryname].region ==
							'seasia') &&
					twilight_self.game.state.defcon < 4
				) {
				...
				if (
					twilight_self.countries[countryname].region == 'mideast' &&
					twilight_self.game.state.defcon < 3
				) {
      ...
      */
			...
			if (
				...
				if (twilight_self.isControlled('us', countryname) == 1) {
					if (
						(countryname == 'westgermany' &&
							twilight_self.game.state.events.nato_westgermany ==
								0) ||
						(countryname == 'france' &&
							twilight_self.game.state.events.nato_france == 0)
					) {
						//If West Germany or France have been removed from Nato (by Degaulle or WillyBrandt), then one can coup there....
					} else {
						failureReason =
							'NATO prevents coups of US-controlled countries in Europe';
					}
				}
			}
			...
			if (
				twilight_self.countries[countryname].region == 'europe' &&
				twilight_self.game.state.events.reformer == 1 &&
				player == 'ussr'
			) {
				failureReason =
					'The Reformer prevents USSR coup attempts in Europe';
			}

			if (
				(player == 'us' &&
					twilight_self.countries[countryname].ussr <= 0) ||
				(player == 'ussr' &&
					twilight_self.countries[countryname].us <= 0)
			) {
				failureReason = 'No enemy influence';
			}
			...
			if (failureReason.length > 0) {
				...
				if (
					card == 'china' &&
					(twilight_self.game.countries[countryname].region ==
						'asia' ||
						twilight_self.game.countries[countryname].region ==
							'seasia')
				) {
					twilight_self.updateLog(
						'China bonus OP added to coup in Asia...'
					);
					ops++;
				}
				if (
					player == 'ussr' &&
					twilight_self.game.state.events.vietnam_revolts == 1 &&
					twilight_self.game.countries[countryname].region == 'seasia'
				) {
					if (
						twilight_self.returnOpsOfCard(card) == 1 &&
						twilight_self.game.state.events.redscare_player1 >= 1
					) {
						twilight_self.updateLog(
							'Vietnam Revolts bonus OP negated by Red Purge'
						);
					} else {
						twilight_self.updateLog(
							'Vietnam Revolts bonus OP added to Southeast Asia coup...'
						);
						ops++;
					}
				}
	...
	playCoup(player, countryname, ops, mycallback = null) {
		...
		if (
			player == 'ussr' &&
			this.game.state.events.cubanmissilecrisis == 1
		) {
			this.sendGameOverTransaction(
				this.game.players[1],
				'Cuban Missile Crisis'
		...
		if (this.game.state.events.yuri == 1) {
			if (player == 'us') {
				...
				this.updateVictoryPoints();
				this.updateLog(
					`USSR gains 1 VP from ${this.cardToText('yuri')}`
				);
			}
		}
		...
		if (this.game.state.events.saltnegotiations == 1) {
			this.updateLog(
				`${this.cardToText('saltnegotiations')}: -1 modifier on coups`
			);
			modifier--;
		}
		...
		if (this.game.state.events.deathsquads != 0) {
			if (this.game.state.events.deathsquads <= -1) {
				let roll_modifier = Math.abs(
					this.game.state.events.deathsquads
				);
				if (
					this.countries[countryname].region == 'camerica' ||
					this.countries[countryname].region == 'samerica'
				) {
					if (player == 'ussr') {
						this.updateLog(
							`${this.cardToText(
								'deathsquads'
							)} triggers: USSR +${roll_modifier} modifier`
						);
					...
					if (player == 'us') {
						if (
							...
							this.updateLog(
								`${this.cardToText(
									'deathsquads'
								)} triggers: US -${roll_modifier} modifier`
							);
							modifier -= roll_modifier;
						}
					}
		...
		if (this.game.state.events.inftreaty == 1) {
			this.updateLog(
				`${this.cardToText('inftreaty')} -1 modifier on coups`
			);
			modifier--;
		}
		...
		if (
			this.game.countries[countryname].bg == 1 &&
			this.game.state.lower_defcon_on_coup == 1
		) {
			if (player == 'ussr' || this.game.state.events.nuclearsubs == 0) {
				console.log(
					'DEFCON MONITOR: about to lower defcon in coup logic 2...'
				);
				this.lowerDefcon();
			}
		}
		...
		if (modifier != 0) {
			roll = roll + modifier;
			this.updateLog(
				`COUP: ${player.toUpperCase()} modified roll: ${roll}`
			);
		} else {
		...
		if (winning > 0) {
			if (this.browser_active == 1) {
				this.displayModal(
					`COUP in ${this.countries[countryname].name}!`,
					`${player.toUpperCase()} successfully shifts influence in by ${winning}`
				);
			}
			...
			let gained = 0;
			this.updateLog(
				`${player.toUpperCase()}'s coup succeeds in ${
					this.countries[countryname].name
				}.`
			);
			...
			if (
				(player == 'us' && this.game.player == 2) ||
				(player == 'ussr' && this.game.player == 1)
			) {
				this.displayModal('COUP FAILS!');
			} else {
				this.displayModal(
					`COUP in ${this.countries[countryname].name}!`,
					'Your forces repel the coup and the government remains in power'
				);
			}

			this.updateLog(
				`${player.toUpperCase()}'s coup in ${
					this.countries[countryname].name
				} fails, no change in influence`
			);
		}
	...
	playRealign(player, country) {
		...
		if (roll_us > roll_ussr) {
			this.updateLog(
				`US wins realignment roll with ${roll_us} (incl. ${bonus_us} bonus) vs. USSR ${roll_ussr} (incl. ${bonus_ussr} bonus)`
			);
			...
			this.updateLog(
				`USSR wins realignment roll with ${roll_ussr} (incl. ${bonus_ussr} bonus) vs. US ${roll_us} (incl. ${bonus_us} bonus)`
			);
			...
			this.updateLog(
				`Realignment roll is a draw! US [${
					roll_us - bonus_us
				} + ${bonus_us}] = USSR [${
					roll_ussr - bonus_ussr
				} + ${bonus_ussr}]`
			);
		}
	}
	...
	endTurn(nextTarget = 0) {
		...
		if (this.game.player == 0) {
			console.log(
				'Observer submitting moves, something went wrong: ',
				JSON.stringify(this.moves)
			);
		}
		this.cancelBackButtonFunction();
		this.updateStatus(
			'Submitting moves... awaiting response from peers...'
		);
		...
		if (this.game.state.events.wwby_triggers == 1) {
			this.addMove(
				`NOTIFY\t${this.cardToText('wwby')} triggers +3 VP for USSR`
			);
	...
	endRound() {
		...
		if (this.game.state.round > 1) {
			...
			let ussr_milops_deficit =
				this.game.state.defcon - this.game.state.milops_ussr;
			let us_milops_deficit =
				this.game.state.defcon - this.game.state.milops_us;

			if (ussr_milops_deficit > 0) {
				this.game.state.vp += ussr_milops_deficit;
				this.updateLog(
					'USSR penalized ' + ussr_milops_deficit + ' VP (milops)'
				);
			}
			if (us_milops_deficit > 0) {
				this.game.state.vp -= us_milops_deficit;
				this.updateLog(
					'US penalized ' + us_milops_deficit + ' VP (milops)'
				);
			}
		}
		...
		if (this.game.state.events.tsarbomba == 1) {
			this.game.state.events.tsarbomba = 0;
		} else {
			this.game.state.defcon++;
			if (this.game.state.defcon > 5) {
				this.game.state.defcon = 5;
	...
	returnCountries() {
		...
		countries['uk'] = {
			...
			control: 5,
			bg: 0,
			neighbours: ['canada', 'norway', 'benelux', 'france'],
			region: 'europe',
			name: 'UK'
		};
		countries['benelux'] = {
		...
		countries['france'] = {
			...
			control: 3,
			bg: 1,
			neighbours: ['algeria', 'uk', 'italy', 'spain', 'westgermany'],
			region: 'europe',
			name: 'France'
		};
		countries['italy'] = {
			...
			control: 2,
			bg: 1,
			neighbours: ['spain', 'france', 'greece', 'austria', 'yugoslavia'],
			region: 'europe',
			name: 'Italy'
		};
		...
		countries['eastgermany'] = {
			...
			control: 3,
			bg: 1,
			neighbours: ['westgermany', 'poland', 'austria', 'czechoslovakia'],
			region: 'europe',
			name: 'East Germany'
		};
		countries['poland'] = {
			...
			control: 3,
			bg: 1,
			neighbours: ['eastgermany', 'czechoslovakia'],
			region: 'europe',
			name: 'Poland'
		};
		countries['spain'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['morocco', 'france', 'italy'],
			region: 'europe',
			name: 'Spain'
		};
		countries['greece'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['italy', 'turkey', 'yugoslavia', 'bulgaria'],
			region: 'europe',
			name: 'Greece'
		};
		countries['turkey'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['syria', 'greece', 'romania', 'bulgaria'],
			region: 'europe',
			name: 'Turkey'
		};
		countries['yugoslavia'] = {
			...
			control: 3,
			bg: 0,
			neighbours: ['italy', 'hungary', 'romania', 'greece'],
			region: 'europe',
			name: 'Yugoslavia'
		};
		countries['bulgaria'] = {
		...
		countries['romania'] = {
			...
			control: 3,
			bg: 0,
			neighbours: ['turkey', 'hungary', 'yugoslavia'],
			region: 'europe',
			name: 'Romania'
		};
		countries['hungary'] = {
			...
			control: 3,
			bg: 0,
			neighbours: ['austria', 'czechoslovakia', 'romania', 'yugoslavia'],
			region: 'europe',
			name: 'Hungary'
		};
		countries['austria'] = {
			...
			control: 4,
			bg: 0,
			neighbours: ['hungary', 'italy', 'westgermany', 'eastgermany'],
			region: 'europe',
			name: 'Austria'
		};
		countries['czechoslovakia'] = {
			...
			control: 3,
			bg: 0,
			neighbours: ['hungary', 'poland', 'eastgermany'],
			region: 'europe',
			name: 'Czechoslovakia'
		};
		countries['denmark'] = {
		...
		countries['lebanon'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['syria', 'jordan', 'israel'],
			region: 'mideast',
			name: 'Lebanon'
		};
		countries['syria'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['lebanon', 'turkey', 'israel'],
			region: 'mideast',
			name: 'Syria'
		};
		countries['israel'] = {
		...
		countries['iraq'] = {
			...
			control: 3,
			bg: 1,
			neighbours: ['jordan', 'iran', 'gulfstates', 'saudiarabia'],
			region: 'mideast',
			name: 'Iraq'
		};
		countries['iran'] = {
			...
			control: 2,
			bg: 1,
			neighbours: ['iraq', 'afghanistan', 'pakistan'],
			region: 'mideast',
			name: 'Iran'
		};
		countries['jordan'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['israel', 'lebanon', 'iraq', 'saudiarabia'],
			region: 'mideast',
			name: 'Jordan'
		};
		countries['gulfstates'] = {
			top: 1504,
			left: 3014,
			us: 0,
			ussr: 0,
		...
		countries['saudiarabia'] = {
			...
			control: 3,
			bg: 1,
			neighbours: ['jordan', 'iraq', 'gulfstates'],
			region: 'mideast',
			name: 'Saudi Arabia'
		};
		...
		countries['pakistan'] = {
			...
			control: 2,
			bg: 1,
			neighbours: ['iran', 'afghanistan', 'india'],
			region: 'asia',
			name: 'Pakistan'
		};
		countries['india'] = {
		...
		countries['laos'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['burma', 'thailand', 'vietnam'],
			region: 'seasia',
			name: 'Laos'
		};
		countries['thailand'] = {
			...
			control: 2,
			bg: 1,
			neighbours: ['laos', 'vietnam', 'malaysia'],
			region: 'seasia',
			name: 'Thailand'
		};
		countries['vietnam'] = {
		...
		countries['malaysia'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['thailand', 'australia', 'indonesia'],
			region: 'seasia',
			name: 'Malaysia'
		};
		countries['australia'] = {
		...
		countries['indonesia'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['malaysia', 'philippines'],
			region: 'seasia',
			name: 'Indonesia'
		};
		...
		countries['japan'] = {
			...
			control: 4,
			bg: 1,
			neighbours: ['philippines', 'taiwan', 'southkorea'],
			region: 'asia',
			name: 'Japan'
		};
		countries['southkorea'] = {
			...
			control: 3,
			bg: 1,
			neighbours: ['japan', 'taiwan', 'northkorea'],
			region: 'asia',
			name: 'South Korea'
		};
		...
		countries['guatemala'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['mexico', 'elsalvador', 'honduras'],
			region: 'camerica',
			name: 'Guatemala'
		};
		...
		countries['honduras'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['nicaragua', 'costarica', 'guatemala', 'elsalvador'],
			region: 'camerica',
			name: 'Honduras'
		};
		countries['nicaragua'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['costarica', 'honduras', 'cuba'],
			region: 'camerica',
			name: 'Nicaragua'
		};
		countries['costarica'] = {
			...
			control: 3,
			bg: 0,
			neighbours: ['honduras', 'panama', 'nicaragua'],
			region: 'camerica',
			name: 'Costa Rica'
		};
		countries['panama'] = {
		...
		countries['haiti'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['cuba', 'dominicanrepublic'],
			region: 'camerica',
			name: 'Haiti'
		};
		...
		countries['colombia'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['panama', 'venezuela', 'ecuador'],
			region: 'samerica',
			name: 'Colombia'
		};
		countries['ecuador'] = {
		...
		countries['peru'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['ecuador', 'chile', 'bolivia'],
			region: 'samerica',
			name: 'Peru'
		};
		countries['chile'] = {
		...
		countries['argentina'] = {
			...
			control: 2,
			bg: 1,
			neighbours: ['chile', 'uruguay', 'paraguay'],
			region: 'samerica',
			name: 'Argentina'
		};
		countries['paraguay'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['uruguay', 'argentina', 'bolivia'],
			region: 'samerica',
			name: 'Paraguay'
		};
		countries['uruguay'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['argentina', 'paraguay', 'brazil'],
			region: 'samerica',
			name: 'Uruguay'
		};
		countries['brazil'] = {
		...
		countries['morocco'] = {
			...
			control: 3,
			bg: 0,
			neighbours: ['westafricanstates', 'algeria', 'spain'],
			region: 'africa',
			name: 'Morocco'
		};
		countries['algeria'] = {
			...
			control: 2,
			bg: 1,
			neighbours: ['tunisia', 'morocco', 'france', 'saharanstates'],
			region: 'africa',
			name: 'Algeria'
		};
		countries['tunisia'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['libya', 'algeria'],
			region: 'africa',
			name: 'Tunisia'
		};
		countries['westafricanstates'] = {
			top: 1596,
			left: 1696,
			us: 0,
			ussr: 0,
			control: 2,
			bg: 0,
			neighbours: ['ivorycoast', 'morocco'],
			region: 'africa',
			name: 'West African States'
		};
		countries['saharanstates'] = {
			top: 1650,
			left: 2028,
			us: 0,
			ussr: 0,
		...
		countries['ivorycoast'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['nigeria', 'westafricanstates'],
			region: 'africa',
			name: 'Ivory Coast'
		};
		countries['nigeria'] = {
			...
			control: 1,
			bg: 1,
			neighbours: ['ivorycoast', 'cameroon', 'saharanstates'],
			region: 'africa',
			name: 'Nigeria'
		};
		countries['ethiopia'] = {
		...
		countries['zaire'] = {
			...
			control: 1,
			bg: 1,
			neighbours: ['angola', 'zimbabwe', 'cameroon'],
			region: 'africa',
			name: 'Zaire'
		};
		countries['kenya'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['seafricanstates', 'somalia'],
			region: 'africa',
			name: 'Kenya'
		};
		countries['angola'] = {
			...
			control: 1,
			bg: 1,
			neighbours: ['southafrica', 'botswana', 'zaire'],
			region: 'africa',
			name: 'Angola'
		};
		countries['seafricanstates'] = {
			...
			control: 1,
			bg: 0,
			neighbours: ['zimbabwe', 'kenya'],
			region: 'africa',
			name: 'Southeast African States'
		};
		countries['zimbabwe'] = {
			top: 2364,
			left: 2550,
			...
			control: 1,
			bg: 0,
			neighbours: ['seafricanstates', 'botswana', 'zaire'],
			region: 'africa',
			name: 'Zimbabwe'
		};
		countries['botswana'] = {
			...
			control: 2,
			bg: 0,
			neighbours: ['southafrica', 'angola', 'zimbabwe'],
			region: 'africa',
			name: 'Botswana'
		};
	...
	returnEarlyWarCards(inc_optional = false) {
		...
		if (inc_optional == true) {
			...
			deck['iranianultimatum'] = {
				img: 'TNRnTS-210png',
				name: 'Iranian Ultimatum',
				scoring: 0,
				player: 'us',
				recurring: 0,
				ops: 3
	...
	returnMidWarCards(inc_optional = false) {
		...
		if (inc_optional == true) {
			...
			// SAITO
			deck['berlinagreement'] = {
				img: 'TNRnTS-217png',
				name: 'Berlin Agreement',
				scoring: 0,
				player: 'both',
				recurring: 0,
				ops: 3
			...
			deck['breakthroughatlopnor'] = {
				img: 'TNRnTS-302png',
				name: 'Breakthrough at Lop Nor',
				scoring: 0,
				player: 'ussr',
				recurring: 0,
				ops: 2
	...
	returnLateWarCards(inc_optional = false) {
		...
		if (inc_optional == true) {
			...
			deck['rustinredsquare'] = {
				img: 'TNRnTS-203png',
				name: 'Rust Lands in Red Square',
				scoring: 0,
				player: 'us',
				recurring: 0,
				ops: 1
			};
			deck['revolutionsof1989'] = {
				img: 'TNRnTS-216png',
	...
	isControlled(player, country) {
		...
		if (player == 'ussr') {
			country_lead =
				parseInt(this.countries[country].ussr) -
				parseInt(this.countries[country].us);
		}
		if (player == 'us') {
			country_lead =
				parseInt(this.countries[country].us) -
		...
		if (this.countries[country].control <= country_lead) {
			return 1;
		}
		return 0;
	}
		...
		if (
			...
			if (card != '') {
				if (this.game.state.events.redscare_player1 >= 1) {
					if (this.returnOpsOfCard(card) == 1) {
						pushme = 0;
					}
				}
			}
	...
	limitToRegionBonus() {
		for (var i in this.countries) {
			if (
				this.countries[i].region.indexOf(
					this.game.state.events.region_bonus
				) == -1
			) {
				let divname = '#' + i;
  ...
  */
	modifyOps(ops, card = '', player = '', updatelog = 1) {
		...
		if (card == 'olympic' && ops == 4) {
		} else {
			if (card != '') {
				ops = this.returnOpsOfCard(card);
			}
		}
	...
	calculateControlledBattlegroundCountries(scoring, bg_countries) {
		for (var [player, side] of Object.entries(scoring)) {
			for (var country of bg_countries) {
				if (this.isControlled(player, country) == 1) {
					side.bg++;
					side.total++;
				}
			}
	...
	determineRegionVictor(
		scoring,
		region_scoring_range,
		max_bg_num,
		region = ''
	) {
		// SAITO COMMUNITY
		if (
			scoring.us.bg == max_bg_num &&
			scoring.us.total > scoring.ussr.total
		) {
		...
		if (
			scoring.ussr.bg == max_bg_num &&
			scoring.ussr.total > scoring.us.total
		) {
	...
	calculateScoring(region, mouseover_preview = 0) {
		...
		if (region !== 'seasia') {
			scoring = this.calculateControlledBattlegroundCountries(
				scoring,
				bg_countries
			); //fill in scoring.us/ussr.bg
			scoring = this.calculateControlledCountries(
				scoring,
				non_bg_countries
			); //fill in scoring.us/ussr.total
		}
		...
		case 'europe':
			...
			scoring = this.determineRegionVictor(
				scoring,
				scoring_range,
				bg_countries.length,
				region
			...
			if (this.isControlled('us', 'finland') == 1) {
				...
				scoring.bonus.push({
					side: 'us',
					name: 'Adjacency',
					desc: 'US +1 for Finland',
					icon: '/twilight/img/adjacency.png'
				});
			}
			...
			if (this.game.state.events.optional.gouzenkoaffair == 1) {
				if (this.isControlled('us', 'canada') == 1) {
					...
					scoring.bonus.push({
						side: 'us',
						name: 'Gouzenko Affair',
						desc: 'US +1 for Canada-USSR adjacency',
						icon: '/twilight/img/adjacency.png'
					});
				}
			}
		...
		case 'mideast':
			...
			if (this.game.state.events.shuttlediplomacy == 1) {
				scoring.bonus.push({
					side: 'us',
					name: 'Shuttle Diplomacy',
					desc: 'USSR -1 battleground',
					icon: '/twilight/img/Event73.png'
				});
				...
				if (mouseover_preview == 0) {
					...
					scoring.shuttle = 1;
					this.game.state.events.shuttlediplomacy = 0;
					this.game.deck[0].discards['shuttle'] =
							this.game.deck[0].cards['shuttle'];
				}
			}
		...
		case 'seasia':
			...
			case 'us':
				scoring.us.total += 2;
				scoring.us.bg = 1;
				scoring.us.status = 'Thailand';
				break;
			case 'ussr':
				scoring.ussr.total += 2;
				scoring.ussr.bg = 1;
				scoring.ussr.status = 'Thailand';
				break;
			}
		...
		case 'asia':
			...
			if (
				...
				scoring.bonus.push({
					side: 'us',
					name: 'Formosan Resolution',
					desc: 'US +1 battleground country',
					icon: '/twilight/img/Event35.svg'
				});
			}
			...
			if (this.isControlled('ussr', 'japan') == 1) {
				if (this.game.state.events.shuttlediplomacy == 1) {
					this.updateLog(
						'USSR loses Japan/US-adjacency with Shuttle Diplomacy'
					);
				} else {
					scoring.ussr.vp++;
			...
			if (mouseover_preview != 1) {
				// SAITO COMMUNITY
				if (region === this.game.state.events.kissinger) {
					this.game.state.events.kissinger = '';
				}
				if (region === this.game.state.events.fischerspassky) {
					this.updateLog(
						'Region Scoring Adjusted by Fischer-Spassky...'
					);
  ...
  */
	doesPlayerDominateRegionForSummit(player, region) {
		...
		////////////
		if (region === 'europe') {
			if (this.isControlled('us', 'italy') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'italy') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'france') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'france') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'westgermany') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'westgermany') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'eastgermany') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'eastgermany') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'poland') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'poland') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('us', 'spain') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'spain') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'greece') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'greece') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'turkey') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'turkey') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'yugoslavia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'yugoslavia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'bulgaria') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'bulgaria') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'austria') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'austria') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'romania') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'romania') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'hungary') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'hungary') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'czechoslovakia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'czechoslovakia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'benelux') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'benelux') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'uk') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'uk') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'canada') == 1) {
				total_us++;
			...
			if (this.isControlled('us', 'norway') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'norway') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'denmark') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'denmark') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'sweden') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'sweden') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'finland') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'finland') == 1) {
				total_ussr++;
			}
			...
			if (bg_us > bg_ussr && total_us > bg_us && total_us > total_ussr) {
				vp_us = 7;
			}
			if (
				bg_ussr > bg_us &&
			...
			if (bg_us > bg_ussr && total_us == 6 && total_us > total_ussr) {
				vp_us = 10000;
			}
			if (bg_ussr > bg_us && total_ussr == 6 && total_us > total_ussr) {
				vp_ussr = 10000;
			}
			...
			if (
				(vp_us >= vp_ussr + 2 && total_us > bg_us) ||
				(bg_us == 5 && total_us > total_ussr)
			) {
				if (player == 'us') {
					return 1;
				}
			...
			if (
				(vp_ussr >= vp_us + 2 && total_ussr > bg_ussr) ||
				(bg_ussr == 5 && total_ussr > total_us)
			) {
				if (player == 'us') {
					return 0;
				}
		...
		/////////////////
		if (region === 'mideast') {
			if (this.isControlled('us', 'libya') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'libya') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'egypt') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'egypt') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'israel') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'israel') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'iraq') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'iraq') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'iran') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'iran') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'saudiarabia') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'saudiarabia') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('us', 'lebanon') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'lebanon') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'syria') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'syria') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'jordan') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'jordan') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'gulfstates') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'gulfstates') == 1) {
				total_ussr++;
			}
			...
			if (bg_us > bg_ussr && total_us == 7 && total_us > total_ussr) {
				vp_us = 7;
			}
			if (bg_ussr > bg_us && total_ussr == 7 && total_us > total_ussr) {
				vp_ussr = 7;
			}
		...
		////////////
		if (region === 'africa') {
			if (this.isControlled('us', 'algeria') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'algeria') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'nigeria') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'nigeria') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'zaire') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'zaire') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'angola') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'angola') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'southafrica') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'southafrica') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('us', 'morocco') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'morocco') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'tunisia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'tunisia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'westafricanstates') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'westafricanstates') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'saharanstates') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'saharanstates') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'sudan') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'sudan') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'ivorycoast') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'ivorycoast') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'ethiopia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'ethiopia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'somalia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'somalia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'cameroon') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'cameroon') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'kenya') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'kenya') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'seafricanstates') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'seafricanstates') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'zimbabwe') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'zimbabwe') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'botswana') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'botswana') == 1) {
				total_ussr++;
			}
		...
		if (region === 'camerica') {
			...
			if (this.isControlled('ussr', 'panama') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('us', 'guatemala') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'guatemala') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'elsalvador') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'elsalvador') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'honduras') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'honduras') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'costarica') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'costarica') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'nicaragua') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'nicaragua') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'haiti') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'haiti') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'dominicanrepublic') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'dominicanrepublic') == 1) {
				total_ussr++;
			}
			...
			if (
				(vp_us > vp_ussr && total_us > bg_us && bg_us > 0) ||
				(bg_us == 3 && total_us > total_ussr)
			) {
				if (player == 'us') {
					return 1;
				}
			...
			if (
				(vp_ussr > vp_us && total_ussr > bg_ussr && bg_ussr > 0) ||
				(bg_ussr == 3 && total_ussr > total_us)
			) {
				if (player == 'us') {
					return 0;
				}
		...
		if (region === 'samerica') {
			...
			if (this.isControlled('ussr', 'venezuela') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'brazil') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'brazil') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'argentina') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'argentina') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'chile') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'chile') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('us', 'colombia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'colombia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'ecuador') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'ecuador') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'peru') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'peru') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'bolivia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'bolivia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'paraguay') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'paraguay') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'uruguay') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'uruguay') == 1) {
				total_ussr++;
			}
			...
			if (
				(vp_us > vp_ussr + 2 && total_us > bg_us && bg_us > 0) ||
				(bg_us == 4 && total_us > total_ussr)
			) {
				if (player == 'us') {
					return 1;
				}
			...
			if (
				(vp_ussr > vp_us + 2 && total_ussr > bg_ussr && bg_ussr > 0) ||
				(bg_ussr == 4 && total_ussr > total_us)
			) {
				if (player == 'us') {
					return 0;
				}
		...
		if (region === 'asia') {
			...
			if (this.isControlled('ussr', 'northkorea') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('us', 'japan') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'japan') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'thailand') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'thailand') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'india') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'india') == 1) {
				bg_ussr++;
			}
			if (this.isControlled('us', 'pakistan') == 1) {
				bg_us++;
			}
			if (this.isControlled('ussr', 'pakistan') == 1) {
				bg_ussr++;
			}
			...
			if (this.isControlled('ussr', 'afghanistan') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'burma') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'burma') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'laos') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'laos') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'vietnam') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'vietnam') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'malaysia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'malaysia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'australia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'australia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'indonesia') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'indonesia') == 1) {
				total_ussr++;
			}
			if (this.isControlled('us', 'philippines') == 1) {
				total_us++;
			}
			if (this.isControlled('ussr', 'philippines') == 1) {
				total_ussr++;
			}
	...
	lowerDefcon() {
		...
		//
		if (
			(this.game.state.events.manwhosavedtheworld === 'us' &&
				this.game.state.turn == 2) ||
			(this.game.state.events.manwhosavedtheworld === 'ussr' &&
				this.game.state.turn == 1)
		) {
			if (this.game.state.defcon == 2) {
				this.game.state.events.manwhosavedtheworld = '';
				this.updateLog(
					'Man Who Saved the World prevents thermonuclear war'
				);
				return;
			}
		}
		...
		if (this.game.state.defcon <= 1) {
			if (this.game.state.headline == 1) {
				...
				this.sendGameOverTransaction(
					this.game.players[2 - this.game.state.player_to_go],
					'thermonuclear war'
				);
			} else {
				this.sendGameOverTransaction(
					this.game.players[2 - this.game.state.turn],
					'thermonuclear war'
				);
			}
			return;
	...
	updateActionRound() {
		...
		if (this.game.state.northseaoil == 1 && this.game.player == 2) {
			rounds_this_turn++;
		}
		if (this.game.state.space_station === 'us' && this.game.player == 2) {
			rounds_this_turn++;
		}
		if (this.game.state.space_station === 'ussr' && this.game.player == 1) {
			rounds_this_turn++;
		}
		...
		if (rounds_this_turn < 8) {
			$('.action_round_8_cover').css('display', 'all');
		} else {
			$('.action_round_8_cover').css('display', 'none');
		}
		if (rounds_this_turn < 7) {
			$('.action_round_7_cover').css('display', 'all');
		} else {
			$('.action_round_7_cover').css('display', 'none');
		}
	}
	...
	advanceSpaceRace(player, withOSS = false) {
		...
		if (vp_change > 0) {
			this.updateLog(
				`${player.toUpperCase()} gains ${vp_change} VP for advancing in the space race.`
			);
		}
	}
	...
	updateSpaceRace() {
		...
		let dt_us =
			this.game.state.space_race_ps[this.game.state.space_race_us].top;
		let dl_us =
			this.game.state.space_race_ps[this.game.state.space_race_us].left;
		let dt_ussr =
			this.game.state.space_race_ps[this.game.state.space_race_ussr].top;
		let dl_ussr =
			this.game.state.space_race_ps[this.game.state.space_race_ussr].left;
	...
	cardToText(cardname, textonly = false) {
		...
		if (card == undefined) {
			card = this.game.deck[0].discards[cardname];
		}
		if (card == undefined) {
			card = this.game.deck[0].removed[cardname];
		}
	...
	returnCardImage(cardname) {
		...
		if (c == undefined) {
			let x = this.returnAllCards(true);
			c = x[cardname];
		}
		...
		if (c == undefined) {
			...
			if (cardname === 'finished') {
				return `<div class="noncard" style="height:100%;background-image: url('/twilight/img/done.png'); background-size: cover;" id="${cardname.replaceAll(
					' ',
					''
				)}"></div>`;
			}
			if (cardname === 'skipturn') {
				return `<div class="noncard" style="height:100%;background-image: url('/twilight/img/skipturn.png'); background-size: cover;" id="${cardname.replaceAll(
					' ',
					''
				)}"></div>`;
			}
			if (cardname === 'cancel cuban missile crisis') {
				return `<div class="noncard" style="height:100%;background-image: url('/twilight/img/cancel_cmc.png'); background-size: cover;" id="${cardname.replaceAll(
					' ',
					''
				)}"></div>`;
			}
		...
		if (c.img.indexOf('png') > -1) {
			...
			if (c.p == 0) {
				html += `<img class="${cardclass}" src="/twilight/img/EarlyWar.svg" />`;
			}
			if (c.p == 1) {
				html += `<img class="${cardclass}" src="/twilight/img/MidWar.svg" />`;
			}
			if (c.p == 2) {
				html += `<img class="${cardclass}" src="/twilight/img/LateWar.svg" />`;
			}
	...
	displayChinaCard() {
		...
		if (x === 'ussr') {
			if (this.game.state.events.china_card_facedown == 0) {
				$('.china_card_status').addClass(
					'china_card_status_ussr_faceup'
				);
			} else {
				$('.china_card_status').addClass(
					'china_card_status_ussr_facedown'
				);
			}
		} else {
			if (this.game.state.events.china_card_facedown == 0) {
	...
	cancelEventsDynamically() {
		...
		if (this.game.player == 2) {
			if (
				this.game.state.space_race_us >= this.game.state.space_race_ussr
			) {
			...
			if (
				this.game.state.space_race_ussr >= this.game.state.space_race_us
			) {
				this.cancelEvent('onesmallstep');
			} else {
				this.uncancelEvent('onesmallstep');
	...
	dynamicDeckManagement() {
		...
		//
		if (
			this.game.state.events.double_quagmire &&
		...
		if (
			this.game.state.events.double_beartrap &&
		...
		//
		if (
			!this.isControlled('us', 'italy') &&
			!this.isControlled('us', 'france') &&
			!this.isControlled('us', 'poland') &&
			!this.isControlled('us', 'eastgermany')
		) {
			if (
				this.game.state.round >= 4 &&
		...
		//
		if (
			this.game.state.events.redscare_player1_count > 1 &&
		...
		if (
			this.game.state.events.redscare_player2_count > 1 &&
		...
		//
		if (
			this.game.state.events.destalinization_played &&
			this.game.state.events.decolonization_played &&
			this.game.state.events.pinochet_added != 1
		) {
			this.addCardToDeck(
				'pinochet',
				'Destalinization and Decolonization'
			);
			this.game.state.events.pinochet_added = 1;
		}
		...
		for (let i in this.game.deck[0].cards) {
			if (saito_edition_removed.includes(i)) {
				...
				//
				if (fulldeck[i]) {
					if (this.game.options[i]) {
						delete this.game.options[i];
					} else {
						this.game.options[i] = 1;
					}
				...
				// from discards
				//
				if (this.game.deck[0].discards[i]) {
					delete this.game.deck[0].discards[i];
				}
				...
				if (this.game.deck[0].hand.includes(i)) {
					for (
						let z = this.game.deck[0].hand.length - 1;
						z >= 0;
						z--
					) {
		...
		for (let i = 0; i < saito_edition_added.length; i++) {
			...
			if (!fulldeck[saito_edition_added[i]]) {
				if (!this.game.options[saito_edition_added[i]]) {
					this.game.options[saito_edition_added[i]] = 1;
				} else {
					delete this.game.options[saito_edition_added[i]];
				}
				fulldeck = this.returnAllCards();
				if (fulldeck[saito_edition_added[i]]) {
					console.log(
						'WTF CAN I NOT ADD THIS 1: ' + saito_edition_added[i]
					);
				}
			}
			...
			if (!this.game.deck[0].cards[saito_edition_added[i]]) {
				if (
					...
					cards_added_to_deck++;
					shuffle_in_these_cards[saito_edition_added[i]] =
						fulldeck[saito_edition_added[i]];
				}
			}
		}
		...
		for (let key3 in this.game.deck[0].cards) {
			if (
				this.game.state.player1_hold_cards.includes(key3) ||
				this.game.state.player2_hold_cards.includes(key3)
			) {
				if (key3 != 'china') {
				...
				if (key3 != 'china') {
					shuffle_in_these_cards[key3] =
						this.game.deck[0].cards[key3];
				}
			}
		}

		console.log('SHUFFLING IN THESE CARDS: ');
		for (let key in shuffle_in_these_cards) {
			console.log(key);
		}
		...
		this.game.queue.push('DECKXOR\t1\t1');
		this.game.queue.push(
			'DECK\t1\t' + JSON.stringify(shuffle_in_these_cards)
		);
		this.game.queue.push('HANDBACKUP\t1');
	...
	addCardToDeck(key = '', reason = '') {
		...
		if (!allCards[key]) {
			if (!this.game.options[key]) {
				this.game.options[key] = 1;
			} else {
				delete this.game.options[key];
			}
		}
		...
		if (this.game.saito_cards_removed.includes(key)) {
			for (
				let z = this.game.saito_cards_removed.length - 1;
				z >= 0;
				z--
			) {
	...
	playEvent(player, card) {
		if (this.game.deck[0].cards[card] != undefined) {
			this.updateStatus(
				`${player.toUpperCase()} triggers ${this.cardToText(card)}`
			);
		} else {
		...
		if (card == 'abmtreaty') {
			...
			this.updateStatus(
				'<div class="status-message" id="status-message">' +
					player.toUpperCase() +
					' <span>plays ABM Treaty</span></div>'
			);
		...
		if (card == 'africa') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>Africa:</span> ' + total_vp + ' <span>VP</span>'
			);
		...
		if (card == 'aldrichames') {
			...
			if (this.game.player == 2) {
				...
				for (let i = 0; i < this.game.deck[0].hand.length; i++) {
					if (
						this.game.deck[0].hand[i] != 'aldrichames' &&
						this.game.deck[0].hand[i] !== 'china' &&
						this.game.deck[0].hand[i] !==
							this.game.state.headline_opponent_card &&
						this.game.deck[0].hand[i] !==
		...
		if (card == 'allende') {
			...
			if (!i_played_the_card) {
				if (player == 'ussr') {
					this.game.queue.push(
						`ACKNOWLEDGE\tUSSR plays ${this.cardToText(card)}.`
					);
				} else {
					this.game.queue.push(
						`ACKNOWLEDGE\tUS triggers ${this.cardToText(card)}.`
					);
				}
			}
			return 1;
		...
		if (card == 'arabisraeli') {
			if (this.game.state.events.campdavid == 1) {
				this.updateLog(
					'Arab-Israeli conflict cancelled by Camp David Accords'
				);
				return 1;
			}
			...
			let roll = this.rollDice(6);
			this.updateLog(
				`${player.toUpperCase()} rolls: ${roll}, adjusted: ${
					roll - modifications
				}`
			);
		...
		if (card == 'armsrace') {
			...
			this.updateVictoryPoints();
			this.updateLog(
				`${player.toUpperCase()} gains ${bonus} VP from ${this.cardToText(
					card
				)}`
			);
			this.displayModal(
				this.cardToText(card),
				`${player.toUpperCase()} gains ${bonus} VP`
			);
			if (!i_played_the_card) {
				this.game.queue.push(
					`ACKNOWLEDGE\t${player.toUpperCase()} plays ${this.cardToText(
						card
					)}.`
				);
			}
		...
		if (card == 'asia') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>Asia:</span> ' + total_vp + ' <span>VP</span>'
			);
			this.updateVictoryPoints();
			...
			if (this.game.player == 2) {
				...
				for (let i = 0; i < this.game.deck[0].hand.length; i++) {
					...
					if (
						...
						card_in_hand !=
							this.game.state.headline_opponent_card &&
						card_in_hand != this.game.state.headline_card
					) {
				...
				if (cardList.length == 0) {
					twilight_self.addMove(
						'notify\tUS has no cards available to discard'
					);
					twilight_self.endTurn();
					return;
				}
				...
				twilight_self.hud.attachControlCallback(function (action2) {
					if (action2 == 'finished') {
						...
						if (
							cards_to_deal_before_reshuffle >
							twilight_self.game.deck[0].crypt.length
						) {
							cards_to_deal_before_reshuffle =
								twilight_self.game.deck[0].crypt.length;
							let cards_to_deal_after_reshuffle =
								cards_discarded -
								cards_to_deal_before_reshuffle;
							if (cards_to_deal_after_reshuffle > 0) {
								twilight_self.addMove(
									'DEAL\t1\t2\t' +
										cards_to_deal_after_reshuffle
								);
							}

							let discarded_cards =
								twilight_self.returnDiscardedCards();
							...
							if (Object.keys(discarded_cards).length > 0) {
								...
								twilight_self.addMove(
									'DECK\t1\t' +
										JSON.stringify(discarded_cards)
								);
								twilight_self.addMove('DECKBACKUP\t1');
								twilight_self.addMove(
									'NOTIFY\tcards remaining: ' +
										twilight_self.game.deck[0].crypt.length
								);
								twilight_self.addMove(
									'NOTIFY\tShuffling discarded cards back into the deck...'
								);
							}
						}

						twilight_self.addMove(
							'DEAL\t1\t2\t' + cards_to_deal_before_reshuffle
						);
						twilight_self.endTurn();
					} else {
		...
		if (card == 'blockade') {
			...
			if (this.game.state.events.optional.berlinagreement == 1) {
				this.updateLog(
					`${this.cardToText(
						'berlinagreement'
					)} prevents ${this.cardToText('blockade')}.`
				);
				return 1;
			}
			...
			if (this.game.player == 2) {
				...
				for (let i = 0; i < this.game.deck[0].hand.length; i++) {
					if (this.game.deck[0].hand[i] != 'china') {
						let avops = this.modifyOps(
							ac[this.game.deck[0].hand[i]].ops,
							this.game.deck[0].hand[i],
							'us',
							0
						);
				...
				if (cards_to_discard.length == 0) {
					this.addMove(
						'remove\tus\tus\twestgermany\t' +
							this.countries['westgermany'].us
					);
					this.addMove(
						'NOTIFY\tUS loses all influence from West Germany'
					);
					this.removeInfluence(
						'westgermany',
						this.countries['westgermany'].us,
					...
					this.updateStatus(
						`<div class='status-message' id='status-message'>${twilight_self.cardToText(
							'blockade'
						)} played: no cards available to discard.</div>`
					);
					return 0;
				}
				...
				this.updateStatusWithOptions(
					`${this.cardToText(card)}:`,
					'<ul><li class="option" id="discard">discard 3 OP card</li><li class="option" id="remove">remove all US influence in W. Germany</li></ul>',
					function (action) {
						if (action == 'discard') {
							twilight_self.updateStatusAndListCards(
								...
								function (card) {
									...
									twilight_self.addMove(
										`NOTIFY\tUS discarded ${twilight_self.cardToText(
											card
										)} to resolve ${twilight_self.cardToText(
											'blockade'
										)}`
									);
									twilight_self.endTurn();
						...
						if (action == 'remove') {
							twilight_self.addMove(
								'remove\tus\tus\twestgermany\t' +
									twilight_self.countries['westgermany'].us
							);
							twilight_self.addMove(
								'NOTIFY\tUS loses all influence from West Germany'
							);
							...
							twilight_self.updateStatus(
								`<div class='status-message' id='status-message'>${twilight_self.cardToText(
									'blockade'
								)}: lose all influence in West Germany.</div>`
							);
							return 0;
						}
					}
				...
				this.updateStatus(
					`<div class='status-message' id='status-message'>US is responding to ${this.cardToText(
						card
					)}</div>`
				);
			}
		...
		if (card == 'brushwar') {
			...
			if (me == player) {
				...
				twilight_self.updateStatus(
					'<div class="status-message" id="status-message">Pick target for Brush War</div>'
				);
						...
						$(divname).on('click', function () {
							...
							if (
								...
								if (twilight_self.game.state.events.nato == 1) {
									if (
										twilight_self.isControlled('us', c) == 1
									) {
										twilight_self.displayModal(
											'NATO prevents Brush War in Europe'
										);
										return;
									}
								}
							...
							for (
								let v = 0;
								v <
								twilight_self.countries[c].neighbours.length;
								v++
							) {
								if (
									twilight_self.isControlled(
										opponent,
										twilight_self.countries[c].neighbours[v]
									) == 1
								) {
									modifications++;
								}
							...
							if (die >= 3 + modifications) {
								...
								if (player == 'us') {
									influence_change =
										twilight_self.countries[c].ussr;
								} else {
									influence_change =
										twilight_self.countries[c].us;
								}

								if (influence_change > 0) {
									twilight_self.addMove(
										`place\t${player}\t${player}\t${c}\t${influence_change}`
									);
									twilight_self.addMove(
										`remove\t${player}\t${opponent}\t${c}\t${influence_change}`
									);
									twilight_self.placeInfluence(
										c,
										influence_change,
							...
							twilight_self.addMove(
								'NOTIFY\t' +
									player.toUpperCase() +
									` rolls for Brush War: ${die}, adjusted: ${
										die - modifications
									}`
							);
							twilight_self.addMove(
								`war\t${card}\t${winner}\t${die}\t${modifications}\t${player}\t${success}`
							);
							twilight_self.endTurn();
						});
					}
		...
		if (card == 'cambridge') {
			...
			if (this.game.state.round > 7) {
				this.updateLog(
					'<span>The Cambridge Five cannot be played as an event in Late Wa</span>'
				);
				this.updateStatus(
					'The Cambridge Five cannot be played as an event in Late War'
				);
				return 1;
			}
			...
			if (this.game.player == 2) {
				...
				if (revealed.length == 0) {
					...
					let scoring_alert =
						'cambridge\t' + keys.replaceAll(' ', '\t');
					this.addMove(scoring_alert);
					this.addMove('showhand\t2\t' + keys);
					this.addMove(
						'NOTIFY\tUS has scoring cards for: ' + revealed
					);
					this.endTurn();
					this.updateStatus(
						`USSR is placing influence for ${this.cardToText(card)}`
					);
				}
			}
		...
		if (card == 'camerica') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>Central America:</span> ' + total_vp + ' <span>VP</span>'
			);
		...
		if (card == 'che') {
			...
			if (player == 'us') {
				couppower = this.modifyOps(3, 'che', 'us');
			}
			if (player == 'ussr') {
				couppower = this.modifyOps(3, 'che', 'ussr');
			}

			for (var c in this.countries) {
				if (
					twilight_self.countries[c].bg == 0 &&
					(twilight_self.countries[c].region == 'africa' ||
						twilight_self.countries[c].region == 'camerica' ||
						twilight_self.countries[c].region == 'samerica') &&
					twilight_self.countries[c].us > 0
				) {
					valid_targets++;
					$('#' + c).addClass('easterneurope');
			...
			if (this.game.player == 1) {
				...
				let user_message = `${this.cardToText(
					card
				)} takes effect. Pick first target for coup:`;
				let html =
					'<ul><li class="option" id="skipche">or skip coup</li></ul>';
		...
		if (card == 'chernobyl') {
			...
			this.updateStatusWithOptions(
				'Chernobyl triggered. Designate region to prohibit USSR placement of influence from OPS:',
				html,
				function (action2) {
					twilight_self.addMove('resolve\tchernobyl');
					twilight_self.addMove('chernobyl\t' + action2);
					twilight_self.addMove(
						'NOTIFY\tUS restricts placement in ' + action2
					);
					twilight_self.endTurn();
				}
			);
		...
		if (card == 'cia') {
			...
			if (this.game.player == 1) {
				...
				this.endTurn();
				this.updateStatus(
					`<div class='status-message' id='status-message'>US saw your hand and is playing 1OP (${this.cardToText(
						card
					)})</div>`
				);
			}
		...
		if (card == 'comecon') {
			if (this.game.player == 1) {
				...
				twilight_self.updateStatus(
					'Place ' +
						ops_to_place +
						' influence in non-US controlled countries in Eastern Europe (1 per country)'
				);
		...
		if (card == 'cubanmissile') {
			...
			this.updateDefcon();
			if (player == 'ussr') {
				this.game.state.events.cubanmissilecrisis = 2;
			}
			if (player == 'us') {
				this.game.state.events.cubanmissilecrisis = 1;
			}
				...
				if (this.game.state.events.china_card == 2) {
					...
					if (this.game.player == 2) {
						...
						if (do_i_have_cc == 1) {
							...
							this.game.state.vp -= 1;
							this.updateLog(
								'USSR gains 1 VP from Cultural Revolution'
							);
							this.updateVictoryPoints();
						}
					}
		...
		if (card == 'debtcrisis') {
			...
			if (this.game.player == 2) {
				...
				let user_message =
					'Choose a card to discard or USSR doubles influence in two countries in South America:';
				...
				if (cards_to_discard.length <= 1) {
					...
					this.addMove(
						'notify\tUS has no cards available for Latin American Debt Crisis'
					);
					this.endTurn();
					return 0;
				}
				...
				twilight_self.hud.attachControlCallback(function (action2) {
					...
					twilight_self.addMove(
						'NOTIFY\tUS discards ' +
							twilight_self.cardToText(action2) +
							' to resolve ' +
							twilight_self.cardToText(card)
					);
					twilight_self.removeCardFromHand(action2);
		...
		if (card == 'defectors') {
			if (this.game.state.headline == 0) {
				...
				this.game.state.vp += 1;
				this.updateLog(
					`US gains 1 VP from ${this.cardToText('defectors')}`
				);
				this.updateVictoryPoints();
			} else {
				//
		...
		if (card == 'destalinization') {
			...
			if (this.game.player == 1) {
				...
				twilight_self.updateStatus(
					'<div class="status-message" id="status-message">Remove four USSR influence from existing countries:</div>'
				);
				...
				$('.country').on('click', function () {
					...
					if (twilight_self.countries[c].ussr <= 0) {
						...
						if (ops_to_purge == 0) {
							twilight_self.updateStatus(
								'<div class="status-message" id="status-message">Add four USSR influence to any non-US controlled countries</div>'
							);
							twilight_self.playerFinishedPlacingInfluence();
							...
							$('.country').on('click', function () {
								...
								if (twilight_self.isControlled('us', cn) == 1) {
									twilight_self.displayModal(
										'Cannot re-allocate to US controlled countries'
									);
									return;
								}
								...
								if (countries_placed[cn] == 2) {
									twilight_self.displayModal(
										'Cannot place more than 2 influence in any one country'
									);
									return;
								} else {
									twilight_self.placeInfluence(cn, 1, 'ussr');
									twilight_self.addMove(
										'place\tussr\tussr\t' + cn + '\t1'
									);
									ops_to_place--;
									countries_placed[cn]++;
									if (ops_to_place == 0) {
		...
		if (card == 'easteuropean') {
			if (this.game.player == 2) {
				...
				if (twilight_self.countries['czechoslovakia'].ussr > 0) {
					options_purge.push('czechoslovakia');
				}
				if (twilight_self.countries['austria'].ussr > 0) {
					options_purge.push('austria');
				}
				if (twilight_self.countries['hungary'].ussr > 0) {
					options_purge.push('hungary');
				}
				if (twilight_self.countries['romania'].ussr > 0) {
					options_purge.push('romania');
				}
				if (twilight_self.countries['yugoslavia'].ussr > 0) {
					options_purge.push('yugoslavia');
				}
				if (twilight_self.countries['bulgaria'].ussr > 0) {
					options_purge.push('bulgaria');
				}
				if (twilight_self.countries['eastgermany'].ussr > 0) {
					options_purge.push('eastgermany');
				}
				if (twilight_self.countries['poland'].ussr > 0) {
					options_purge.push('poland');
				}
				if (twilight_self.countries['finland'].ussr > 0) {
					options_purge.push('finland');
				}

				if (options_purge.length <= countries_to_purge) {
					//Speed up the game and select for the player
					let msg = `${twilight_self.cardToText(
						card
					)}: Auto remove ${ops_to_purge} OPS from `;
					for (let i = 0; i < options_purge.length; i++) {
						...
						msg +=
							twilight_self.countries[options_purge[i]].name +
							', ';
					}
					...
					twilight_self.updateStatus(
						'Remove ' +
							ops_to_purge +
							' from 3 countries in Eastern Europe'
					);
		...
		if (card == 'europe') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>Europe:</span> ' + total_vp + ' <span>VP</span>'
			);
			this.updateVictoryPoints();
		...
		if (card == 'fiveyearplan') {
			...
			if (this.game.player == 1) {
				...
				for (
					let i = 0;
					i < twilight_self.game.deck[0].hand.length;
					i++
				) {
					...
					if (
						...
						!(
							...
							(thiscard ==
								this.game.state.headline_opponent_card ||
								thiscard == this.game.state.headline_card)
						)
					) {
						available_cards.push(thiscard);
					}
					...
					twilight_self.rollDice(
						...
						function (roll) {
							...
							if (ac[card].player == 'us') {
								...
								twilight_self.addMove(
									'modal\tFive Year Plan\tUSSR triggers ' +
										twilight_self.cardToText(card)
								);
								twilight_self.addMove(
									'NOTIFY\tFive Year Plan triggers US event: ' +
										twilight_self.cardToText(card)
								);
								twilight_self.endTurn();
							} else {
								twilight_self.addMove(
									'modal\tFive Year Plan\tUSSR discards ' +
										twilight_self.cardToText(card)
								);
								twilight_self.addMove(
									'NOTIFY\tUSSR discarded ' +
										twilight_self.cardToText(card)
								);
								twilight_self.endTurn();
							}
		...
		if (card == 'glasnost') {
			...
			if (this.game.state.events.reformer == 1) {
				...
				this.game.queue.push(
					'notify\tUSSR plays 4 OPS for influence or realignments'
				);
			} else {
				if (!i_played_the_card) {
					if (player == 'ussr') {
		...
		if (card == 'grainsales') {
			...
			if (this.game.player == 1) {
				...
				if (available_cards.length == 0) {
					...
					this.addMove(
						'setvar\tgame\tstate\tback_button_cancelled\t1'
					);
					this.addMove(
						`NOTIFY\tUSSR has no cards to give for ${this.cardToText(
							card
						)}`
					);
					this.endTurn();
					...
					twilight_self.rollDice(
						...
						function (roll) {
							...
							twilight_self.addMove(
								'notify\tUSSR shares ' +
									twilight_self.cardToText(newcard)
							);
							twilight_self.endTurn();
							twilight_self.updateStatus(
								`<div class='status-message' id='status-message'>Sending ${twilight_self.cardToText(
									newcard
								)} to US</div>`
							);
						}
		...
		if (card == 'howilearned') {
			...
			if (player == 'ussr') {
				this.game.state.milops_ussr = 5;
			}
			if (player == 'us') {
				this.game.state.milops_us = 5;
			}
			...
			let adjustDefcon = function (defcon_target) {
				...
				if (defcon_target > twilight_self.game.state.defcon) {
					let defcon_diff =
						defcon_target - twilight_self.game.state.defcon;
				...
				if (defcon_target < twilight_self.game.state.defcon) {
					let defcon_diff =
						twilight_self.game.state.defcon - defcon_target;
					for (let i = 0; i < defcon_diff; i++) {
			...
			if (i_played_the_card) {
				...
				//
				for (let i = 1; i <= 5; i++) {
					twilight_self.app.browser.addElementToDom(
						`<div id="${i}" class="set_defcon_box set_defcon_box_${i}"></div>`,
						document.getElementById('gameboard')
					);
					$('.set_defcon_box_' + i).css(
						'top',
						twilight_self.scale(
							twilight_self.game.state.defcon_ps[5 - i].top
						) + 'px'
					);
					$('.set_defcon_box_' + i).css(
						'left',
						twilight_self.scale(
							twilight_self.game.state.defcon_ps[5 - i].left
						) + 'px'
					);
				}
				...
				$('.set_defcon_box').on('click', async function (e) {
					...
					let confirm_it = await sconfirm(
						'Set DEFCON at ' + defcon_target + '?'
					);
					if (!confirm_it) {
						return;
					}
				...
				twilight_self.updateStatusWithOptions(
					'Set DEFCON to:',
					'<ul><li class="option" id="5">five</li><li class="option" id="4">four</li><li class="option" id="3">three</li><li class="option" id="2">two</li><li class="option" id="1">one</li></ul></div>',
					function (action2) {
		...
		if (card == 'indopaki') {
			...
			if (this.roles[this.game.player] == player) {
				...
				twilight_self.updateStatusWithOptions(
					'Indo-Pakistani War. Choose Target to invade:',
					'<ul><li class="option" id="pakistan">Pakistan</li><li class="option" id="india">India</li></ul>',
					function (invaded) {
						let modifications = 0;
						let winner = 'india';

						for (let c of twilight_self.countries[invaded]
							.neighbours) {
							if (twilight_self.isControlled(opponent, c) == 1) {
								modifications++;
							}
						}
						...
						if (die >= target + modifications) {
							...
							if (player == 'us') {
								influence_change =
									twilight_self.countries[invaded].ussr;
							} else {
								influence_change =
									twilight_self.countries[invaded].us;
							}
							if (influence_change > 0) {
								twilight_self.addMove(
									`place\t${player}\t${player}\t${invaded}\t${influence_change}`
								);
								twilight_self.addMove(
									`remove\t${player}\t${opponent}\t${invaded}\t${influence_change}`
								);
								twilight_self.placeInfluence(
									invaded,
									influence_change,
		...
		if (card == 'indreds') {
			if (this.game.player == 2) {
				...
				let czechoslovakia_diff =
					czechoslovakia_ussr - czechoslovakia_us;

				this.addMove('resolve\tindreds');
				if (
					hungary_us >= hungary_ussr &&
					yugo_us >= yugo_ussr &&
					romania_us >= romania_ussr &&
					bulgaria_us >= bulgaria_ussr &&
					czechoslovakia_us >= czechoslovakia_ussr
				) {
					this.endTurn();
					return 0;
				} else {
					...
					if (yugo_diff > 0) {
						userhtml +=
							'<li class="option" id="yugoslavia">Yugoslavia</li>';
					}
					if (romania_diff > 0) {
						userhtml +=
							'<li class="option" id="romania">Romania</li>';
					}
					if (bulgaria_diff > 0) {
						userhtml +=
							'<li class="option" id="bulgaria">Bulgaria</li>';
					}
					if (hungary_diff > 0) {
						userhtml +=
					...
					if (czechoslovakia_diff > 0) {
						userhtml +=
							'<li class="option" id="czechoslovakia">Czechoslovakia</li>';
					}
					userhtml += '</ul>';

					let twilight_self = this;
					this.updateStatusWithOptions(
						'Match USSR influence in which country?',
						userhtml,
						function (myselect) {
							$('.card').off();
							...
							if (myselect == 'romania') {
								...
								twilight_self.addMove(
									'place\tus\tus\tromania\t' + romania_diff
								);
								twilight_self.endTurn();
							}
							if (myselect == 'yugoslavia') {
								...
								twilight_self.addMove(
									'place\tus\tus\tyugoslavia\t' + yugo_diff
								);
								twilight_self.endTurn();
							}
							if (myselect == 'bulgaria') {
								...
								twilight_self.addMove(
									'place\tus\tus\tbulgaria\t' + bulgaria_diff
								);
								twilight_self.endTurn();
							}
							if (myselect == 'hungary') {
								...
								twilight_self.addMove(
									'place\tus\tus\thungary\t' + hungary_diff
								);
								twilight_self.endTurn();
							}
		...
		if (card == 'iranianhostage') {
			...
			if (this.countries['iran'].us > 0) {
				this.removeInfluence('iran', this.countries['iran'].us, 'us');
			}
		...
		if (card == 'iraniraq') {
			...
			if (this.roles[this.game.player] == player) {
				...
				twilight_self.updateStatusWithOptions(
					'Iran-Iraq War. Choose Target:',
					'<ul><li class="option" id="iraq">Iraq</li><li class="option" id="iran">Iran</li></ul>',
					function (invaded) {
						let target = 4;
						let modifications = 0;
						let winner = '';
		...
		if (card == 'ironlady') {
			...
			if (this.countries['uk'].ussr > 0) {
				this.removeInfluence('uk', this.countries['uk'].ussr, 'ussr');
			}
		...
		if (card == 'junta') {
			...
			if (i_played_the_card) {
				...
				let className =
					player == 'us' ? 'westerneurope' : 'easterneurope';
				var twilight_self = this;
				twilight_self.playerFinishedPlacingInfluence();
				...
				twilight_self.updateStatus(
					'<div class="status-message" id="status-message">' +
						player.toUpperCase() +
						' to place 2 Influence in Central or South America</div>'
				);
				...
				$(divname).on('click', function () {
					...
					let confirmoptional =
						'<ul><li class="option" id="conduct">coup or realign</li><li class="option" id="skip">skip</li></ul>';
					twilight_self.updateStatusWithOptions(
						'Do you wish to use 2 free OPS for a coup or realignment rolls in Central or South America?',
						confirmoptional,
						function (action2) {
							if (action2 == 'conduct') {
		...
		if (card == 'kitchendebates') {
			...
			if (us_bg > ussr_bg) {
				...
				this.updateLog(
					'US controls ' +
						us_bg +
						' battlegrounds and USSR controls ' +
						ussr_bg +
						' battlegrounds'
				);
				...
				this.updateLog(
					'US does not have more battleground countries than USSR...'
				);
			}
			if (!i_played_the_card) {
				if (player == 'ussr') {
		...
		if (card == 'koreanwar') {
			...
			if (this.isControlled('us', 'taiwan') == 1) {
				modifications++;
			}
			if (this.isControlled('us', 'northkorea') == 1) {
				modifications++;
		...
		if (card == 'liberation') {
			...
			if (this.game.player == 1) {
				...
				this.updateStatus(
					'USSR places three influence in Central America (max 2 per country)'
				);
				for (var i in this.countries) {
		...
		if (card == 'marine') {
			if (this.countries['lebanon'].us > 0) {
				...
				this.updateLog(
					`${this.cardToText(
						card
					)}: All US influence removed from Lebanon`
				);
			} else {
				this.updateLog(
					`${this.cardToText(
						card
					)}: No US influence in Lebanon to remove`
				);
			}
			...
			if (this.game.player == 1) {
				...
				this.updateStatus(
					'Remove' +
						ops_to_purge +
						' US influence from the Middle East'
				);
		...
		if (card == 'marshall') {
			...
			if (this.game.player == 2) {
				...
				this.updateStatus(
					'Place 1 influence in each of ' +
						ops_to_place +
						' non USSR-controlled countries in Western Europe'
				);
		...
		if (card == 'mideast') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>Middle East:</span> ' + total_vp + ' <span>VP</span>'
			);
		...
		if (card == 'missileenvy') {
			...
			if (this.game.player == respondant) {
				...
				for (let i = 0; i < available_cards.length; i++) {
					...
					if (
						this.modifyOps(card.ops, available_cards[i], player) ==
						selected_ops
					) {
						multiple_cards = 1;
					}
				...
				if (multiple_cards == 0) {
					...
					//
					this.addMove(
						'missileenvy\t' + respondant + '\t' + selected_card
					);
					this.endTurn();
				} else {
					//
					...
					for (let i = 0; i < available_cards.length; i++) {
						if (
							this.modifyOps(
								ac[available_cards[i]].ops,
								available_cards[i],
								player
							) == selected_ops &&
							available_cards[i] != 'china'
						) {
							html += `<li class="option" id="${
								available_cards[i]
							}">${ac[available_cards[i]].name}</li>`;
						}
					}
					html += '</ul>';
					this.updateStatusWithOptions(
						'Select card to give opponent:',
						html,
						function (action2) {
							//
							// offer card
							//
							twilight_self.addMove(
								'missileenvy\t' + respondant + '\t' + action2
							);
							twilight_self.endTurn();
						}
					);
				...
				this.updateStatus(
					`<div class='status-message' id='status-message'>${this.roles[
						respondant
					].toUpperCase()} is returning card for ${this.cardToText(
						card
					)}</div>`
				);
			}
		...
		if (card == 'muslimrevolution') {
			if (this.game.state.events.awacs == 1) {
				this.updateLog(
					`${this.cardToText(
						'muslimrevolution'
					)} prevented by ${this.cardToText('awacs')}}`
				);
				return 1;
			}
			...
			if (muslim_countries.length == 0) {
				this.updateLog(
					'Muslim Revolutions targets no countries with US influence.'
				);
				return 1;
			}
			...
			if (muslim_countries.length <= 2) {
				for (var i of muslim_countries) {
					this.updateLog(
						'Muslim Revolutions removes all US influence in ' + i
					);
			...
			if (this.game.player == 1) {
				...
				this.updateStatus(
					'Remove All US influence from 2 countries among: Sudan, Egypt, Iran, Iraq, Libya, Saudi Arabia, Syria, Jordan.'
				);
		...
		if (card == 'nasser') {
			...
			this.updateStatus(
				'Nasser - Soviets add two influence in Egypt. US loses half (rounded-up) of all influence in Egypt.'
			);
		...
		if (card == 'nato') {
			if (
				...
				this.updateLog(
					'NATO cannot trigger before Warsaw Pact or Marshall Plan. Moving to discard pile.'
				);
			}
			return 1;
		}
			...
			if (does_us_get_vp == 1) {
				...
				if (this.game.player == 1) {
					for (let i = 0; i < this.game.deck[0].hand.length; i++) {
						if (this.game.deck[0].hand[i] == 'china') {
							this.updateLog(
								'US gets the China Card (face down)'
							);
							this.game.deck[0].hand.splice(i, 1);
						}
					}
		...
		if (card == 'oas') {
			if (this.game.player == 2) {
				...
				this.updateStatus(
					'US places two influence in Central or South America'
				);
				for (var i in this.countries) {
					if (
						this.countries[i].region == 'samerica' ||
		...
		if (card == 'olympic') {
			...
			if (player == opponent) {
				...
				twilight_self.updateStatusWithOptions(
					`${opponent.toUpperCase()} hosts the ${this.cardToText(
						card
					)}:`,
					'<ul><li class="option" id="boycott">boycott</li><li class="option" id="participate">participate</li></ul>',
					function (action) {
						if (action == 'boycott') {
							twilight_self.addMove(
								'ops\t' + opponent + '\tolympic\t4'
							);
							twilight_self.addMove(
								'setvar\tgame\tstate\tback_button_cancelled\t1'
							);
						...
						if (action == 'participate') {
							...
							while (winner == 0) {
								...
								if (opponent == 'us') {
									twilight_self.addMove(
										`NOTIFY\tOlympic Games: USSR rolls ${ussrroll} / US rolls ${usroll} (+2 hosting bonus)`
									);
									usroll += 2;
								} else {
									twilight_self.addMove(
										`NOTIFY\tOlympic Games: USSR rolls ${ussrroll} (+2 hosting bonus) / US rolls ${usroll}`
									);
									ussrroll += 2;
								}
				...
				this.updateStatus(
					`<div class='status-message' id='status-message'>${opponent.toUpperCase()} is deciding whether to boycott the ${this.cardToText(
						card
					)}</div>`
				);
			}
		...
		if (card == 'opec') {
			if (this.game.state.events.northseaoil == 1) {
				this.updateLog(
					`${this.cardToText(card)} prevented by ${this.cardToText(
						'northseaoil'
					)}`
				);
				return 1;
		...
		if (card == 'ortega') {
			...
			if (this.countries['cuba'].us > 0) {
				can_coup = 1;
			}
			if (this.countries['honduras'].us > 0) {
				can_coup = 1;
			}
			if (this.countries['costarica'].us > 0) {
				can_coup = 1;
			}
			...
			if (this.game.state.events.cubanmissilecrisis == 1) {
				this.updateStatus(
					'USSR is under Cuban Missile Crisis and cannot coup. Skipping Ortega coup.'
				);
				this.updateLog(
					'USSR is under Cuban Missile Crisis and cannot coup. Skipping Ortega coup.'
				);
			...
			if (this.game.player == 1) {
				...
				twilight_self.updateStatusWithOptions(
					'Pick a country adjacent to Nicaragua to coup:',
					'<ul><li class="option" id="skiportega">or skip coup</li></ul>',
					function (action2) {
						if (action2 == 'skiportega') {
							twilight_self.updateStatus(
								'Skipping Ortega coup...'
							);
			...
			if (this.game.player == 1) {
				...
				this.updateStatus(
					`<div class='status-message' id='status-message'>${this.cardToText(
						card
					)}: Remove 3 US influence from Western Europe (max 1 per country)</div>`
				);
				...
				if (valid_targets.length == 0) {
					twilight_self.addMove(
						'NOTIFY\tUS does not have any targets for ' +
							twilight_self.cardToText(card)
					);
					twilight_self.endTurn();
					return;
				...
				$('.easterneurope').on('click', function () {
					...
					if (twilight_self.countries[c].place != 1) {
						...
						twilight_self.updateStatus(
							`<div class='status-message' id='status-message'>${twilight_self.cardToText(
								card
							)}: Remove ${ops_to_purge} US influence from Western Europe (max 1 per country)</div>`
						);
					}
				});
			}
		...
		if (card == 'puppet') {
			if (this.game.player == 2) {
				...
				this.updateStatus(
					'US place three influence in countries without any influence'
				);
		...
		if (card == 'reagan') {
			...
			if (x >= 2) {
				...
				this.updateLog(
					'<span>Reagan bombs Libya and US scores</span> ' +
						us_vp +
						' <span>VP</span>'
				);
		...
		if (card == 'redscare') {
			if (player == 'ussr') {
				this.game.state.events.redscare_player2 += 1;
				if (!this.game.state.events.redscare_player2_count) {
					this.game.state.events.redscare_player2_count = 0;
				}
				this.game.state.events.redscare_player2_count++;
			}
			if (player == 'us') {
				this.game.state.events.redscare_player1 += 1;
				if (!this.game.state.events.redscare_player1_count) {
					this.game.state.events.redscare_player1_count = 0;
				}
			...
			if (i_played_the_card) {
				...
				for (var i in this.game.deck[0].discards) {
					...
					try {
						...
						console.log(
							'ERROR: please check scoring error in SALT for card: ' +
								i
						);
					}
				}
		...
		if (card == 'seasia') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>Southeast Asia:</span> ' + total_vp + ' <span>VP</span>'
			);
		...
		if (card == 'socgov') {
			if (this.game.state.events.ironlady == 1) {
				...
				this.updateStatus(
					'Socialist Governments prevented by Iron Lady'
				);
				return 1;
			}
			...
			if (this.game.player == 1) {
				...
				for (var i of europeanCountries) {
					if (twilight_self.countries[i].us == 1) {
						available_targets += 1;
					}
					if (twilight_self.countries[i].us > 1) {
						available_targets += 2;
				...
				this.updateStatus(
					'Remove ' +
						ops_to_purge +
						' US influence from Western Europe (max 2 per country)'
				);
		...
		if (card == 'solidarity') {
			if (this.game.state.events.johnpaul == 0) {
				this.updateLog(
					`${this.cardToText(
						card
					)} does not trigger because no ${this.cardToText(
						'johnpaul'
					)}`
				);
				return 1;
		...
		if (card == 'southafrican') {
			if (this.game.player == 1) {
				...
				twilight_self.updateStatusWithOptions(
					`${twilight_self.cardToText(card)}: `,
					'<ul><li class="option" id="southafrica">2 Influence in South Africa</li><li class="option" id="adjacent">1 Influence in South Africa and 2 Influence in an adjacent country</li></ul>',
					function (action2) {
						...
						if (action2 == 'adjacent') {
							...
							twilight_self.addMove(
								'place\tussr\tussr\tsouthafrica\t1'
							);

							twilight_self.updateStatus(
								'Place two influence in neighboring country'
							);
		...
		if (card == 'samerica') {
			...
			this.game.state.vp += total_vp;
			this.updateLog(
				'<span>South America:</span> ' + total_vp + ' <span>VP</span>'
			);
			...
			if (this.isControlled('us', 'uk') == 1) {
				if (this.game.player == 2) {
					...
					if (this.game.state.events.nato == 1) {
						...
						this.updateStatus(
							'US is playing Special Relationship. Place 2 OPS anywhere in Western Europe.'
						);
					} else {
						this.updateStatus(
							'US is playing Special Relationship. Place 1 OP adjacent to the UK.'
						);
						placeable.push('canada');
						placeable.push('france');
						placeable.push('norway');
				...
				this.updateLog(
					`${this.cardToText(
						card
					)} doesn't trigger because UK not controlled by US`
				);
			}
		...
		if (card == 'starwars') {
			...
			if (
				...
				this.updateLog(
					`US is not ahead of USSR in the space race (${this.cardToText(
						card
					)})`
				);
				return 1;
			...
			for (var i in this.game.deck[0].discards) {
				if (this.game.state.headline == 1 && i == 'unintervention') {
				} else {
					if (ac[i] != undefined) {
						if (ac[i].name != undefined) {
							if (ac[i].scoring != 1) {
								if (
									this.game.state.events.shuttlediplomacy ==
										0 ||
									(this.game.state.events.shuttlediplomacy ==
										1 &&
										i != 'shuttle')
			...
			if (discard_deck.length == 0) {
				twilight_self.addMove(
					`NOTIFY\tUS cannot use ${this.cardToText(
						card
					)} as no cards to retrieve`
				);
				twilight_self.endTurn();
				return 1;
			}
			...
			if (this.game.player == 2) {
				...
				twilight_self.updateStatusAndListCards(
					`${this.cardToText(
						card
					)}: Choose card to play immediately:`,
					discard_deck,
					false
				);
				twilight_self.hud.attachControlCallback(function (action2) {
		...
		if (card == 'suezcrisis') {
			if (this.game.player == 1) {
				...
				twilight_self.updateStatus(
					'Remove four influence from Israel, UK or France'
				);
				...
				if (options_available <= 4) {
					this.updateLog(
						'Suez Crisis auto-removed available influence'
					);
					...
					if (israel_ops > 0) {
						...
						twilight_self.addMove(
							'remove\tussr\tus\tisrael\t' + israel_ops
						);
					}
					if (france_ops > 0) {
						twilight_self.removeInfluence(
						...
						twilight_self.addMove(
							'remove\tussr\tus\tfrance\t' + france_ops
						);
					}
					if (uk_ops > 0) {
						twilight_self.removeInfluence('uk', uk_ops, 'us');
						twilight_self.addMove(
							'remove\tussr\tus\tuk\t' + uk_ops
						);
					}
					twilight_self.endTurn();
				} else {
					if (twilight_self.countries['uk'].us > 0) {
						options_purge.push('uk');
					}
					if (twilight_self.countries['france'].us > 0) {
						options_purge.push('france');
					}
					if (twilight_self.countries['israel'].us > 0) {
						options_purge.push('israel');
					}
		...
		if (card == 'summit') {
			...
			if (
				this.doesPlayerDominateRegionForSummit('ussr', 'mideast') == 1
			) {
			...
			if (
				this.doesPlayerDominateRegionForSummit('ussr', 'camerica') == 1
			) {
				this.updateLog('Central America: USSR +1 bonus');
				ussr_roll++;
			}
			if (
				this.doesPlayerDominateRegionForSummit('ussr', 'samerica') == 1
			) {
			...
			this.updateLog(
				`${this.cardToText(card)}: US result ${us_roll} (+${
					us_roll - usbase
				} bonus)`
			);
			this.updateLog(
				`${this.cardToText(card)}: USSR result ${ussr_roll} (+${
					ussr_roll - ussrbase
				} bonus)`
			);
			...
			if (us_roll === ussr_roll) {
				...
				if (this.game.player === winner) {
					...
					if (us_roll > ussr_roll) {
						...
						twilight_self.updateLog(
							'USSR receives 2 VP from Summit'
						);
						twilight_self.addMove('vp\tussr\t2');
					}
					...
					twilight_self.updateStatusWithOptions(
						`You win the ${twilight_self.cardToText(card)}:`,
						...
						function (action2) {
							...
							if (action2 == 'lower') {
								twilight_self.addMove('defcon\tlower');
								twilight_self.addMove(
									'notify\tDEFCON is lowered by 1'
								);
								twilight_self.endTurn();
							}
							if (action2 == 'same') {
								twilight_self.addMove(
									'notify\tDEFCON left untouched'
								);
								twilight_self.endTurn();
							}
						}
					...
					if (this.game.player == 0) {
						this.updateStatus(
							`${this.roles[
								winner
							].toUpperCase()} won the ${this.cardToText(card)}`
						);
					} else {
						this.updateStatus(
							`You lost the ${this.cardToText(
								card
							)}, waiting for opponent to change DEFCON`
						);
					}
				}
				return 0;
		...
		if (card == 'tehran') {
			...
			if (this.game.player == 1) {
				...
				for (
					let i = 0;
					i < this.game.deck[0].crypt.length && i < 5;
					i++
				) {
		...
		if (card == 'terrorism') {
			...
			if (
				...
				this.isControlled('us', 'canada')
			) {
				this.updateLog(
					this.cardToText('argo') +
						' cancels Terrorism against United States'
				);
				return 1;
			}
			...
			if (target == this.roles[this.game.player]) {
				...
				for (let z = 0; z < this.game.deck[0].hand.length; z++) {
					if (
						this.game.deck[0].hand[z] === 'china' ||
						this.game.deck[0].hand[z] ==
							this.game.state.headline_opponent_card ||
						this.game.deck[0].hand[z] ==
							this.game.state.headline_card
					) {
				...
				if (cards_for_select.length < cards_to_discard) {
					cards_to_discard = cards_for_select.length;
				}
				...
				if (cards_to_discard == 0) {
					this.addMove(
						`NOTIFY\t${this.cardToText(
							card
						)}: ${target.toUpperCase()} has no cards to discard`
					);
				}
				...
				for (let i = 0; i < cards_to_discard; i++) {
					if (cards_for_select.length > 0) {
						this.rollDice(cards_for_select.length, function (roll) {
							...
							twilight_self.addMove('dice\tburn\t' + player);
							twilight_self.addMove(
								`discard\t${target}\t${victim}`
							);
							twilight_self.addMove(
								`modal\t${twilight_self.cardToText(
									card
								)}\t${target.toUpperCase()} discarded ${twilight_self.cardToText(
									victim
								)}`
							);
		...
		if (card == 'truman') {
			...
			for (var i in this.countries) {
				if (this.countries[i].region === 'europe') {
					if (
						twilight_self.countries[i].ussr > 0 &&
						twilight_self.whoControls(i) == ''
					) {
			...
			if (options_purge.length == 0) {
				this.updateLog(
					'USSR has no influence that can be removed by Truman'
				);
				return 1;
			}
			...
			if (options_purge.length == 1) {
				twilight_self.removeInfluence(
					options_purge[0],
					twilight_self.countries[options_purge[0]].ussr,
					'ussr'
				);
				this.updateLog(
					'Truman removes all USSR influence from ' + options_purge[0]
				);
				return 1;
			}
			...
			if (this.game.player == 2) {
				...
				twilight_self.updateStatus(
					'Select a non-controlled country in Europe to remove all USSR influence:'
				);
				...
				$('.westerneurope').on('click', function () {
					...
					twilight_self.addMove(
						`NOTIFY\t${twilight_self.cardToText(
							card
						)}: US removes all USSR influence from ` +
							twilight_self.countries[c].name
					);
					twilight_self.addMove(
						'remove\tus\tussr\t' + c + '\t' + ussrpur
					);
					twilight_self.playerFinishedPlacingInfluence();
					twilight_self.endTurn();
				});
		...
		if (card == 'unintervention') {
			...
			if (player === this.roles[this.game.player]) {
				...
				if (twilight_self.game.state.events.u2 == 1) {
					twilight_self.addMove(
						'notify\tU2 activates and triggers +1 VP for USSR'
					);
		...
		if (card == 'ussuri') {
			...
			if (us_cc == 1) {
				this.updateLog(
					'US places 4 influence in Asia (max 2 per country)'
				);
		...
		if (card == 'voiceofamerica') {
			...
			for (var i in this.countries) {
				if (this.countries[i].ussr > 0) {
					ops_removable += this.countries[i].ussr;
				}
			}
			if (ops_to_purge > ops_removable) {
				ops_to_purge = ops_removable;
			}
			if (ops_to_purge <= 0) {
				return 1;
			}
			...
			if (this.game.player == 2) {
				...
				this.hud.back_button_callback = null;
				this.updateStatus(
					'Remove 4 USSR influence from non-European countries (max 2 per country)'
				);
		...
		if (card == 'wargames') {
			if (this.game.state.defcon != 2) {
				this.updateLog(
					'Wargames event cannot trigger as DEFCON is not at 2'
				);
				return 1;
			}
			...
			if (i_played_the_card) {
				...
				let choicehtml =
					'<ul><li class="option" id="endgame">end the game</li><li class="option" id="cont">continue playing</li></ul>';

				this.updateStatusWithOptions(
					`${this.cardToText(
						card
					)}: Do you want to give your opponent 6 VP and End the Game? (VP ties will be won by opponent)`,
					choicehtml,
					function (action2) {
						if (action2 == 'endgame') {
							twilight_self.updateStatus(
		...
		if (card == 'warsawpact') {
          ...
          <ul>
            ...
            <li class="option" id="add">add five USSR influence in Eastern Europe (max 2 per country)</li>
				...
				twilight_self.updateStatusWithOptions(
					'USSR establishes the Warsaw Pact:',
					html,
					function (action2) {
						const europeanCountries = [
							'czechoslovakia',
						...
						if (action2 == 'remove') {
							...
							twilight_self.updateStatus(
								'<div class="status-message" id="status-message">Remove all US influence from four countries in Eastern Europe</div>'
							);
							...
							if (options_purge == 0) {
								twilight_self.displayModal(
									'US has no influence in Eastern Europe',
									'Add influence instead'
								);
								action2 = 'add';
							} else if (
								options_purge.length <= countries_to_purge
							) {
								for (let i = 0; i < options_purge.length; i++) {
									twilight_self.addMove(
										'remove\tussr\tus\t' +
								...
								twilight_self.endTurn();
								twilight_self.updateStatus(
									`Only ${options_purge.length} countries in Eastern Europe with US influence...`
								);
							} else {
						...
						if (action2 == 'add') {
							twilight_self.addMove('resolve\twarsawpact');
							twilight_self.updateStatus(
								'<div class="status-message" id="status-message">Add five influence in Eastern Europe (max 2 per country)</div>'
							);
		...
		if (card == 'antiapartheid') {
			...
			if (twilight_self.game.player == 1) {
				...
				twilight_self.updateStatusWithOptions(
					`${twilight_self.cardToText(card)}: `,
					'<ul><li class="option" id="anywhere">2 Influence in Non-Battlegrounds</li><li class="option" id="african">2 Influence in African Battlegrounds</li></ul>',
					function (action2) {
						...
						if (action2 == 'african') {
							for (var i in twilight_self.countries) {
								if (
									twilight_self.countries[i].region ==
										'africa' &&
									bgs.includes(i)
								) {
									if (twilight_self.countries[i].us > 0) {
										us_troops +=
											twilight_self.countries[i].us;
										targets.push(i);
									}
								}
							}
						...
						if (us_troops == 0) {
							twilight_self.updateLog(
								'US has no influence in non-battleground countries'
							);
							twilight_self.endTurn();
							return 0;
						}
						...
						twilight_self.updateStatus(
							'Remove ' + ops_to_purge + ' US influence'
						);
		...
		if (card == 'berlinagreement') {
			...
			if (this.countries['westgermany'].us > 0) {
				this.countries['westgermany'].us--;
				this.updateLog(
					'Berlin Agreement: 1 US influence removed in West Germany'
				);
			} else {
				this.updateLog(
					'Berlin Agreement: no US influence in West Germany to remove'
				);
			}
			...
			if (this.countries['eastgermany'].ussr > 0) {
				...
				this.updateLog(
					'Berlin Agreement: 1 USSR influence removed in East Germany'
				);
			} else {
				this.updateLog(
					'Berlin Agreement: no USSR influence in East Germany to remove'
				);
			}
		...
		if (card == 'carterdoctrine') {
			...
			this.updateLog(
				'US may ignore DEFCON restrictions on Middle East realignments for remainder of turn'
			);
		...
		if (card == 'energycrisis') {
			...
			if (this.game.player == 2) {
				...
				twilight_self.updateStatusWithOptions(
					`${twilight_self.cardToText(card)}: `,
					'<ul><li class="option" id="givevp">give USSR 2 VP</li><li class="option" id="discard">discard US OPs</li></ul>',
					function (action2) {
						if (action2 === 'givevp') {
							twilight_self.addMove('vp\tussr\t2');
							twilight_self.endTurn();
						...
						if (action2 === 'discard') {
							let user_message = `${twilight_self.cardToText(
								card
							...
							for (
								...
								if (
									twilight_self.game.deck[0].cards[
										twilight_self.game.deck[0].hand[i]
									].ops >= 2 &&
									twilight_self.game.deck[0].cards[
										twilight_self.game.deck[0].hand[i]
									].player === 'us'
							...
							twilight_self.hud.attachControlCallback(function (
								action2
							) {
								if (
									twilight_self.game.deck[0].hand.includes(
										action2
									)
								) {
									try {
		...
		if (card == 'fallofsaigon') {
			...
			if (me == player) {
				...
				twilight_self.updateStatus(
					'<div class="status-message" id="status-message">Select Country for Evacuation</div>'
				);

				for (var i in twilight_self.countries) {
					if (
						(twilight_self.countries[i].us > 0 && me === 'us') ||
						(twilight_self.countries[i].ussr > 0 && me === 'ussr')
					) {
						let divname = '#' + i;
						$(divname).off();
						$(divname).on('click', function () {
							...
							if (me === 'us') {
								influence_to_remove =
									twilight_self.game.countries[c].us;
							}
							if (me === 'ussr') {
								influence_to_remove =
									twilight_self.game.countries[c].ussr;
							}

							let neighbours =
								twilight_self.game.countries[c].neighbours;
							...
							twilight_self.addMove(
								`remove\t${player}\t${me}\t${c}\t${influence_to_remove}`
							);

							twilight_self.updateStatus(
								'<div class="status-message" id="status-message">Select Country to Place</div>'
							);
							...
							for (var i in twilight_self.countries) {
								if (neighbours.includes(i)) {
									...
									$(divname).on('click', function () {
										...
										twilight_self.addMove(
											`place\t${player}\t${player}\t${c}\t${max_influence_to_add}`
										);
										twilight_self.placeInfluence(
											c,
											max_influence_to_add,
		...
		if (card == 'fischerspassky') {
			...
			this.updateStatusWithOptions(
				'Fischer-Spassky triggered. Designate region to downgrade Control and Dominance:',
				html,
				function (action2) {
					twilight_self.addMove('resolve\tfischerspassky');
					twilight_self.addMove(
						`SETVAR\tstate\tevents\tfischerspassky\t${action2}`
					);
					twilight_self.addMove(
						'NOTIFY\tFischer-Spassky is evented targetting ' +
							action2
					);
					twilight_self.endTurn();
				}
...
*/
		...
		if (card == 'iranianultimatum') {
			...
			this.displayBoard();
			this.updateLog(
				`${this.cardToText(card)}: 2 US influence added to Iran`
			);
			...
			if (this.game.player == 2) {
				...
				this.updateStatus(
					'Remove 1 USSR influence from the Middle East'
				);
		...
		if (card == 'khruschevthaw') {
			...
			if (this.game.player == 2) {
				...
				twilight_self.updateStatus(
					'Add 3 influence to 3 non-battleground countries in Eastern Europe'
				);
		...
		if (card == 'kissinger') {
			...
			let user_message =
				'Designate a region to turn all 1-stability countries into battleground countries:';
			let html = `<ul>";
                  <li class="option" id="asia">Asia</li>
                  <li class="option" id="europe">Europe</li>
                  <li class="option" id="africa">Africa</li>
			...
			this.updateStatusWithOptions(
				...
				function (action2) {
					...
					if (action2 == 'camerica') {
						selreg = 'Central America';
					}
					if (action2 == 'samerica') {
						selreg = 'South America';
					}
					if (action2 == 'mideast') {
						selreg = 'Middle East';
					}
					...
					twilight_self.addMove(
						`SETVAR\tstate\tevents\tkissinger\t${action2}`
					);

					for (let i in twilight_self.countries) {
						if (
							twilight_self.countries[i].region.indexOf(
								action2
							) != -1 &&
							twilight_self.countries[i].control == 1
						) {
							twilight_self.addMove(
								'SETVAR\tcountries\t' + i + '\tbg\t' + 1
							);
							twilight_self.addMove(
								'notify\t' +
									twilight_self.countries[i].name +
									' is now a battleground country'
							);
						}
					}
		...
		if (card == 'nixonshock') {
			...
			if (twilight_self.game.player == 2) {
				...
				twilight_self.updateStatusWithOptions(
					`${twilight_self.cardToText(card)}: `,
					'<ul><li class="option" id="draw">Drawl Additional Card from Deck</li><li class="option" id="skip">Skip</li></ul>',
					function (action2) {
						if (action2 === 'skip') {
							twilight_self.endTurn();
							return 0;
						...
						//
						twilight_self.addMove(
							'nixon_shock_play_card_or_hand_to_opponent\t2\t' +
								player
						);
		...
		if (card == 'revolutionsof1989') {
			...
			if (this.game.player == 2) {
				...
				this.updateStatusWithOptions(
					`${this.cardToText(
						card
					)}: do you want to trigger Final Scoring?`,
					choicehtml,
					function (action2) {
						if (action2 == 'endgame') {
			...
			if (this.game.player == 1) {
				...
				for (let i = 0; i < this.game.deck[0].hand.length; i++) {
					...
					if (
						...
						if (
							card_in_hand != 'asia' &&
							card_in_hand != 'mideast' &&
							card_in_hand != 'europe' &&
							card_in_hand != 'africa' &&
							card_in_hand != 'seasia' &&
							card_in_hand != 'camerica' &&
							card_in_hand != 'samerica'
						) {
							let mod_ops = this.modifyOps(
								3,
								'samotlor',
								'ussr',
								0
							...
							if (
								(myspacerace < 4 && mod_ops > 1) ||
								(myspacerace < 7 && mod_ops > 2) ||
								mod_ops > 3
							) {
								// cards we can space
							} else {
				...
				if (cardList.length == 0) {
					...
					twilight_self.addMove(
						'notify\tUSSR has no cards available to discard'
					);
					twilight_self.endTurn();
					return;
				}
				...
				twilight_self.hud.attachControlCallback(function (action2) {
					if (action2 == 'finished') {
						...
						twilight_self.addMove(
							'DEAL\t1\t1\t' + cards_to_deal_before_reshuffle
						);
						twilight_self.endTurn();
					} else {
						if (this.game.deck[0].hand.includes(action2)) {
		...
		if (card == 'sudan') {
			...
			let die = twilight_self.rollDice(6);
			twilight_self.game.queue.push(
				'NOTIFY\t' +
					player.toUpperCase() +
					` rolls: ${die}, adjusted: ${die - modifications}`
			);
			...
			if (die >= target + modifications) {
				...
				twilight_self.game.queue.push(
					'notify\tSudan is permanently a battleground country'
				);
				twilight_self.game.queue.push(
					`war\t${card}\t${winner}\t${die}\t${modifications}\t${player}\t${success}`
				);
		...
		if (card == 'tsarbomba') {
			...
			this.updateVictoryPoints();
			this.updateLog(
				`USSR gains 1 VP from ${this.cardToText('tsarbomba')}`
			);
		...
		if (card == 'unitedfruit') {
			...
			if (ussrtroops == 0) {
				this.updateLog(
					'USSR has no influence in Central or South America'
				);
				return 1;
			}
			...
			if (this.game.player == 2) {
				...
				this.updateStatus(
					'Remove 1 USSR influence from Central or South America'
				);
		...
		if (card == 'berlinagreement') {
			...
			for (var i in twilight_self.countries) {
				...
				if (this.countries[countryname].region == 'europe') {
					if (
						this.countries[countryname].us >
						this.countries[countryname].ussr
					) {
						us_predominates = 1;
					}
					if (
					...
					if (player == 'us' && us_predominates == 1) {
						placeable.push(countryname);
					}
					if (player == 'ussr' && ussr_predominates == 1) {
						placeable.push(countryname);
					}
				}
			}
			...
			if (placeable.length == 0) {
				...
				if (player == opponent) {
					this.updateStatus(
						'Opponent is placing 1 influence in a European country in which they have a predominance of influence'
					);
					return 0;
				}
				...
				this.updateStatus(
					'Place 1 influence in a European country in which you have a predominance of influence'
				);
		...
		if (card == 'culturaldiplomacy') {
			...
			if (
				...
				this.updateStatus(
					'Place one influence two hops away from a country in which you have existing influence. You cannot break control with this influence.'
				);
				...
				for (var i in this.countries) {
					...
					$(divname).on('click', function () {
						...
						let neighbours =
							twilight_self.countries[selected_countryname]
								.neighbours;
						for (let z = 0; z < neighbours.length; z++) {
							let this_country =
								twilight_self.countries[selected_countryname]
									.neighbours[z];
							let neighbours2 =
								twilight_self.countries[this_country]
									.neighbours;
							...
							for (let zz = 0; zz < neighbours2.length; zz++) {
								...
								if (player == 'us') {
									if (
										twilight_self.countries[two_hopper].us >
										0
									) {
										is_this_two_hops = 1;
									}
								...
								if (player == 'ussr') {
									if (
										twilight_self.countries[two_hopper]
											.ussr > 0
									) {
										is_this_two_hops = 1;
									}
		...
		if (card == 'poliovaccine') {
			let my_go = 0;
			if (player == 'ussr' && this.game.player == 1) {
				my_go = 1;
			}
			if (player == 'us' && this.game.player == 2) {
				my_go = 1;
			}
			...
			if (my_go == 1) {
				...
				if (cards_to_discard == 0) {
					twilight_self.addMove(
						'notify\tPlayer has no cards available to discard'
					);
					twilight_self.endTurn();
					return 0;
				}
				...
				html +=
					'<li class="option dashed nocard" id="finished">finished</li></ul>';
				...
				twilight_self.updateStatusWithOptions(
					...
					function (card) {
						...
						if (action2 == 'finished' || cards_discarded == 3) {
							...
							if (this.game.player == 1) {
								twilight_self.addMove(
									'DEAL\t1\t1\t' + cards_discarded
								);
							}
							if (this.game.player == 2) {
								twilight_self.addMove(
									'DEAL\t1\t2\t' + cards_discarded
								);
							}
							...
							if (
								...
								if (Object.keys(discarded_cards).length > 0) {
									...
									twilight_self.updateLog(
										'cards remaining: ' +
											twilight_self.game.deck[0].crypt
												.length
									);
									twilight_self.updateLog(
										'Shuffling discarded cards back into the deck...'
		...
		if (card == 'breakthroughatlopnor') {
			...
			for (var i in this.countries) {
				if (this.countries[i].us > 0) {
					ops_removable += this.countries[i].us;
				}
			}
			if (ops_to_purge > ops_removable) {
				ops_to_purge = ops_removable;
			...
			if (this.game.player == 1) {
				this.updateStatus(
					'Remove 3 US influence from Southeast Asia or North Korea (max 2 per country)'
				);
		...
		if (card == 'eurocommunism') {
			if (this.game.player == 1) {
				this.updateStatus(
					'Eurocommunism: US is removing 4 USSR influence from Western Europe (max 2 per country)'
				);
				return 0;
			}
			if (this.game.player == 2) {
				this.updateStatus(
					'Remove 4 USSR influence from Western Europe (max 2 per country)'
				);
				...
				for (var i in this.countries) {
					if (
						...
						if (twilight_self.countries[i].ussr == 1) {
							available_targets += 1;
						}
						if (twilight_self.countries[i].ussr > 1) {
							available_targets += 2;
				...
				if (available_targets == 0) {
					this.addMove(
						'notify\tUSSR has no influence in Western Europe to remove'
					);
					this.endTurn();
					return 0;
				}
				if (available_targets < 4) {
					...
					this.updateStatus(
						'Remove ' +
							ops_to_purge +
							' USSR influence from Western Europe (max 2 per country)'
					);
				}
    ...
    */
		...
		if (card == 'inftreaty') {
			...
			this.addMove(
				'notify\t' +
					player +
					' plays 3 OPS for influence or realignments'
			);
			this.endTurn();
			...
			if (player != me) {
				...
				for (let i = 0; i < this.game.deck[0].hand.length; i++) {
					if (
						...
						eligible_cards.push(this.game.deck[0].hand[i]);
					}
					if (
						me === 'us' &&
						this.game.deck[0].cards[this.game.deck[0].hand[i]]
				...
				if (eligible_cards.length == 0) {
					...
					this.addMove(
						'notify\t' +
							player.toUpperCase() +
							' has no valid cards for Nation Building'
					);
					this.endTurn();
					return 0;
				}
				...
				this.updateStatus(
					'Select any country in Africa, Central America or South America that is not controlled by the opposing player and in which you have at least 1 influence:'
				);
				for (var i in this.countries) {
					let divname = '#' + i;
					let is_eligible = 0;
					...
					if (is_eligible == 1) {
						...
						$(divname).on('click', function () {
							...
							let html =
								'Discard one of the following cards to increase the stability of this country by 1 and add 1 influence: ';
							twilight_self.updateStatusAndListCards(
								html,
								eligible_cards
							);
								...
								twilight_self.placeInfluence(
									...
									function () {
										...
										twilight_self.addMove(
											'notify\t' +
												player.toUpperCase() +
												' discards <span class="showcard" id="' +
												card +
												'">' +
												twilight_self.game.deck[0]
													.cards[card].name +
												'</span>'
										);
										twilight_self.endTurn(1);
				...
				if (eligible_countries == 0) {
					...
					this.addMove(
						'notify\t' +
							player.toUpperCase() +
							' has no eligible countries for Nation Building'
					);
					this.endTurn();
					return 0;
				}
		...
		if (card == 'communistrevolution') {
			...
			if (me == 'ussr') {
				...
				twilight_self.updateStatus(
					'<div class="status-message" id="status-message">Pick target for Communist Revolution</div>'
				);
				...
				for (var i in twilight_self.countries) {
					...
					$(divname).on('click', function () {
						...
						twilight_self.addMove(
							'SETVAR\tstate\tlimit_ignoredefcon\t' + 0
						);
						twilight_self.addMove(
							'SETVAR\tstate\tlower_defcon_on_coup\t' + 1
						);
						twilight_self.addMove(
							'coup\tussr\t' +
								c +
								'\t' +
								twilight_self.modifyOps(2)
						);
						twilight_self.addMove(
							'SETVAR\tstate\tlower_defcon_on_coup\t' + 0
						);
						twilight_self.addMove(
							'SETVAR\tstate\tlimit_ignoredefcon\t' + 1
						);
						twilight_self.addMove(
							'SETVAR\tcountries\t' +
								c +
		...
		if (card == 'philadelphia') {
			...
			if (me == 'us') {
				...
				twilight_self.updateStatus(
					'<div class="status-message" id="status-message">Pick country to remove all US influence:</div>'
				);
				...
				for (var i in twilight_self.countries) {
					...
					$(divname).on('click', function () {
						...
						if (us_influence <= 0) {
							alert(
								'Invalid Choice - country must have US influence'
							);
							return;
						}
						...
						twilight_self.updateStatus(
							'<div class="status-message" id="status-message">Place ' +
								us_influence +
								' in any country not controlled by the USSR:</div>'
						);
						for (var i in twilight_self.countries) {
		...
		if (card == 'sinoindian') {
			...
			if (twilight_self.whoHasTheChinaCard() != player) {
				twilight_self.updateLog(
					'Sino-Indian War cannot trigger, as player does not have the China Card'
				);
				return 1;
			}
			...
			if (me == player) {
				...
				if (twilight_self.isControlled(opponent, 'pakistan') == 1) {
					target++;
				}
				if (twilight_self.isControlled(opponent, 'burma') == 1) {
					target++;
				}
				...
				let die = twilight_self.rollDice(6);
				twilight_self.addMove(
					'notify\t' + player.toUpperCase() + ' rolls ' + die
				);
				...
				if (die >= target) {
					if (player == 'us') {
						twilight_self.addMove(
							'place\tus\tus\tindia\t' +
								twilight_self.countries['india'].ussr
						);
						twilight_self.addMove(
							'remove\tus\tussr\tindia\t' +
								twilight_self.countries['india'].ussr
						);
						twilight_self.addMove('milops\tus\t2');
						...
						twilight_self.addMove(
							'place\tussr\tussr\tindia\t' +
								twilight_self.countries['india'].us
						);
						twilight_self.addMove(
							'remove\tussr\tus\tindia\t' +
								twilight_self.countries['india'].us
						);
						twilight_self.addMove('milops\tussr\t2');
		...
		if (card == 'sovietcoup') {
			...
			if (1) {
				...
				twilight_self.updateStatusWithOptions(
					'Sacrifice any VP before rolling for +1 modifier:',
					'<ul><li class="option" id="zero">0 VP</li><li class="option" id="one">1 VP</li><li class="option" id="two">2 VP</li><li class="option" id="three">3 VP</li></ul>',
					function (action) {
						let modifier = 0;
						...
						if (modifier > 0) {
							twilight_self.addMove('vp\tus\t' + modifier);
						}
						...
						if (roll < 4) {
							...
							twilight_self.addMove(
								'NOTIFY\tUSSR rolls ' +
									roll +
									' for Soviet Coup and loses the game.'
							);
							twilight_self.endTurn();
							return;
						}
						...
						this.updateStatus(
							'Place eight influence in non-US controlled countries:'
						);
				...
				twilight_self.updateLog(
					'Conditions for Soviet Coup are not met...'
				);
				return 1;
			}
