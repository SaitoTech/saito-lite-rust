  ...
  initializeGame(game_id) {
    ...
    try {
      ...
      $('.scoring_card').mouseover(function() {
        ...
        if (total_vp > (twilight_self.game.vp_needed) || total_vp < (twilight_self.game.vp_needed * -1)) {
          total_vp = "WIN"
        }
        ...
        if (action2 == "realign") {
          ...
          $(".country").on('click', async function() {
            ...
            if (failureReason.length > 0) {
              ...
              if (twilight_self.countries[c].region !== "seasia" && twilight_self.countries[c].region !== "asia") {
  ...
  */
    ...
    if (player == "ussr") {
      ...
      for (var i in this.game.countries) {
        if (this.game.countries[i].ussr > 0) {
          ...
          //
          if (this.game.state.ironlady_before_ops == 1 && this.game.countries['chile'].ussr < 1 && this.game.countries['uruguay'].ussr < 1 && this.game.countries['paraguay'].ussr < 1 && this.game.countries['argentina'].ussr == 1 && i === "argentina") {
            place_in_country = 0;
          }
  ...
  isSpaceRaceAvailable(ops) {
    ...
    if (this.game.player == 1 && this.game.state.space_race_ussr_counter >= 1) {
      if (this.game.state.animal_in_space == "ussr" && this.game.state.space_race_ussr_counter < 2) {
      } else {
        sre = 0;
      }
    }
...
//      this.game.state.back_button_cancelled = 1;
    ...
    if (card == "terrorism") {
      ...
      if (target == this.playerRoles[this.game.player]) {
        ...
        for (let z = 0; z < this.game.deck[0].hand.length; z++) {
          if (this.game.deck[0].hand[z] === "china" || this.game.deck[0].hand[z] == this.game.state.headline_opponent_card || this.game.deck[0].hand[z] == this.game.state.headline_card) {
          } else {
        ...
        if (cards_to_discard == 0) {
          this.addMove(`NOTIFY\t${this.cardToText(card)}: ${target.toUpperCase()} has no cards to discard`);
        }
    ...
    */
    ...
    if (card == "nationbuilding") {
      ...
      if (player != me) {
        ...
        for (let i = 0; i < this.game.deck[0].hand.length; i++) {
          if (me === "ussr" && this.game.deck[0].cards[this.game.deck[0].hand[i]].player === "ussr") {
