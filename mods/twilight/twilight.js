...
<<<<<<< HEAD
            ...
            this.updateStatusHeader(
              `${this.cardToText("aldrichames")}: USSR choosing card to discard`
            );
          }
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
        ...
        //
        await this.settleVPOutstanding();
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
  ...
  async playHeadlinePostModern(stage, hash = "", xor = "", card = "") {
    if (this.game.player === 0) {
      ...
      if (this.game.player == 1) {
        if (this.game.state.events.missile_envy == 1) {
          ...
          if (scoring_cards_available > moves_remaining) {
            await this.playerTurn("scoringcard");
          } else {
            //
            ...
            if (
              ...
              await this.playerTurn("missileenvy");
            }
          }
        } else {
          await this.playerTurn();
...
<<<<<<< HEAD
          twilight_self.attachCardboxEvents(async function (action2) {
            if (action2 === "select") {
              twilight_self.updateStatusHeader();
              await twilight_self.playerTurn();
=======
          this.updateStatusWithOptions(user_message, html, function (action2) {
            if (action2 === "select") {
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
            ...
            if (action2 === "scoring" || action2 === "scoring_w_card") {
              ...
              await twilight_self.playerTurn("greatsociety");
            }
          });
  ...
  async playerTurn(selected_card = null) {
    if (this.browser_active == 0) {
      return;
    }
...
<<<<<<< HEAD
            ...
            this.updateStatusWithOptions(user_message, html, false);
            this.attachCardboxEvents(async function (action) {
=======
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
              if (action === "play") {
                await twilight_self.playerTurn("china"); //reload function, ignoring this logic tree
              }
              if (action === "skipturn") {
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
        ...
        await twilight_self.playerTriggerEvent(player, card);
        return;
      }
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
        ...
        // play normally when not confirmed
        await twilight_self.playerTriggerOps(player, card);
        return;
      }
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
              ...
              if (alignment_rolls <= 0) {
                if (twilight_self.isRegionBonus(card) == 1) {
                  ...
                  await twilight_self.reverseMoves("realign");
                }
              }
            }
          });
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
  ...
  */
  async cancelCubanMissileCrisis() {
    let twilight_self = this;
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
    ...
    for (let i = twilight_self.game.queue.length - 1; i >= 0; i--) {
      ...
      if (tmpar[0] === "play") {
        await twilight_self.displayBoard();
        return 1;
      } else {
  ...
  async playerTriggerOps(player, card) {
    let twilight_self = this;
    if (this.game.player == 0) {
      return;
    } //just in case
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
  ...
  async playerTriggerEvent(player, card) {
    let twilight_self = this;
  ...
  playerPlaceInitialInfluence() {
    ...
    try {
      ...
      if (this.game.player == 1) {
        ...
        $(".easterneurope").off();
        $(".easterneurope").on("click", async function () {
          let countryname = $(this).attr("id");
        ...
        $(".westerneurope").off();
        $(".westerneurope").on("click", async function () {
          let countryname = $(this).attr("id");
        ...
        if (this.game.deck[0].hand[i] != "china") {
          if (this.game.deck[0].cards[this.game.deck[0].hand[i]]?.scoring == 1) {
            ...
            if (this.game.options.deck != "late-war" && this.game.state.round != 8) {
              ...
              await this.resignGame(this.game.id, "scoring card held");
              return 0;
            }
          }
        }
  ...
  async lowerDefcon() {
    ...
    if (this.game.state.defcon <= 1) {
      if (this.game.state.headline == 1) {
        ...
        await this.endGame(this.game.players[2 - this.game.state.turn], "thermonuclear war");
      }
    }
  }
...
<<<<<<< HEAD
          await this.endTurn();
          this.updateStatusHeader(`USSR is placing influence for ${this.cardToText(card)}`);
=======
          this.endTurn();
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
            ...
            await twilight_self.displayModal("you already place one there...");
          }
        });
      }
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
    ...
    if (card == "decolonization") {
      if (this.game.player == 1) {
        ...
        $(".easterneurope").off();
        $(".easterneurope").on("click", async function (e) {
          let countryname = $(this).attr("id");
          if (twilight_self.countries[countryname].place == 1) {
            twilight_self.addMove("place\tussr\tussr\t" + countryname + "\t1");
            twilight_self.placeInfluence(countryname, 1, "ussr");
            ...
            await twilight_self.displayModal("you already placed there...");
          }
        });
      }
      return 0;
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
          ...
          $(".westerneurope").on("click", async function () {
            ...
            if (twilight_self.countries[c].place != 1) {
              await twilight_self.displayModal("Invalid Option");
            } else {
    ...
    if (card == "fiveyearplan") {
      ...
      if (this.game.player == 1) {
        ...
        if (available_cards.length == 0) {
          ...
          await twilight_self.displayModal("No cards left to discard");
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
        ...
        $(".easterneurope").on("click", async function () {
          ...
          if (twilight_self.countries[c].place != 1 || twilight_self.countries[c].us == 0) {
            await twilight_self.displayModal("Invalid Country");
          } else {
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
    ...
    if (card == "nato") {
      if (this.game.state.events.marshall == 1 || this.game.state.events.warsawpact == 1) {
        ...
        await this.displayModal("NATO in effect");
      } else {
        this.updateLog(
    ...
    if (card == "onesmallstep") {
      if (player == "us") {
        if (this.game.state.space_race_us < this.game.state.space_race_ussr) {
          ...
          await this.advanceSpaceRace("us", true);
          await this.advanceSpaceRace("us");
        }
      } else {
        if (this.game.state.space_race_ussr < this.game.state.space_race_us) {
          this.updateLog("USSR takes one small step into space...");
          await this.advanceSpaceRace("ussr", true);
          await this.advanceSpaceRace("ussr");
        }
      }
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
        ...
        $(".easterneurope").on("click", async function () {
          ...
          if (twilight_self.countries[c].us > 0) {
            ...
            await twilight_self.displayModal("Invalid Target", "No US influence to coup");
          }
        });
      }
      return 0;
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
          ...
          for (let m = 0; m < options_purge.length; m++) {
            ...
            $(divname).on("click", async function () {
              ...
              if (options_purged[c] >= 2) {
                ...
                if (ops_to_purge == 0) {
                  twilight_self.playerFinishedPlacingInfluence();
                  await twilight_self.displayModal("All Influence Removed");
                  await twilight_self.endTurn();
                }
              }
            });
    ...
    if (card == "summit") {
      ...
      if (us_roll === ussr_roll) {
        ...
        await this.displayModal(`${this.cardToText(card)}: no winner`);
        return 1;
      } else {
        //
        // winner
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
          ...
          if (action2 == "remove") {
            ...
            if (options_purge == 0) {
              ...
              $(".easterneurope").on("click", async function () {
                ...
                if (twilight_self.countries[c].place != 1) {
                  await twilight_self.displayModal("Invalid Option", "No US influence to remove");
                } else {
                  twilight_self.countries[c].place = 0;
          ...
          if (action2 == "add") {
            ...
            $(".easterneurope").on("click", async function () {
              ...
              if (twilight_self.countries[c].place != 1) {
                await twilight_self.displayModal("Invalid Placement");
              } else {
                ops_placed[c]++;
                ops_to_place--;
                twilight_self.placeInfluence(c, 1, "ussr");
    ...
    if (card == "wwby") {
      ...
      await this.lowerDefcon(); //Checks for end game
      this.updateDefcon();
...
=======
        this.updateStatus("Place one influence two hops away from a country in which you have existing influence. You cannot break control with this influence.");
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
...
>>>>>>> d78b646660d92a43b6b603e94e8e9f5ce5b2f4b0
      ...
      if (this.game.player == 2) {
<<<<<<< HEAD
        this.updateStatusHeader("Remove 4 USSR influence from Western Europe (max 2 per country)");
=======
