...
const TwilightGameRulesTemplate = require("./lib/twilight-game-rules.template");
const TwilightGameOptionsTemplate = require("./lib/twilight-game-options.template");
const TwilightSingularGameOptionsTemplate = require("./lib/twilight-singular-game-options.template");
