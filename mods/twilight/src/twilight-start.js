...
playerTurnHeadlineSelected(card, player) {
  ...
  */
  ...
  returnGameRulesHTML(){
    ...
    <h4>The Objective</h4>
    The objective of the game is to score the most by end of the game and/or be the first one to accumulate 20 victory points against your opponent
    <h4>The Play</h4>
    ...
    <li>INFLUENCE</dt><dd>Influence markers are placed on countries with friendly influence or their immediate neighbors. It costs 1 OP to place influence in a friendly or uncontrolled country, and 2 OP to place influence in an enemy controlled country. To control a country, your influence must exceed your opponent's by at least the STABILITY number of the country.</li>
    <li>REALIGNMENT</dt><dd>Realignment rolls reduce enemy influence in a country regardless of whether the player has any influence in the country or its neighbors. It costs 1 OP per roll. Both players roll and the high roller can remove the difference in die values of influence in the target country. Players get +1 if the target country borders their SUPERPOWER, +1 if they have more influence in the target country, and +1 for each adjacent controlled country.</li>
    <li>COUP</dt><dd>A Coup is an attempt to replace the enemy's influence in a target country with that of your own. Roll the dice and add the OP of the card and subtract double the STABILITY number of the country. The result, if positive, is a successful coup and the player may first remove that many enemy influence then add any remaining amount of friendly influence.</li>
    <li>SPACE RACE</dt><dd>Players gain victory points and special abilities for advancing in the SPACE RACE. A player may only attempt to advance in the SPACE RACE once per turn and success depends upon a dice roll. The player must DISCARD a card with a minimum OPERATIONS values. Unlike other actions, the EVENT of the discarded card does not get triggered.</li>
    </ul>
    <h4>DEFCON STATUS</h4>
    ...
    <h4>References</h4>
    <p>1. <a href="https://www.youtube.com/watch?v=TGVxl732psk" target="_blank">Video Tutorial</a></p>
    </div>`;
  }
