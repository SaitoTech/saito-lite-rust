...
class Midnight extends GameTemplate {
  ...
  initializeHTML(app){
      ...
      this.menu.addSubMenuOption("game-game", {
          ...
          callback: function (app, game_mod) {
              game_mod.queue = [];
              game_mod.game.queue.push("page\t1");
              game_mod.game.state = game_mod.returnState();
              game_mod.endTurn();
          }
      });
      this.menu.addSubMenuOption("game-game", {
          ...
          callback: function (app, game_mod) {
              game_mod.queue = [];
              game_mod.game.queue.push(`page\t${game_mod.game.state.lastpage}`);
              game_mod.endTurn();
          }
      });
  ...
  showPage(page) {
    ...
    if (this.book[page].choices) {
      if (this.book[page].choices.length > 0) {
        html += `<ul class="choicelist">`;
        for (let i = 0; i < this.book[page].choices.length; i++) {
          html += `<li class="textchoice" id="${i}">${this.book[page].choices[i].option}</li>`;
        }
        html += "</ul>";
      }
    }
    ...
    this.updateStatus(`<div class="story">${this.book[page].text}</div>${html}`);

    $(".textchoice").off();
    $(".textchoice").on("click", function () {
      let action = $(this).attr("id");
      midnight_self.game.state.lastpage = page;
      midnight_self.addMove(midnight_self.book[page].choices[action].command);
      midnight_self.endTurn();
    });
  }


  /* Function stub, no defined combat in the game*/
  ...
  /*
The rest of the file is the definition of the interactive book
*/
  ...
  returnBook() {
    ...
    book["114"] = {
      ...
      choices: [
        {
          option:
            "Fight the Ogre substracting 2 from your Attack Strenght because of the darkness.",
          command: "page\t328",
        },
      ],
    };
    ...
    book["157"] = {
      ...
      choices: [
        ...
        {
          option:
            "You do not have the skill, If dice result is equal to your SKILL score or less then you succeed",
          command: "page\t324",
        },
      ],
    };
    ...
    book["195"] = {
      ...
      choices: [
        ...
        {
          option:
            "You decide to pay for information, result of the die is equal to or less than the number of gold pieces you offer",
          command: "page\t66",
        },
      ],
    };
    ...
    book["201"] = {
      ...
      choices: [
        ...
        {
          option:
            "You leave the house and ry to find the Eye of the Basilisk, if you think you have enough information",
          command: "page\t144",
        },
        {
          option:
    ...
    book["225"] = {
      ...
      choices: [
        ...
        {
          option:
            "Gargoyle wins, lose 2 STAMINA points and roll two dice, if the result is equal to your SKILL score or less",
          command: "page\t365",
        },
        {
    ...
    book["245"] = {
      ...
      choices: [
        {
          option:
            "If the die result is equal to your SKILL score or less, you manage to break down the door",
          command: "page\t186",
        },
        {
    ...
    book["249"] = {
      ...
      choices: [
        {
          option:
            "You fight your own shadow (subtract 3 SKILL points if you have no other weapon to fight with.)",
          command: "page\t11",
        },
        {
    ...
    book["266"] = {
      ...
      choices: [
        {
          option:
            "The result is less or equal to your SKILL score, you dodge his first blow. Continue the combat.",
          command: "page\t131",
        },
        {
          option:
            "The result is higher than your Skill score, the guard's attack takes you by surprise - lose 2 STAMINA points and continue the combat",
          command: "page\t131",
        },
      ],
    };
    ...
    book["267"] = {
      ...
      choices: [
        ...
        {
          option:
            "You do not have the skill, so roll two dice. If the result is equal to your SKILL score or less, you manage to climb out",
          command: "page\t240",
        },
        {
          option:
            "You climb part of the way out, but fall back in against, losing 1 STAMINA point in the process; try again, and keep on trying until either you get out of the pit or die in the attempt.",
          command: "page\t268",
        },
      ],
    };
    ...
    book["271"] = {
      ...
      choices: [
        ...
        {
          option:
            "You have CLIMB skill (there’s no time to use a rope and grapnel, even if you have one), you try to climb to safety ",
          command: "page\t72",
        },
      ],
    };
    ...
    book["278"] = {
      ...
      choices: [
        ...
        {
          option:
            "You still want to play, roll two dice. If the result is less than or equal to your SKILL score",
          command: "page\t14",
        },
        {
    ...
    book["283"] = {
      ...
      choices: [
        {
          option:
            "You give them one of these items, cross it off your Adventure Sheet and leave the tavern (Choose another option)",
          command: "page\t203",
        },
        {
    ...
    book["304"] = {
      ...
      choices: [
        {
          option:
            "You win the first round of combat, but you have not wounded the Giant Spider, merely fended off its attack. After this round, fight it normally. You kill the spider without losing any rounds",
          command: "page\t353",
        },
        {
    ...
    book["308"] = {
      ...
      choices: [
        ...
        {
          option:
            "If you want a clue, spend 2 LUCK points – don’t forget to adjust the score on your Adventure Sheet",
          command: "page\t338",
        },
      ],
    };
    ...
    book["317"] = {
      ...
      choices: [
        {
          option:
            "The result is equal to your skill score or less, you lift the portcullis and escape",
          command: "page\t152",
        },
      ],
    };
    ...
    book["323"] = {
      ...
      choices: [
        {
          option:
            "You drink the potion. Record anything you take on your Adventure Sheet; only the wire counts as a backpack item.",
          command: "page\t247",
        },
        {
    ...
    book["327"] = {
      ...
      choices: [
        {
          option:
            "The number rolled is equal to or less than the number of gold pieces you offered, Don’t forget to cross the money off your Adventure sheet",
          command: "page\t44",
        },
        {
          option:
            "The number rolled is higher than the number of gold pieces you offered, Don’t forget to cross the money off your Adventure sheet",
          command: "page\t268",
        },
      ],
    };
    ...
    book["338"] = {
      ...
      choices: [
        ...
        {
          option:
            "You do not have the skill, so you will have to try to break open the chest. Roll two dice. The result is equal to your skill score or less",
          command: "page\t118",
        },
        {
          option: "The result is more than your skill score",
    ...
    book["349"] = {
      ...
      choices: [
        ...
        {
          option:
            "You do not have the skill, so there is nothing for it but to wait until someone finds you and face the music. You have failed your test, and your adventure ends here.",
          command: "page\t1",
        },
      ],
    };
    ...
    book["377"] = {
      ...
      choices: [
        ...
        {
          option:
            "You don’t have PICK LOCK skill, you cant open the door, and you will have to confine your attention to the desk",
          command: "page\t90",
        },
        {
          option:
    ...
    book["380"] = {
      ...
      choices: [
        {
          option:
            "You are Lucky, you lose 4 STAMINA points. If you are still alive, go back and try again to take the gem",
          command: "page\t87",
        },
      ],
    };
    ...
    book["391"] = {
      ...
      choices: [
        {
          option:
            "The result is equal to or less than your SKILL score, you manage to evade the guards and escape. (Turn back and try somewhere else)",
          command: "page\t144",
        },
        {
          option: "Result is more than your SKILL score",
    ...
    book["397"] = {
      ...
      choices: [
        ...
        {
          option:
            "You want a clue, spend 2 LUCK points – don’t forget to adjust the score on your Adventure Sheet",
          command: "page\t338",
        },
      ],
    };
