...
class AssaultOverlay {
    ...
    renderPostAssault(res={}) {
      ...
      this.updateInstructions("Assault over in " + this.mod.game.spaces[res.spacekey].name);
    }
    ...
    renderAssault(res={}) {
      ...
      obj.style.backgroundImage = "url(/his/img/backgrounds/siege.png)";
      obj.style.backgroundSize = "cover";
      this.updateInstructions("Assault in " + this.mod.game.spaces[res.spacekey].name);
    }
    ...
    renderPreAssault(res={}) {
      ...
      obj.style.backgroundImage = "url(/his/img/backgrounds/siege.png)";
      obj.style.backgroundSize = "cover";
      this.updateInstructions("Assault imminent in " + this.mod.game.spaces[res.spacekey].name);
    }
...
alert("assign hits manually!");
      ...
      //
      document.querySelectorAll(`.siege-grid ${side} .siege-row`).forEach((el) => { 
	el.remove();
      });
	...
	if (can_i_kill_this_guy) {
	  ...
	  el.onclick = (e) => {
	    ...
	    this.mod.addMove("siege_destroy_unit\t" + faction + "\t" + spacekey + "\t" + unit_type);
