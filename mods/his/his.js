...
console.log("CARDS: " + JSON.stringify(this.game.deck[0].fhand));
	    if (this.game.deck[0].cards[this.game.deck[0].fhand[0][i]].type === "mandatory") {} else { x.push(this.game.deck[0].fhand[0][i]); }
          ...
          this.attachCardboxEvents(function(card) {
            ...
            let card_sig = game_self.app.crypto.signMessage(card, game_self.app.wallet.getPrivateKey());
            let hash2_sig = game_self.app.crypto.signMessage(hash2, game_self.app.wallet.getPrivateKey());
            let hash3_sig = game_self.app.crypto.signMessage(hash3, game_self.app.wallet.getPrivateKey());
