...
class HereIStand extends GameTemplate {
  constructor(app) {
    ...
    this.publisher_message =
      "Here I Stand is owned by GMT Games. This module is made available under an open source license provided by GMT Games that permits usage provided that at least one player per game has purchased a copy of the game.";
  ...
  initializeGame(game_id) {
    ...
    this.importDebater("luther-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, faction) {
        if (
          ...
          his_self.canPlayerCommitDebater("protestant", "luther-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (p === his_self.game.player) {
            if (
              his_self.game.state.players_info[player - 1].tmp_debaters_committed_reformation ==
                0 &&
              his_self.game.state.players_info[player - 1].tmp_debaters_committed_translation ==
                0 &&
    ...
    this.importDebater("melanchthon-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, faction) {
        if (
          menu == "translation_german_language_zone" &&
          his_self.canPlayerCommitDebater("protestant", "melanchthon-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (p === his_self.game.player) {
            if (
    ...
    this.importDebater("zwingli-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          ...
          his_self.canPlayerCommitDebater("protestant", "zwingli-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
    ...
    this.importDebater("bucer-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "bucer-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("oekolampadius-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "oekolampadius-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("bullinger-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, faction) {
        if (
          menu == "debate" &&
          his_self.canPlayerCommitDebater("protestant", "bullinger-debater")
        ) {
    ...
    this.importDebater("canisius-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          ...
          his_self.canPlayerCommitDebater("papacy", "canisius-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("papacy");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("contarini-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "catholic_counter_reformation" &&
          his_self.canPlayerCommitDebater("papacy", "contarini-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("papacy");
          if (p === his_self.game.player) {
    ...
    this.importDebater("faber-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          ...
          if (p === his_self.game.player) {
            if (
              ["augsburg", "trier", "cologne", "wittenberg", "mainz", "brandenburg"].includes(
                spacekey
              )
            ) {
              return 1;
    ...
    this.importDebater("farel-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "farel-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("olivetan-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, faction) {
        if (
          ...
          his_self.canPlayerCommitDebater("protestant", "olivetan-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (p === his_self.game.player) {
            if (
    ...
    this.importDebater("cranmer-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "cranmer-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("wishart-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "wishart-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("latimer-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "latimer-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("knox-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, spacekey) {
        if (
          menu == "protestant_reformation" &&
          his_self.canPlayerCommitDebater("protestant", "knox-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (
            p === his_self.game.player &&
    ...
    this.importDebater("tyndale-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, faction) {
        if (
          ...
          his_self.canPlayerCommitDebater("protestant", "tyndale-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (p === his_self.game.player) {
            if (
    ...
    this.importDebater("coverdale-debater", {
      ...
      menuOptionTriggers: function (his_self, menu, player, faction) {
        if (
          menu == "translation_english_language_zone" &&
          his_self.canPlayerCommitDebater("protestant", "coverdale-debater")
        ) {
          let p = his_self.returnPlayerOfFaction("protestant");
          if (p === his_self.game.player) {
            if (
      ...
      handleGameLoop: function (his_self, qe, mv) {
        if (mv[0] == "knights-of-saint-john") {
          ...
          if (player == his_self.game.player) {
            ...
            let card =
              his_self.game.deck[0].cards[
                his_self.game.deck[0].hand[his_self.game.deck[0].hand[fhand_idx].length - 1]
              ];
            let ops = card.ops;
      ...
      handleGameLoop: function (his_self, qe, mv) {
        if (mv[0] == "venetian_alliance_placement") {
          his_self.playerSelectSpaceWithFilter(
            ...
            function (space) {
              if (
                his_self.isSpaceControlled(space, "papacy") &&
      ...
      onEvent: function (his_self, faction) {
        ...
        if (his_self.game.player == p) {
          his_self.playerSelectSpaceWithFilter(
            ...
            function (space) {
              if (his_self.isSpaceControlled(space, "ottoman") && space.ports.length > 0) {
                return 1;
              }
              return 0;
            },
  ...
  returnDeck() {
    ...
    deck["002"] = {
      ...
      canEvent: function (his_self, faction) {
        if (his_self.isBesieged("charles-v")) {
          return 0;
        }
        if (his_self.isCaptured("charles-v")) {
          return 0;
        }
        return 1;
      },
      onEvent: function (his_self, faction) {
        ...
        his_self.playerSelectSpaceWithFilter(
          ...
          function (space) {
            if (space.home === "hapsburg" && !his_self.isSpaceControlled(space, "hapsburg")) {
              return 1;
            }
            return 0;
          },
            ...
            $(".option").on("click", function () {
              ...
              if (opt === "select") {
                ...
                $(".option").on("click", function () {
                  ...
                  his_self.addMove(
                    "SETVAR\tstate\ttheological_debate\tselected_papal_debater\t" +
                ...
                $(".option").on("click", function () {
                  ...
                  his_self.addMove("RESETCONFIRMSNEEDED\tall");
                  his_self.addMove(
                    "SETVAR\tstate\ttheological_debate\tprohibited_protestant_debater\t" +
    ...
    deck["007"] = {
      ...
      menuOptionActivated: function (his_self, menu, player, extra) {
        if (menu === "debate") {
          ...
          his_self.addMove(
            "NOTIFY\tHere I Stand played to substitute Luther into the Theological Debate"
          );
    ...
    deck["008"] = {
      ...
      onEvent: function (his_self, faction) {
        ...
        his_self.game.queue.push(
          "STATUS\tProtestants selecting reformation targets...\t" + JSON.stringify(players_to_go)
        );
      ...
      handleGameLoop: function (his_self, qe, mv) {
        if (mv[0] == "catholic_counter_reformation") {
          ...
          let target_spaces = his_self.countSpacesWithFilter(function (space) {
            if (
            ...
            if (target_spaces > 0) {
              his_self.playerSelectSpaceWithFilter(
                ...
                function (spacekey) {
                  ...
                  his_self.addMove(
                    "counter_or_acknowledge\tCounter-Reformation Attempt in " +
                      spacekey +
        ...
        if (player == his_self.game.player) {
          ...
          his_self.game.queue.push(
            "hand_to_fhand\t1\t" +
              player +
              "\t" +
              this.game.state.players_info[player - 1].factions[faction_hand_idx]
          );
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "field_battle") {
          ...
          return {
            faction: f,
            event: "arquebusiers",
            html: `<li class="option" id="arquebusiers">arquebusiers (${f})</li>`,
          };
        }
        return {};
      },
    ...
    deck["025"] = {
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "field_battle") {
          ...
          return {
            faction: f,
            event: "field_artillery",
            html: `<li class="option" id="field_artillery">field artillery (${f})</li>`,
          };
        }
        return {};
      },
    ...
    deck["026"] = {
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "field_battle") {
          ...
          return {
            faction: f,
            event: "mercenaries_bribed",
            html: `<li class="option" id="mercenaries_bribed">mercenaries bribed (${f})</li>`,
          };
        }
        return {};
      },
    ...
    deck["027"] = {
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "assault") {
          ...
          return {
            faction: f,
            event: "mercenaries_grow_restless",
            html: `<li class="option" id="mercenaries_grow_restless">mercenaries grow restless (${f})</li>`,
          };
        }
        return {};
      },
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "assault") {
          ...
          return {
            faction: f,
            event: "siege_mining",
            html: `<li class="option" id="siege_mining">siege mining (${f})</li>`,
          };
        }
        return {};
      },
    ...
    deck["029"] = {
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "assault") {
          ...
          return {
            faction: f,
            event: "surprise_attack",
            html: `<li class="option" id="surprise_attack">surprise attack (${f})</li>`,
          };
        }
        return {};
      },
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "field_battle") {
          ...
          return {
            faction: f,
            event: "tercois",
            html: `<li class="option" id="tercois">tercois (${f})</li>`,
          };
        }
        return {};
      },
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "move" || menu == "assault" || menu == "piracy") {
          ...
          return {
            faction: f,
            event: "foulweather",
            html: `<li class="option" id="foulweather">foul weather (${f})</li>`,
          };
        }
        return {};
      },
      ...
      menuOption: function (his_self, menu, player) {
        if (menu == "field_battle") {
          ...
          return {
            faction: f,
            event: "landsknechts",
            html: `<li class="option" id="landsknechts">landsknechts (${f})</li>`,
          };
        }
        return {};
      },
        ...
        if (menu == "field_battle") {
          if (faction == "ottoman" || faction == "france") {
            ...
            his_self.playerPlaceUnitsInSpaceWithFilter(
              ...
              faction,
              function (space) {
                if (!his_self.isSpaceUnderSeige(space.key)) {
                  return 0;
                }
                if (!his_self.returnFriendlyLandUnitsInSpace("france", space.key)) {
                  return 0;
                }
          ...
          if (faction === "hapsburg") {
            his_self.playerPlaceUnitsInSpaceWithFilter(
              ...
              function (space) {
                ...
                if (!his_self.returnFriendlyLandUnitsInSpace("hapsburg", space.key)) {
                  return 0;
                }
                if (!his_self.isSpaceFriendly(space.key)) {
                  return 1;
            ...
            if (faction === "ottoman") {
              ...
              his_self.playerPlaceUnitsInSpaceWithFilter(
                ...
                function (space) {
                  ...
                  if (!his_self.returnFriendlyLandUnitsInSpace(faction, space.key)) {
                    return 0;
                  }
                  if (!his_self.isSpaceFriendly(space.key)) {
                    return 1;
    ...
    deck["036"] = {
      ...
      menuOption: function (his_self, menu, player, extra) {
        if (menu == "field_battle") {
          ...
          return {
            faction: f,
            event: "swiss_mercenaries",
            html: `<li class="option" id="swiss_mercenaries">swiss mercenaries (${f})</li>`,
          };
        }
        return {};
      },
    ...
    deck["037"] = {
      ...
      menuOption: function (his_self, menu, player, card = "") {
        if (menu == "event") {
          ...
          //
          if (card === "001" || card == "002" || card == "003" || card == "004") {
            return {};
          }
          ...
          return {
            faction: "protestant",
            event: "wartburg",
            html: `<li class="option" id="wartburg">jwartburg (protestant)</li>`,
          };
        }
        return {};
      },
    ...
    deck["047"] = {
      ...
      onEvent: function (his_self, faction) {
        let home_spaces = his_self.returnSpacesWithFilter(function (spacekey) {
        ...
        for (let i = 0; i < home_spaces.length; i++) {
          if (his_self.game.spaces[home_spaces[i]].religion === "protestant") {
            count++;
          }
        }
    ...
    deck["065"] = {
      ...
      onEvent: function (his_self, faction) {
        ...
        his_self.game.queue.push("protestant_reformation\t" + player + "\tgerman");
        his_self.game.queue.push(
          "ACKNOWLEDGE\tThe Protestants - A Mighty Fortress - 6 Reformation Attempts in German Zone"
        );
        his_self.commitDebater("protestant", "luther-debater");
      ...
      onEvent: function (his_self, faction) {
        ...
        if (his_self.game.player == p) {
          ...
          for (let i = 0; i < neighbours.length; i++) {
            for (let ii = 0; ii < enemies.length; ii++) {
              if (his_self.isSpaceControlled(neighbours[i], enemies[ii])) {
                if (!target_which_faction.includes(enemies[ii])) {
          ...
          his_self.playerSelectSpaceWithFilter(
            ...
            function (spacekey) {
              ...
              his_self.playerSelectSpaceWithFilter(
                ...
                function (spacekey) {
                  if (
                    spacekey !== first_choice &&
                    his_self.game.spaces[spacekey].religion === "protestant" &&
                    his_self.isOccupied(his_self.game.spaces[spacekey]) == 0 &&
                    his_self.isElectorate(spacekey)
                  ) {
                    return 1;
                  }
                  return 0;
    ...
    deck["071"] = {
      ...
      onEvent: function (his_self, faction) {
        ...
        if (p == his_self.game.player) {
          his_self.playerSelectSpaceWithFilter(
            ...
            function (space) {
              // captured key
              if (space.home === "independent" && space.political != space.home) {
                return 1;
              }
      ...
      handleGameLoop: function (his_self, qe, mv) {
        if (mv[0] == "city-state-rebels") {
          ...
          if (his_self.game.player == p) {
            his_self.addMove(
              "finish-city-state-rebels\t" + faction + "\t" + respondent + "\t" + spacekey
            );
        ...
        if (mv[0] == "cloth-prices-fluctuate-option2") {
          ...
          his_self.playerSelectSpaceWithFilter(
            ...
            function (space) {
              ...
              if (space.home == "hapsburg" && space.language == "italian") {
                return 1;
              }
              if (space.home == "hapsburg" && space.language == "german") {
                return 1;
              }
              return 0;
            },
    ...
    deck["078"] = {
      ...
      onEvent: function (his_self, faction) {
        ...
        res = his_self.returnNearestSpaceWithFilter(
          ...
          function (spacekey) {
            if (
              his_self.game.spaces[spacekey].religious == "catholic" &&
      ...
      onEvent: function (his_self, faction) {
        ...
        if (his_self.game.player == p) {
          ...
          his_self.playerSelectSpaceWithFilter(
            ...
            function (space) {
              if (space.home === "france" && !his_self.isOccupied(space)) {
                return 1;
              }
              return 0;
            },
      ...
      onEvent: function (his_self, faction) {
        ...
        if (p == his_self.game.player) {
          let res = his_self.returnSpacesWithFilter(function (spacekey) {
            ...
            if (his_self.isOccupied(his_self.game.spaces[spacekey])) {
              return 0;
            }
            return 1;
          });
              ...
              function (card) {
                ...
                his_self.playerRetainUnitsWithFilter(
                  ...
                  function (spacekey, unit_idx) {
                    if (this.game.spaces[spacekey].units[target][unit_idx].type == "mercenary") {
                      return 1;
                    }
                    return 0;
                  },
          ...
          for (let i = 0; i < this.game.state.players_info.length; i++) {
            for (let ii = 0; ii < this.game.state.players_info[i].captured.length; ii++) {
              captured_leaders.push({
                leader: this.game.state.players_info[i].captured[ii].type,
                player: i,
                idx: ii,
              });
        ...
        if (mv[0] == "ransom") {
          ...
          if (player == his_self.game.player) {
            his_self.playerFactionSelectSpaceWithFilter(
              ...
              function (spacekey) {
                if (
                  his_self.game.spaces[spacekey].type == "fortress" &&
                  his_self.game.spaces[spacekey].home == ransomed_leader.owner
                ) {
                  return 1;
                }
                return 0;
          ...
          if (his_self.game.player === p) {
            his_self.playerSelectUnitsWithFilterFromSpacesWithFilter(
              ...
              (selected) => {
                for (let i = 0; i < selected.length; i++) {
                  his_self.addMove(
                    "build" + "\t" + "land" + "\t" + selected[i].type + "\t" + "egypt" + "\t"
                  );
                  his_self.addMove(
                    "remove_unit" +
                      "\t" +
            ...
            $(".option").on("click", function () {
              ...
              if (action === "yes") {
                ...
                his_self.playerSelectSpaceWithFilter(
                  ...
                  (space) => {
                    return his_self.returnFactionLandUnitsInSpace(faction, space.key);
                  },
          ...
          if (his_self.game.player === p) {
            his_self.playerSelectUnitsWithFilterFromSpacesWithFilter(
              ...
              (selected) => {
                for (let i = 0; i < selected.length; i++) {
                  his_self.addMove(
                    "build" + "\t" + "land" + "\t" + selected[i].type + "\t" + "ireland" + "\t"
                  );
                  his_self.addMove(
                    "remove_unit" +
                      "\t" +
    ...
    deck["094"] = {
      ...
      onEvent: function (his_self, faction) {
        ...
        if (p == his_self.game.player) {
          let res = his_self.returnSpacesWithFilter(function (spacekey) {
            if (his_self.game.spaces[spacekey].language == "spanish") {
              return 1;
            }
            return 0;
          });
    ...
    deck["105"] = {
      ...
      canEvent: function (his_self, faction) {
        let spaces_under_siege = his_self.countSpacesWithFilter(function (space) {
          if (space.besieged > 0) {
            return 1;
          }
          return 0;
    ...
    deck["106"] = {
      ...
      canEvent: function (his_self, faction) {
        let spaces_with_mercenaries = his_self.countSpacesWithFilter(function (space) {
          for (let key in space.units) {
            for (let i = 0; i < space.units[key].length; i++) {
            ...
            function (spacekey) {
              ...
              if (factions.length > 0) {
                ...
                $(".option").on("click", function () {
                  ...
                  for (
                    let z = his_self.game.spaces[spacekey].units[action].length - 1;
                    z >= 0;
                    z--
                  ) {
                ...
                for (
                  let z = his_self.game.spaces[spacekey].units[factions[0]].length - 1;
                  z >= 0;
                  z--
                ) {
      ...
      onEvent: function (his_self, faction) {
        ...
        if (p == his_self.game.player) {
          his_self.playerSelectSpaceWithFilter(
            ...
            function (space) {
              for (let key in space.units) {
                if (his_self.returnFactionLandUnitsInSpace(space.key) > 0) {
                  return 1;
                }
              }
              return 0;
          ...
          if (his_self.game.player == p2) {
            ...
            his_self.addMove(
              "share_hand\t" +
                ...
                faction_giving +
                "\t" +
                JSON.stringify(his_self.game.deck[0].fhand[fhand_idx])
            );
            his_self.endTurn();
          }
          ...
          if (his_self.game.player === p) {
            his_self.playerSelectUnitsWithFilterFromSpacesWithFilter(
              ...
              (selected) => {
                for (let i = 0; i < selected.length; i++) {
                  his_self.addMove(
                    "build" + "\t" + "land" + "\t" + selected[i].type + "\t" + "persia" + "\t"
                  );
                  his_self.addMove(
                    "remove_unit" +
                      "\t" +
  ...
  hasCatholicLandUnits(space) {
    ...
    for (let f in space.units) {
      if (f != "protestant" && f != "ottoman") {
        if (
          f == "england" &&
          (this.game.state.leaders.edward_vi != 1 || this.game.state.leaders.elizabeth_i != 1)
        ) {
  ...
  isSpaceControlled(space, faction) {
    ...
    if (space.home !== faction && this.isAlliedMinorPower(space.home, faction)) {
      return true;
    }
  ...
  returnNearestFactionControlledPorts(faction, space) {
    try {
      if (this.game.navelspaces[space]) {
  ...
  canFactionRetreatToSpace(faction, space, attacker_comes_from_this_space) {
    ...
    try {
      if (this.game.spaces[attacker_comes_from_this_space]) {
        attacker_comes_from_this_space = this.game.spaces[invalid_space];
      }
    } catch (err) {}
      ...
      for (let f in this.game.spaces[key].units) {
        if (f != exclude_faction) {
          if (this.game.spaces[key].units[faction]) {
            for (let i = 0; i < this.game.spaces[key].units[faction].length; i++) {
              if (
                this.game.spaces[key].units[faction][i].type === "squadron" ||
                this.game.spaces[key].units[faction][i].type === "corsair"
              ) {
                return 1;
              }
            }
  ...
  doesFactionHaveNavalUnitsInSpace(faction, key) {
    ...
    if (this.game.navalspaces[key]) {
      if (this.game.navalspaces[key].units[faction]) {
        for (let i = 0; i < this.game.navalspaces[key].units[faction].length; i++) {
          if (
            this.game.navalspaces[key].units[faction][i].type === "squadron" ||
            this.game.navalspaces[key].units[faction][i].type === "corsair"
          ) {
            return 1;
          }
        }
  ...
  returnNumberOfKeysControlledByFaction(faction) {
    ...
    for (let key in this.game.spaces) {
      if (this.game.spaces[key].type === "key") {
        if (
          this.game.spaces[key].political === this.factions[faction].key ||
          (this.game.spaces[key].political === "" &&
            this.game.spaces[key].home === this.factions[faction].key)
        ) {
          controlled_keys++;
        }
      }
  ...
  returnSpaces() {
    ...
    for (let key in spaces) {
      ...
      if (!spaces[key].key) {
        spaces[key].key = spaces[key].name;
      }
  ...
  isOccupied(space) {
    ...
    for (let key in this.game.spaces[space].units) {
      if (this.game.spaces[space].units[key].length > 0) {
        return 1;
      }
    }
  ...
  isMinorPower(power) {
    if (power === "genoa" || power === "hungary" || power === "scotland" || power === "venice") {
      return 1;
    }
    return 0;
  }
  ...
  returnDebatersInLanguageZone(language_zone = "german", faction = "papacy", committed = -1) {
    ...
    for (let i = 0; i < this.game.state.debaters.length; i++) {
      if (
        ...
        this.game.state.debaters[i].langauge_zone === "any"
      ) {
        if (
          this.game.state.debaters[i].faction === faction ||
          (faction != "papacy" && this.game.state.debaters[i].faction != "papacy")
        ) {
  ...
  addEvents(obj) {
    ...
    if (obj.menuOptionTriggers == null) {
      obj.menuOptionTriggers = function (his_self, stage, player, faction) {
        return 0;
      };
    }
    ...
    if (obj.menuOptionActivated == null) {
      obj.menuOptionActivated = function (his_self, stage, player, faction) {
        return 0;
      };
    }
    ...
    if (this.game.queue.length > 0) {
      ...
      if (mv[0] === "round") {
        ...
        this.game.queue.push(
          "ACKNOWLEDGE\tFACTION: " + JSON.stringify(this.returnPlayerFactions(this.game.player))
        );
      ...
      if (mv[0] === "show_overlay") {
        ...
        if (mv[1] === "field_battle") {
          if (mv[2] === "post_field_battle_attackers_win") {
            this.field_battle_overlay.attackersWin(his_self.game.state.field_battle);
          }
          if (mv[2] === "post_field_battle_defenders_win") {
            this.field_battle_overlay.defendersWin(his_self.game.state.field_battle);
          }
        }
        this.game.queue.splice(qe, 1);
        return 1;
                  ...
                  if (lqe - 1 >= 0) {
                    ...
                    if (skip_avoid_battle != 1) {
                      this.game.queue.splice(
                        lqe,
                        0,
                        "naval_retreat_check\t" + faction + "\t" + destination + "\t" + source
                      );
                    }
                  ...
                  if (lqe - 1 >= 0) {
                    ...
                    if (skip_avoid_battle != 1) {
                      this.game.queue.splice(
                        lqe,
                        0,
                        "retreat_check\t" + faction + "\t" + destination + "\t" + source
                      );
                      this.game.queue.splice(
                        lqe,
                        0,
                        "fortification_check\t" + faction + "\t" + destination + "\t" + source
                      );
                    }
              ...
              if (fluis > 4) {
                ...
                if (this.isMinorPower(f)) {
                  if (this.isMinorUnactivatedPower(f)) {
                    ...
                    if (this.game.state.activated_powers["ottoman"].includes(f)) {
                      cf = "ottoman";
                    }
                    if (this.game.state.activated_powers["hapsburg"].includes(f)) {
                      cf = "hapsburg";
                    }
                    if (this.game.state.activated_powers["france"].includes(f)) {
                      cf = "france";
                    }
                    if (this.game.state.activated_powers["england"].includes(f)) {
                      cf = "england";
                    }
                    if (this.game.state.activated_powers["papacy"].includes(f)) {
                      cf = "papacy";
                    }
                    if (this.game.state.activated_powers["protestant"].includes(f)) {
                      cf = "protestant";
                    }
                    ...
                    for (let i = 0; i < space.units[f].length; i++) {
                      his_self.game.queue.push(
                        "fortify_unit\t" +
                          ...
                          f +
                          "\t" +
                          JSON.stringify(space.units[f][i])
                      );
                    }
                  }
                }
      ...
      if (mv[0] === "fortification") {
        ...
        if (this.game.player === player) {
          console.log(
            "0. this player is fortifying space: " + faction + " / " + attacker + " / " + spacekey
          );
          ...
          if (this.isPlayerControlledFaction(faction)) {
            ...
            this.updateStatus(
              this.returnFactionName(faction) + " handling retreat into fortification"
            );
          } else {
      ...
      if (mv[0] === "naval_retreat") {
        ...
        if (this.game.spaces[destination_spacekey]) {
          source = this.game.spaces[destination_spacekey];
        }
        if (this.game.navalspaces[destination_spacekey]) {
          source = this.game.navalspaces[destination_spacekey];
        }
        ...
        if (dsum >= hits_on) {
          ...
          for (let i = 0; i < units_to_move_idx.length; i++) {
            let m =
              ...
              spacekey +
              "\t" +
              units_to_move_idx[i + "\t" + 1]; // 1 = skip avoid battle
      ...
      if (mv[0] === "diet_of_worms") {
        ...
        for (let i = 0; i < this.game.deck[0].fhand[0].length; i++) {
          ...
          if (this.game.deck[0].cards[this.game.deck[0].fhand[0][i]].type === "mandatory") {
          } else {
        ...
        if (protestant_hits > papacy_hits) {
          ...
          if (protestant_hits < papacy_hits) {
            ...
            for (
              let i = 1;
              i <= total_conversion_attempts &&
              i <= this.returnNumberOfProtestantSpacesInLanguageZone();
              i++
            ) {
      ...
      if (mv[0] === "counter_or_acknowledge") {
        ...
        $(".option").on("click", function () {
          ...
          //
          his_self.addMove("RESOLVE\t" + this.publicKey);
      ...
      if (mv[0] === "naval_battle") {
        ...
        for (let f in space.units) {
          if (f !== attacker_faction && faction_map[f] === attacker_faction) {
            ...
            let p = {};
            if (fp > 0) {
              p = his_self.game.state.players_info[fp - 1];
            }
          ...
          if (f !== defender_faction && faction_map[f] === defender_faction) {
            ...
            if (fp > 0) {
              let p = {};
              if (fp > 0) {
                let p = his_self.game.state.players_info[fp - 1];
              }
        ...
        his_self.game.queue.push(
          `counter_or_acknowledge\tNaval Battle Hits Assigmentt\tnaval_battle_hits_assignment`
        );
      ...
      if (mv[0] === "field_battle") {
        ...
        let calculate_rolls = function (faction) {
          ...
          for (let i = 0; i < space.units[faction].length; i++) {
            if (space.units[faction][i].personage == false) {
              if (
                space.units[faction][i].land_or_sea === "land" ||
        ...
        if (his_self.game.state.field_battle.attacker_player > 0) {
          attacker_modified_rolls = modify_rolls(
            his_self.game.state.players_info[his_self.game.state.field_battle.attacker_player - 1],
            attacker_results
          );
        }
        if (his_self.game.state.field_battle.defender_player > 0) {
          defender_modified_rolls = modify_rolls(
            his_self.game.state.players_info[his_self.game.state.field_battle.defender_player - 1],
            defender_results
          );
        }
        ...
        if (ap.tmp_roll_first == 1 && dp.tmp_roll_first != 1) {
          ...
          his_self.game.queue.push(
            "field_battle_assign_hits\t" + his_self.game.state.field_battle.defender_faction
          );
          his_self.game.queue.push(
            "field_battle_assign_hits\t" + his_self.game.state.field_battle.attacker_faction
          );
                      ...
                      for (let i = 0; i < space.units[f].length; i++) {
                        if (space.units[f][i].type === cannon_fodder) {
                          ...
                          if (faction === his_self.game.state.field_battle_attacker_faction) {
                            for (
                              let z = 0;
                              z < his_self.game.state.field_battle.attacker_units.length;
                              z++
                            ) {
                          ...
                          if (faction === his_self.game.state.field_battle_defender_faction) {
                            for (
                              let z = 0;
                              z < his_self.game.state.field_battle.defender_units.length;
                              z++
                            ) {
                    ...
                    if (space.units[selected_faction][ii].type === cannon_fodder) {
                      his_self.updateLog(
                        this.returnFactionName(f) +
                          " " +
                          space.units[selected_faction][ii].name +
                          " killed"
                      );
          ...
          if (space.units[faction][i].type === unit_type) {
            if (
              ...
              for (let z = 0; z < this.game.state.field_battle.attacker_units.length; z++) {
                if (
                  this.game.state.field_battle.attacker_units[z] === space.units[faction][i].type
                ) {
              ...
              for (let z = 0; z < this.game.state.field_battle.defender_units.length; z++) {
                if (
                  this.game.state.field_battle.defender_units[z].type ===
                  space.units[faction][i].type
                ) {
      ...
      if (mv[0] === "field_battle_continue") {
        ...
        his_self.updateLog(
          "Attacker Modified: " +
            JSON.stringify(his_self.game.state.field_battle.attacker_modified_rolls)
        );
        his_self.updateLog(
          "Defender Modified: " +
            JSON.stringify(his_self.game.state.field_battle.defender_modified_rolls)
        );
        ...
        his_self.game.state.field_battle.defender_land_units_remaining =
          his_self.game.state.field_battle.defender_units.length -
          his_self.game.state.field_battle.attacker_hits;

        if (
          his_self.game.state.field_battle.attacker_land_units_remaining == 0 &&
          his_self.game.state.field_battle.defender_land_units_remaining == 0
        ) {
          if (
        ...
        this.updateLog(
          "Attacker Units Remaining: " +
            his_self.game.state.field_battle.attacker_land_units_remaining
        );
        this.updateLog(
          "Defender Units Remaining: " +
            his_self.game.state.field_battle.efender_land_units_remaining
        );
          ...
          for (let f in his_self.game.state.field_battle.faction_map) {
            ...
            if (
              ...
              if (can_faction_retreat == 1) {
                ...
                this.game.queue.push(
                  "post_field_battle_player_evaluate_retreat\t" + f + "\t" + space.key
                );
              }
        ...
        if (winner === his_self.game.state.field_battle.attacker_faction) {
            ...
            if (
              ...
              for (let z = 0; z < space.neighbours.length; z++) {
                let fluis = this.canFactionRetreatToSpace(
                  f,
                  space.neighbours[z],
                  his_self.game.state.attacker_comes_from_this_spacekey
                );
                if (fluis > 0) {
                  can_faction_retreat = 1;
                }
          ...
          this.game.queue.push(
            "post_field_battle_player_evaluate_fortification\t" +
              his_self.game.state.field_battle.attacker_faction +
              "\t" +
              his_self.returnPlayerOfFaction(his_self.game.state.field_battle.defender_faction) +
              "\t" +
              his_self.game.state.field_battle.defender_faction +
              "\t" +
              space.key
      ...
      if (mv[0] === "destroy_units") {
        ...
        if (this.game.space[spacekey]) {
          space = this.game.space[spacekey];
        }
      ...
      if (mv[0] === "destroy_naval_units") {
        ...
        if (this.game.navalspace[spacekey]) {
          space = this.game.navalspace[spacekey];
        }
      ...
      if (mv[0] === "naval_battle_continue") {
        ...
        let attacker_player =
          his_self.game.state.players_info[his_self.returnPlayerOfFaction(attacker_faction) - 1];
        let defender_player =
          his_self.game.state.players_info[his_self.returnPlayerOfFaction(defender_faction) - 1];
        ...
        //
        his_self.game.state.naval_battle.attacker_modified_rolls = modify_rolls(
          attacker_player,
          attacker_results
        );
        his_self.game.state.naval_battle.defender_modified_rolls = modify_rolls(
          defender_player,
          defender_results
        );
        ...
        his_self.updateLog(
          "Attacker Modified: " +
            JSON.stringify(his_self.game.state.naval_battle.attacker_modified_rolls)
        );
        his_self.updateLog(
          "Defender Modified: " +
            JSON.stringify(his_self.game.state.naval_battle.defender_modified_rolls)
        );
        ...
        this.game.queue.push(
          "purge_naval_units_and_capture_leaders\t" + f + "\t" + defender_faction + "\t" + space.key
        );
        ...
        if (this.game.spaces[space.key]) {
          ...
          //
          this.game.queue.push(
            "player_evaluate_post_naval_battle_retreat\t" + attacker_faction + "\t" + space.key
          );
        } else {
          //
          ...
          if (winner === defender_faction) {
            ...
            this.game.queue.push(
              "player_evaluate_post_naval_battle_retreat\t" + defender_faction + "\t" + space.key
            );
          }
        }

        this.game.queue.push(
          "naval_battle_hits_assignment\t" +
            defender_faction +
            "\t" +
            attacker_hits +
            "\t" +
      ...
      if (mv[0] === "assault_continue") {
        ...
        if (attacker_player.tmp_rolls_first == 1 && defender_player.tmp_rolls_first != 1) {
          ...
          //
          his_self.game.state.assault.attacker_modified_rolls = modify_rolls(
            attacker_player,
            attacker_results
          );
          ...
          //
          his_self.game.state.assault.defender_modified_rolls = modify_rolls(
            defender_player,
            defender_results
          );
        ...
        his_self.updateLog(
          "Attacker Modified: " +
            JSON.stringify(his_self.game.state.assault.attacker_modified_rolls)
        );
        his_self.updateLog(
          "Defender Modified: " +
            JSON.stringify(his_self.game.state.assault.defender_modified_rolls)
        );
        his_self.updateLog("Attacker Hits: " + attacker_hits);
        his_self.updateLog("Defender Hits: " + defender_hits);
      ...
      if (mv[0] === "purge_units_and_capture_leaders") {
        ...
        if (space.units[loser].length > 0) {
          this.updateLog(
            this.returnFactionName(loser) + " eliminated in " + this.returnSpaceName(spacekey)
          );
        }
      ...
      if (mv[0] === "player_evaluate_post_naval_battle_retreat") {
        ...
        if (this.game.player == this.returnPlayerOfFaction(loser)) {
          ...
          this.updateStatus(
            this.returnFactionName(loser) + " considering post-battle retreat at sea"
          );
        }
      ...
      if (mv[0] === "pick_first_round_debaters") {
        ...
        this.game.state.theological_debate.attacker_faction =
          attacker.charAt(0).toUpperCase() + attacker.slice(1);
        this.game.state.theological_debate.defender_faction =
      ...
      if (mv[0] === "theological_debate") {
        ...
        for (let i = 0; i < this.game.state.debaters.length; i++) {
          if (
            this.game.state.debaters[i].type === this.game.state.theological_debate.attacker_debater
          ) {
            attacker_idx = i;
            if (this.game.state.debaters[i].committed == 0) {
              this.commitDebater(
        ...
        for (let i = 0; i < this.game.state.debaters.length; i++) {
          if (
            this.game.state.debaters[i].type === this.game.state.theological_debate.defender_debater
          ) {
            defender_idx = i;
            if (this.game.state.debaters[i].committed == 0) {
        ...
        let defender_rolls =
          this.game.state.debaters[defender_idx].power + 1 + was_defender_uncommitted;
        ...
        if (
          attacker === "papacy" &&
          this.game.state.theological_debate.attacker_debater === "eck-debater" &&
          this.game.state.theological_debate.attacker_debater_entered_uncommitted == 1
        ) {
          attacker_rolls++;
        }
        ...
        if (
          attacker === "papacy" &&
          this.game.state.theological_debate.attacker_debater === "gardiner-debater" &&
          this.game.state.theological_debate.language_zone === "english" &&
          this.game.state.theological_debate.defender_debater_entered_uncommitted == 1
        ) {
          attacker_rolls++;
        }
        ...
        if (attacker_hits == defender_hits) {
          ...
          if (attacker_hits > defender_hits) {
            this.game.state.theological_debate.status =
              this.game.state.theological_debate.attacker_faction + " Wins";
          } else {
            this.game.state.theological_debate.status =
              this.game.state.theological_debate.defender_faction + " Wins";
          }
        }
        ...
        if (attacker_hits == defender_hits) {
          ...
          if (this.game.state.theological_debate.round > 2) {
            ...
            this.game.queue.push(
              "counter_or_acknowledge\tThe Debate is Tied - Progress to 2nd Round\tdebate"
            );
            this.game.queue.push("RESETCONFIRMSNEEDED\tall");
          ...
          //
          if (
            (this.game.state.theological_debate.attacker_debater === "aleander-debater" &&
              this.game.state.theological_debate.attacker_debater_entered_uncommitted == 1) ||
            (this.game.state.theological_debate.defender_debater === "aleander-debater" &&
              this.game.state.theological_debate.defender_debater_entered_uncommitted == 1)
          ) {
            bonus_conversions = 1;
          }
          ...
          if (attacker_hits > defender_hits) {
            ...
            let total_spaces_in_zone =
              this.returnNumberOfProtestantSpacesInLanguageZone(language_zone);
            if (attacker === "papacy") {
              total_spaces_in_zone = this.returnNumberOfCatholicSpacesInLanguageZone(language_zone);
            }
            ...
            if (
              this.game.state.theological_debate.defender_debater === "campeggio-debater" &&
              this.game.state.theological_debate.defender_debater_entered_uncommitted == 1
            ) {
            ...
            if (total_spaces_to_convert == 1) {
              this.updateLog(
                this.game.state.theological_debate.attacker_faction +
                  ` Wins - Convert ${total_spaces_to_convert + bonus_conversions} Space}`
              );
            } else {
              this.updateLog(
                this.game.state.theological_debate.attacker_faction +
                  ` Wins - Convert ${total_spaces_to_convert + bonus_conversions} Spaces}`
              );
            }

            console.log(
              "TOTAL SPACES AVAILABLE: " + (total_spaces_to_convert + " + " + bonus_conversions)
            );
            ...
            for (let i = total_spaces_to_convert + bonus_conversions; i >= 1; i--) {
              if (i > total_spaces_in_zone + bonus_conversions) {
                ...
                if (attacker === "papacy") {
                  ...
                  this.game.queue.push(
                    "select_for_protestant_conversion\tprotestant\t" + language_zone
                  );
                }
              }
            }
            ...
            this.game.queue.push(
              "counter_or_acknowledge\t" +
                this.game.state.theological_debate.attacker_faction +
                ` Wins - Convert ${total_spaces_to_convert} Spaces}`
            );
            this.game.queue.push("RESETCONFIRMSNEEDED\tall");
            this.game.queue.push("show_overlay\ttheological_debate");
          } else {
            ...
            //
            if (
              this.game.state.theological_debate.attacker_debater === "campeggio-debater" &&
              this.game.state.theological_debate.attacker_debater_entered_uncommitted == 1
            ) {
              let roll = this.rollDice(6);
              if (roll >= 5) {
            ...
            if (total_spaces_to_convert == 1) {
              this.updateLog(
                this.game.state.theological_debate.defender_faction +
                  ` Wins - Convert ${total_spaces_to_convert} Space}`
              );
            } else {
              this.updateLog(
                this.game.state.theological_debate.defender_faction +
      ...
      if (mv[0] === "spring_deployment") {
        ...
        if (this.game.player == player) {
          ...
          this.updateStatus(
            faction.charAt(0).toUpperCase() + faction.slice(1) + " Spring Deployment"
          );
        }
      ...
      if (mv[0] === "card_draw_phase") {
        ...
        for (let i = this.game.state.players_info.length - 1; i >= 0; i--) {
          for (let z = 0; z < this.game.state.players_info[i].factions.length; z++) {
            let cardnum =
              this.factions[this.game.state.players_info[i].factions[z]].returnCardsDealt(this);
            ...
            this.game.queue.push(
              "hand_to_fhand\t1\t" + (i + 1) + "\t" + this.game.state.players_info[i].factions[z]
            );
            this.game.queue.push(
              "add_home_card\t" + (i + 1) + "\t" + this.game.state.players_info[i].factions[z]
            );
        ...
        if (type == "card") {
          if (this.game.player === player_of_faction) {
            ...
            for (let zz = 0; zz < discards.length; zz++) {
              this.addMove(
                "discard\t" + faction + "\t" + this.game.deck[0].fhand_idx[discards[zz]]
              );
            }
            this.endTurn();
          }
      ...
      if (mv[0] === "hand_to_fhand") {
        ...
        if (this.game.player == player) {
          ...
          while (this.game.deck[deckidx].fhand.length < fhand_idx + 1) {
      ...
      if (mv[0] === "reformation") {
        ...
        for (let i = 0; i < this.game.spaces[space].neighbours.length; i++) {
          ...
          if (this.game.spaces[this.game.spaces[space].neighbours[i]].religion === "catholic") {
            c_roll_desc.push({
              name: this.game.spaces[this.game.spaces[space].neighbours[i]].name,
              desc: "adjacency",
            });
            c_neighbours++;
          }
        ...
        if (this.game.state.tmp_protestant_reformation_bonus_spaces.length > 0) {
          if (!this.game.state.tmp_protestant_reformation_bonus_spaces.includes(space)) {
            ...
            if (this.game.state.tmp_protestant_reformation_bonus < 0) {
        ...
        if (this.game.state.tmp_catholic_reformation_bonus_spaces.length > 0) {
          if (!this.game.state.tmp_catholic_reformation_bonus_spaces.includes(space)) {
            ...
            if (this.game.state.tmp_catholic_reformation_bonus < 0) {
      ...
      if (mv[0] === "counter_reformation") {
        ...
        if (this.game.state.tmp_protestant_counter_reformation_bonus_spaces.length > 0) {
          if (!this.game.state.tmp_protestant_counter_reformation_bonus_spaces.includes(space)) {
            ...
            if (this.game.state.tmp_protestant_counter_reformation_bonus < 0) {
        ...
        if (this.game.state.tmp_catholic_counter_reformation_bonus_spaces.length > 0) {
          if (!this.game.state.tmp_catholic_counter_reformation_bonus_spaces.includes(space)) {
            ...
            if (this.game.state.tmp_catholic_counter_reformation_bonus < 0) {
    ...
    let selectUnitsInterface = function (
      ...
      for (let i = 0; i < space.units[faction].length; i++) {
        if (!units_to_destroy.includes(parseInt(i))) {
          let is_fodder = true;
          if (space.units[faction][i].land_or_sea === "sea" && naval_hits_acceptable == 0) {
            is_fodder = false;
          }
      ...
      if (targets <= 0 || hits_to_assign <= 0) {
        this.addMove(
          "destroy_units\t" + faction + "\t" + spacekey + "\t" + JSON.stringify(units_to_destroy)
        );
        this.endTurn();
        return;
      }
  ...
  playerResolveWinterRetreat(faction, spacekey) {
    ...
    $(".option").on("click", () => {
      ...
      his_self.addMove(
        "retreat_to_winter_spaces_resolve\t" + faction + "\t" + spacekey + "\t" + id
      );
      his_self.endTurn();
    });
  }
    ...
    let selectUnitsInterface = function (
      ...
      for (let i = 0; i < available_units.length; i++) {
        ...
        if (units_to_move.includes(i)) {
          ...
          html += `<li class="option" style="" id="${i}">${tu.name} - ${his_self.returnFactionName(
            tf
          )}</li>`;
        }
      }
    ...
    if (this.game.state.activated_powers[faction].length > 0) {
      ...
      this.attachCardboxEvents(function (selected_faction) {
        ...
        this.attachCardboxEvents(async (user_choice) => {
          ...
          if (ops > 0) {
            this.addMove(
              "continue\t" + this.game.player + "\t" + faction + "\t" + card + "\t" + ops
            );
          }
          ...
          function (destination_spacekey) {
            ...
            let selectUnitsInterface = function (
              ...
              $(".option").on("click", function () {
                ...
                let unitno = 0;
                for (let i = 0; i < units_to_move.length; i++) {
                  if (space.units[faction][units_to_move[i]].command_value == 0) {
                    unitno++;
                  }
        ...
        if (command_value_one == 0) {
          ...
          if (command_value_two == 0) {
            ...
            if (
              ...
              units_to_move[i].command_value > command_value_one
            ) {
              command_value_one = units_to_move[i].command_value;
            } else {
              if (
                command_value_one < command_value_two &&
                units_to_move[i].command_value > command_value_two
              ) {
          ...
          his_self.playerSelectOptions(
            ...
            function (array_of_unit_idxs) {
              ...
              for (let i = 0; i < array_of_unit_idxs.length; i++) {
                ...
                for (let z = 0; z < selected.length; z++) {
                  if (
                    selected[z].spacekey == options[array_of_unit_idxs[i]].spacekey &&
                    selected[z].unit_idx === array_of_unit_idxs[i]
                  ) {
                    add_this_unit = false;
                  }
                }
  ...
  playerSelectOptions(options, num = 1, must_select_max = true, mycallback = null) {
    ...
    let selectOptionsInterface = function (his_self, options_selected, selectOptionsInterface) {
      ...
      let msg = `Select
                 From Options: (${remaining} remaining)`;
      let html = "<ul>";
  ...
  playerEvaluateNavalRetreatOpportunity(faction, spacekey) {
    ...
    let onFinishSelect = function (his_self, destination_spacekey) {
      his_self.addMove(
        "naval_retreat" + "\t" + faction + "\t" + spacekey + "\t" + "\t" + destination_spacekey
      );
      his_self.endTurn();
    };
  ...
  playerEvaluateRetreatOpportunity(
    ...
    let onFinishSelect = function (his_self, destination_spacekey) {
      if (is_attacker_loser) {
        his_self.addMove(
          "retreat" + "\t" + attacker + "\t" + spacekey + "\t" + destination_spacekey
        );
      } else {
        his_self.addMove(
          "retreat" + "\t" + defender + "\t" + spacekey + "\t" + destination_spacekey
        );
      }
      his_self.endTurn();
    };
  ...
  playerEvaluateInterceptionOpportunity(
    ...
    let selectUnitsInterface = function (
      ...
      for (let i = 0; i < space.units[defender].length; i++) {
        if (
          space.units[defender][i].land_or_sea === "land" ||
  ...
  canPlayerNavalTransport(his_self, player, faction, ops) {
    ...
    if (faction === "protestant" && his_self.game.state.events.schmalkaldic_league == 0) {
      return false;
    }
        ...
        for (let z in space.units) {
          if (space.units[z].length > 0 && z === faction) {
            ...
            for (let i = 0; i < spaces.units[z].length; i++) {
              if (space.units[z][i].locked == false) {
                any_unlocked_units = true;
              }
            }
            if (any_unlocked_units) {
              return 1;
            }
            if (space.pass) {
              if (space.pass.length > 0) {
                return 1;
              }
            }
          }
        ...
        if (id === "end") {
          ...
          for (let z = 0; z < entries_to_loop; z++) {
            ...
            revised_units_to_move.unshift(
              JSON.parse(JSON.stringify(units_available[units_to_move[highest_idx]]))
            );
  ...
  playerBuyMercenary(his_self, player, faction) {
    his_self.playerSelectSpaceWithFilter(
      ...
      function (space) {
        if (his_self.isSpaceFriendly(space, faction) && space.home === faction) {
          return 1;
        }
        return 0;
      },
      ...
      function (destination_spacekey) {
        his_self.addMove(
          "build\tland\t" + faction + "\t" + "mercenary" + "\t" + destination_spacekey
        );
        his_self.endTurn();
      }
    );
  ...
  async playerRaiseRegular(his_self, player, faction) {
    his_self.playerSelectSpaceWithFilter(
      ...
      function (destination_spacekey) {
        his_self.addMove(
          "build\tland\t" + faction + "\t" + "regular" + "\t" + destination_spacekey
        );
        his_self.endTurn();
      }
    );
  ...
  async playerBuildNavalSquadron(his_self, player, faction) {
    his_self.playerSelectSpaceWithFilter(
      ...
      function (destination_spacekey) {
        his_self.addMove(
          "build\tland\t" + faction + "\t" + "squadron" + "\t" + destination_spacekey
        );
        his_self.endTurn();
      }
    );
    ...
    his_self.playerSelectSpaceWithFilter(
      ...
      function (space) {
        if (
          ...
          his_self.returnFactionLandUnitsInSpace(faction, space) > 0 &&
          space.besieged == 1
        ) {
  ...
  canPlayerExplore(his_self, player, faction) {
    ...
    if (this.game.state.players_info[player - 1].has_explored == 0) {
      return 1;
    }
    return 0;
  }
  ...
  canPlayerColonize(his_self, player, faction) {
    ...
    if (this.game.state.players_info[player - 1].has_conquered == 0) {
      return 1;
    }
    return 0;
  }
  ...
  canPlayerInitiatePiracyInASea(his_self, player, faction) {
    ...
    if (faction === "ottoman" && his_self.game.events.ottoman_piracy_enabled == 1) {
      return 1;
    }
    return 0;
  }
  ...
  async playerRaiseCavalry(his_self, player, faction) {
    his_self.playerSelectSpaceWithFilter(
      ...
      function (destination_spacekey) {
        his_self.addMove(
          "build\tland\t" + faction + "\t" + "cavalry" + "\t" + destination_spacekey
        );
        his_self.endTurn();
      }
    );
  ...
  canPlayerBuildCorsair(his_self, player, faction) {
    if (faction === "ottoman" && his_self.game.events.ottoman_corsairs_enabled == 1) {
      return 1;
    }
    return 0;
  }
  ...
  async playerPublishTreatise(his_self, player, faction) {
    if (faction === "protestant") {
      ...
      $(".option").on("click", function () {
        ...
        if (
          id === "french" &&
          his_self.canPlayerCommitDebater("protestant", "calvin-debater") &&
          his_self.game.player === his_self.returnPlayerOfFaction("protestant")
        ) {
        ...
        if (
          id === "german" &&
          his_self.canPlayerCommitDebater("protestant", "carlstadt-debater") &&
          his_self.game.player === his_self.returnPlayerOfFaction("protestant")
        ) {
    ...
    $(".option").on("click", (e) => {
      ...
      $(".option").on("click", () => {
        ...
        if (faction === "papacy") {
          ...
          his_self.addMove("RESETCONFIRMSNEEDED\tall");
          his_self.addMove(
            "pick_first_round_debaters\tpapacy\tprotestant\t" + language_zone + "\t" + committed
          );
        } else {
          his_self.addMove("theological_debate");
          ...
          his_self.addMove("RESETCONFIRMSNEEDED\tall");
          his_self.addMove(
            "pick_first_round_debaters\tprotestant\tpapacy\t" + language_zone + "\t" + committed
          );
        }
        his_self.endTurn();
      });
  ...
  async playerBurnBooks(his_self, player, faction) {
    ...
    $(".option").on("click", function () {
      ...
      if (
        ...
        his_self.game.player === his_self.returnPlayerOfFaction("papacy")
      ) {
        ...
        $(".option").on("click", function () {
          ...
          if (id2 === "cajetan-debater" || id2 === "caraffa-debater") {
            if (id2 === "cajetan-debater") {
              his_self.addMove("commit\tpapacy\tcajetan-debater");
            }
            if (id2 === "caraffa-debater") {
              his_self.addMove("commit\tpapacy\tcaraffa-debater");
            }
  ...
  playerPlaceUnitsInSpaceWithFilter(
    ...
    his_self.playerSelectSpaceWithFilter(
      ...
      function (spacekey) {
        ...
        his_self.addMove(
          "build\tland\t" + faction + "\t" + unittype + "\t" + spacekey + "\t" + this.game.player
        );
  ...
  importFaction(name, obj) {
    ...
    if (obj.returnAdminRating == null) {
      obj.returnAdminRating = function () {
