...
class Chessgame extends GameTemplate {
  ...
  returnGameRulesHTML(){
    ...
    <h1>Chess</h1>
    <h4>The Objective</h4>
    To objective of the game is to checkmate and capture the oppponents king.
    <h4>The Play</h4>
    ...
    <h4>References</h4>
    <p>1. <a href="https://www.youtube.com/watch?v=6Pqd7UFWr7M" target="_blank">Video Tutorial</a></p>
    </div>`;
    return html;
  }
