...
class Youtube extends ModTemplate {
	constructor(app) {
		super(app);
		...
		this.slug = 'youtube';
		this.name = 'youtube';
		this.description = 'Create livestream on youtube';
		...
		this.styles = ['/youtube/style.css', '/saito/saito.css'];
	...
	async render() {
		...
		console.log('inside render of youtube //////////////');
	}
