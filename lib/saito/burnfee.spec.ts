...
test("burnfee routing work needed tests", () => {
    ...
    const bf3 = burnfee.returnBurnFeeForBlockProducedAtCurrentTimestampInNolan(BigInt(100000000), burnfee.heartbeat, 0);
    const bf4 = burnfee.returnBurnFeeForBlockProducedAtCurrentTimestampInNolan(BigInt(100000000), burnfee.heartbeat / 10, 0);
