...
test("difficulty test", () => {
    ...
    expect(GoldenTicket.generateHash(3).toUpperCase()).toEqual("1FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
    expect(GoldenTicket.generateHash(4).toUpperCase()).toEqual("0FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
    expect(GoldenTicket.generateHash(16).toUpperCase()).toEqual("0000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
    expect(GoldenTicket.generateHash(17).toUpperCase()).toEqual("00007FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
