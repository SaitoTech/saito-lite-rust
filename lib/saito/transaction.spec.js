...
test("sign", () => {
    ...
    tx.sign(mockApp);
    expect(Buffer.from(tx.transaction.sig).toString("hex").toUpperCase())
        .toEqual(
            "BF0FEC1A8E50CBAFD6262A38834F890E4A917BC7929074060D76226B31181A83018E07FF503FF2DD97558D492629693B2CE86F7D656CCE2693E29FE6818D5A7B5DFCD4C2CB18EAF857729A11D18807B3BFBC39677B11CEB8048572767335D8E6");
});
