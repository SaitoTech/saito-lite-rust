...
console.log("ABOUT TO RENDER THE INVITE PANEL -- which will eventually send the TX");
    ...
    document.querySelector(".saito-scheduler-text-input").addEventListener("keyup", (e) => {
      ...
      console.log(td);
      if (td) {
        document.querySelector(".scheduler-datetime-input").value = td.toISOString().substring(0,16);
