...
console.log("invitemod name: " + invitemod.name);
      invitemod.resetInviteOptions();
console.log("invitemod name: " + invitemod.name + " 2");
      invitemod.addPrivateSlotToInviteOptions(app.wallet.returnPublicKey());
console.log("invitemod name: " + invitemod.name + " 3");
      for (let i = 0; i < scheduler_self.options.slots.length; i++) {
console.log("invitemod name: " + invitemod.name + " 4");
...
console.log("INVITE MOD OPTIONS: ");
console.log(JSON.stringify(invitemod.options));
...
console.log("rendering : " + invitemod.name);
