...
class SaitoHeader extends UIModTemplate {
  ...
  attachEvents(app, mod) {
    ...
    if (document.querySelectorAll('.saito-left-sidebar-hamburger')) {
      ...
      const icon = document.querySelector('.saito-left-sidebar-hamburger #icon');
      mobileHamburger.forEach(item => {
        item.addEventListener('click', (e) => {
          console.log(item.parentElement);
          const mobileSidebar = item.parentElement.querySelector('.saito-left-sidebar-mobile');
          if (mobileSidebar.classList.contains('show-left-sidebar-mobile')) {
            mobileSidebar.classList.remove('show-left-sidebar-mobile');
            icon.className = "fas fa-bars";

          } else {
            icon.className = "fas fa-times";
            mobileSidebar.classList.add('show-left-sidebar-mobile');
          }
