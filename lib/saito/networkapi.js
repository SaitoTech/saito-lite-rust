...
class NetworkAPI {
    ...
    deserializeAPIMessage(bytes) {
        return new APIMessage(Buffer.from(bytes.slice(0, 8), "hex").toString("utf-8"), this.app.binary.u32FromBytes(bytes.slice(8, 12)), bytes.slice(12));
    }
