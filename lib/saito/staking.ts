...
export default class Staking {
    ...
    onChainReorganization(block, lc) {
        ...
        if (block.hasFeeTransaction() && block.hasGoldenTicket()) {
            ...
            //
            const golden_ticket_data = this.app.goldenticket.deserializeFromTransaction(golden_ticket_transaction);
    ...
    resetStakerTable(staking_treasury) {
        ...
        //
        const staking_payout_per_block = staking_treasury / BigInt(this.app.blockchain.blockchain.genesis_period);
