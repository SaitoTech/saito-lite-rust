...
export default class Transaction extends SaitoTransaction {
  ...
  async generateRebroadcastTransaction(
    ...
    const output = new Slip(undefined);
  ...
  // async returnSignature(app: Saito, force = 0): string {
  //   if (this.signature !== "" && force != 1) {
  ...
  //   for (let v = 0; v < this.from.length; v++) {
  //     if (this.from[v].publicKey === publickey) {
  //       x.push(this.from[v]);
  //     }
  //   }
  //   return x;
  ...
  //   for (let v = 0; v < this.from.length; v++) {
  //     if (this.from[v].publicKey === publickey) {
  //       x.from.push(this.from[v]);
  //     }
  //   }
  //   for (let v = 0; v < this.to.length; v++) {
  //     if (this.to[v].publicKey === publickey) {
  //       x.to.push(this.to[v]);
  //     }
  //   }
  //   return x;
  ...
  //   //
  //   let aggregate_routing_work = this.total_fees;
  ...
  //   //
  //
  //   const inputs_len = app.binary.u32AsBytes(this.from.length);
  //   const outputs_len = app.binary.u32AsBytes(this.to.length);
  //   const message_len = app.binary.u32AsBytes(this.m.byteLength);
  //
