...
console.log("ON CHAIN REORG IN BLOCKRING: " + block_id);
    ...
    if (lc) {
console.log("UPDATING LC POS IN BLOCKRING TO: " + insert_pos);
      this.lc_pos = insert_pos;
console.log("those hashes: " + JSON.stringify(this.ring[insert_pos]));
    } else {
