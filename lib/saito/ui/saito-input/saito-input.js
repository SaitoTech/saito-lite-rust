...
/***
 The Saito Input class manages the TEXTAREA into which typing is typically done in 
 RedSquare and Chat and potentially other applications. It has the following 
 subcomponents:

	- SaitoInputSelectionBox (key auto-complete)
...
class SaitoInput {
				...
				if (document.querySelector('.saito-input-selection-box')) {
					...
					if (!document.querySelector('.saito-input-selection-box')) {
						this.app.browser.addElementToDom(
							SaitoInputLegacySelectionBoxTemplate(this)
						);
	...
	processKeyDownEvents(e) {
		...
		if (this.selection_box.is_visible) {
			this.selection_box.processKeyDownEvents(e);
			return;
		}

		//
		// @ symbol -- address / username helper
		//
