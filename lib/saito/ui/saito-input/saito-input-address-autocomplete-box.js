const SaitoInputAddressAutocompleteBoxTemplate = require('./saito-input-address-autocomplete-box.template');
const SaitoUser = require('./../saito-user/saito-user');

class SaitoInputAddressAutocompleteBox {
	...
	render(obj={}) {
		...
		this.app.browser.addElementToDom(SaitoInputAddressAutocompleteBoxTemplate(obj));
...
console.log("keylist length: " + this.keylist.length);
...
console.log("searching all keys: " + myKeys.length);
...
module.exports = SaitoInputAddressAutocompleteBox;
