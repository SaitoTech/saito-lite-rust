...
SaitoInputContacts = require("./saito-input-contacts.template");
...
module.exports = SaitoInputSelectionBox = (input_self) => {
	...
	if (input_self.enable_mentions) {
		html += `<div class="selection-box-pane at-window ${input_self.open_tab == "at-window" ? "active-tab" : ""}" id="at-window">
			<div class="saito-input-mention-header">
				<input type="text" id="saito-mention-search-bar" class="saito-mention-search-bar" placeholder="Seach Contacts"></input>
				<i class="fa-solid fa-magnifying-glass"></i>
			</div>
			${SaitoInputContacts(input_self)}
		</div>`;
	}
