...
class PhotoUploader {
	...
	handleRender() {
		...
		const actionsElement = document.querySelector('.uploader-actions');

		if (photoElement && actionsElement) {
			if (this.image) {
			...
			console.error('Required DOM elements for rendering are missing!');
		}
	}
}
