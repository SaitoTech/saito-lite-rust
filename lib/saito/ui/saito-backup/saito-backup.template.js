module.exports = SaitoBackupTemplate = (app, mod, this_self) => {
	return `

			<div class="saito-overlay-form saito-backup-container saito-overlay-backup-reminder">
		      <div class="saito-overlay-form-header">
		        <div class="saito-overlay-form-header-title">BACKUP YOUR WALLET</div>
		      </div>
