module.exports = ActivateTemplate = (ticker, address, confirmations) => {
  ...
  return `
    <div class="crypto-activation-overlay" id="crypto-activation-overlay">
      ...
      <div class="crypto-activation-message">
        ...
        <div>Please note that new access keys have been added to your wallet. Please back-up afresh.</div>
      </div>
