module.exports  = (app, mod, obj) => {
  ...
  if (obj?.address && app.wallet.isValidPublicKey(obj.address)) {
    identicon = app.keychain.returnIdenticon(obj.address);
  }
    ...
    <div class="saito-overlay-form" id="saito-withdraw-overlay">
        ...
        <div id="withdraw-step-one">
          ...
          if (obj.identicon != null) {
            html +=   `<img class="saito-identicon" src="${identicon}" data-id="${obj.address}">`;
          }
