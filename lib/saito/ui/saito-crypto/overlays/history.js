...
class MixinHistory {
  ...
  async render() {
    ...
    if (this.mod.ticker != "SAITO") {
      ...
      document.querySelector(".mixin-txn-his-container .saito-table-body").innerHTML = '<a href="/explorer" class="saito-history-msg">View SAITO history on block explorer &gt;&gt;</a>';
    }
