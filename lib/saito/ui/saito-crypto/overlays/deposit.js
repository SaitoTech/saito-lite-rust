...
class Deposit {
  ...
  constructor(app, mod, container = "") {
    ...
    this.app.connection.on("saito-crypto-deposit-render-request", (obj) => {
      ...
      this.ticker_mod = this.app.wallet.returnCryptoModuleByTicker(this.ticker);
      this.address = this.ticker_mod.returnAddress();
  ...
  async render() {
    ...
    this.address = await this.app.wallet.returnPublicKey();
