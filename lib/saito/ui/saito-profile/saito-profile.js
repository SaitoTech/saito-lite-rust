...
class SaitoProfile {
    ...
    async render() {
        document.querySelector(this.container).innerHTML =  await SaitoProfileTemplate(this.app, this.mod, this);
    ...
    async addProfileMenu() {
        ...
        let mods = await this.app.modules.respondTo("saito-profile-menu", {publickey: this.publickey});
