...
class SaitoProfile {
  ...
  attachEvents() {
    ...
    if (document.querySelector(".saito-profile-unfollow-contact-btn")){
      document.querySelector(".saito-profile-unfollow-contact-btn").onclick = (e) => {
        this.mod.sendUnfollowTransaction(this.publicKey);
      }
    }

    if (document.querySelector(".saito-profile-follow-contact-btn")){
      document.querySelector(".saito-profile-follow-contact-btn").onclick = (e) => {
        this.mod.sendFollowTransaction(this.publicKey);
      }
    }
