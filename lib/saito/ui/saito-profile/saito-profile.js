...
class SaitoProfile {
  constructor(app, mod, container = "") {
    ...
    this.publickey = null;
    this.app.keychain.returnKeys().then((res) => {
      this.keys = res;
    });
  ...
  remove() {
    if (document.querySelector(".saito-profile-container")) {
      document
        .querySelector(".saito-profile-container")
        .parentElement.removeChild(document.querySelector(".saito-profile-container"));
    }
  }
