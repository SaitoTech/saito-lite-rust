...
class SaitoProfile {
    ...
    render() {
      ...
      if (!document.querySelector(myqs)) {
        this.app.browser.addElementToSelector(SaitoProfileTemplate(this.app, this.mod), this.container);
      } else {
        this.app.browser.replaceElementBySelector(SaitoProfileTemplate(), myqs);
      }
