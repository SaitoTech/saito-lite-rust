...
class SaitoProfile {
  ...
  constructor(app, mod, container = "") {
    ...
    app.connection.on("update-profile-stats", (key, amount) => {
      let field = document.querySelector(`.redsquare-profile-menu-${key} span`);
      if (field) {
        field.innerHTML = sanitize(`(${amount})`);
      }
    });

    app.connection.on("rerender-profile", () => {
      this.render()
    })
  }
  ...
  attachEvents() {
    if (document.querySelector(".saito-profile-add-contact-btn")) {
      document.querySelector(".saito-profile-add-contact-btn").onclick = (e) => {
        document.querySelector(".saito-profile-add-contact-btn").style.display = "none";
    ...
    if (document.querySelector(".saito-profile-unfollow-contact-btn")) {
      document.querySelector(".saito-profile-unfollow-contact-btn").onclick = async (e) => {
    ...
    if (document.querySelector(".saito-profile-follow-contact-btn")) {
      document.querySelector(".saito-profile-follow-contact-btn").onclick = async (e) => {
    ...
    if (document.querySelector('.saito-description-edit')) {
      document.querySelector(
