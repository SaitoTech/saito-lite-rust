module.exports = SaitoProfileTemplate = (app, mod, profile) => {
  ...
  let html = `
    <div class="saito-profile">
      ...
      ${profile.publicKey === mod.publicKey && `	<i class="saito-profile-edit fas fa-camera"> </i>`}
  ...
  html += `
     ...
     <div class="saito-profile-info">
      ...
      <div id="${profile.publicKey}-profile-description" class="saito-profile-description" data-id="${profile.publicKey}"> </div>
    </div>`;
