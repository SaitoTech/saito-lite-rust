module.exports = SaitoProfileTemplate = (app, mod, profile) => {
	...
	// let key = app.keychain.returnKey(profile.publicKey);
	// console.log(key, 'profile key');

	let banner = profile.photo || ""
	let bio = profile.bio || ""
	...
	<div class="saito-profile-photo-container">
	${profile.publicKey === mod.publicKey && profile.identifier && `	<i class="saito-profile-edit fas fa-camera"> </i>`}
    ${
		banner
			? `<img class="saito-profile-banner" src="${banner}"/>`
