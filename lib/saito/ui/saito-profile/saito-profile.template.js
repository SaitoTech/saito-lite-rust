...
***/
  ...
  html += `
    <div class="saito-profile-menu">
      <div class="redsquare-profile-menu-tabs redsquare-profile-menu-posts ${profile.tab == "posts" ? "active" :""}" data-id="posts">Posts</div>
      <div class="redsquare-profile-menu-tabs redsquare-profile-menu-replies ${profile.tab == "replies" ? "active" :"" }" data-id="replies">Replies</div>
    </div>
  `;
