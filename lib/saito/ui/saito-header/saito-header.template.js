let SaitoHeaderTemplate = (app, mod) => {
  ...
  app.modules.respondTo("header-menu").forEach(headerModule => {
    added_top_menu = 1;
    menu_insert_html += headerModule.respondTo("header-menu").returnMenu(app, mod);
});
               ...
               <div class="saito-header-hamburger-contents">
                   ...
                   <div class="saito-header-profile header-wallet">
                       <div class="wallet-infoo">
                           <div class="saito-header-loader-container">
                            <i class="saito-header-qr-loader fa-solid fa-circle-notch"></i>
                           </div>
                           <div id="qrcode"></div>
