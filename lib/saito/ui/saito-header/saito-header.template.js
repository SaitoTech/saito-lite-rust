      ...
      <div class="relative" style="">
         ...
         <!-------- wallet end ----------->
            ...
            <div class="saito-header-menu-section">
               <div class="saito-menu">
                  <ul>
                     <li id="saito_header_menu_item_0" data-id="Games" class="saito-header-appspace-option saito-header-arcade">
            ...
            <div class="saito-header-menu-section">
               <div class="saito-menu">
                  <ul>    
                     ...
                     <li class="saito-header-wallet-history" id="wallet-btn-history" data-assetid="" data-ticker="" data-balance="0" data-sender="">
