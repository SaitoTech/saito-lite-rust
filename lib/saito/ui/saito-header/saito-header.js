...
class SaitoHeader extends UIModTemplate {
	...
	********************************************/
	...
	async renderCrypto(force = false) {
		...
		//Still necessary or duplicated below???
		...
		try {
			if (preferred_crypto.isActivated()) {
				...
				this.setAttributes(addressContainer, {
	...
	// Only used above, plz delete because no sense caching this info in the html... (except for debugging)
