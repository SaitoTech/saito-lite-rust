...
console.log("WE HAVE HIT RENDER");
...
console.log("WE HAVE HIT RENDER BUT NOT RETURNED");

    if (!document.getElementById("saito-header")) {
console.log("RENDERING SAITO HEADER");
      app.browser.addElementToDom(SaitoHeaderTemplate(app));
    } else {
console.log("NOT RENDERING SAITO HEADER");
    }
