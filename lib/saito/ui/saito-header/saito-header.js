...
class SaitoHeader extends UIModTemplate {
  ...
  async loadCryptoBalance(cryptoMod) {
    try {
      ...
      //data-assetid="${xmod.asset_id}" data-ticker="${xmod.ticker}" data-balance="${xmod.balance}" data-sender="${xmod.returnAddress()}"

      console.log("cryptoMod ///////////");
      console.log(cryptoMod);
