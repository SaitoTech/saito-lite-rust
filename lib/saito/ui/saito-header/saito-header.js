...
const Deposit = require('./../saito-crypto/overlays/deposit');
const Withdraw = require('./../saito-crypto/overlays/withdraw.js');
const History = require('./../saito-crypto/overlays/history');
...
class SaitoHeader extends UIModTemplate {
  ...
  constructor(app, mod) {
    ...
    //
    this.deposit_overlay = new Deposit(this.app, this);
    this.withdrawal_overlay = new Withdraw(this.app, this);
    this.history_overlay = new History(this.app, this);
  ...
  renderUsername() {
    ...
    if (username === "Anonymous Account" || username === "Anonymous") {
      el.onclick = (e) => {
        header_self.app.connection.emit("register-username-or-login", {success_callback: ()=>{
