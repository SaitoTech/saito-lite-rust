...
class GameRaceTrack {
  ...
  render() {
    ...
    if (document.getElementById("racetrack")) {
      this.app.browser.replaceElementById(GameRaceTrackTemplate(this), "racetrack");
    } else {
  ...
  attachEvents() {
    ...
    document.querySelector(".racetrack").onclick = (e) => {
      if (document.querySelector(".racetrack").classList.contains("racetrack-lock")) {
        document.querySelector(".racetrack").classList.remove("racetrack-lock");
      } else {
        document.querySelector(".racetrack").classList.add("racetrack-lock");
      }
    }
