...
class SaitoCalendar {
  ...
  clearEvents() {
    document.querySelectorAll(".saito-calendar-day").forEach(el => { el.onclick = (e) => {} });
    document.querySelectorAll(".saito-calendar-prev").forEach(el => { el.onclick = (e) => {} });
    document.querySelectorAll(".saito-calendar-next").forEach(el => { el.onclick = (e) => {} });
  }
  ...
  attachEvents() {
    ...
    document.querySelectorAll(".saito-calendar-day.next-date").forEach(el => {
       el.onclick = (e) => { document.querySelector(".saito-calendar-next").click(); }
    });

    document.querySelectorAll(".saito-calendar-day.prev-date").forEach(el => {
       el.onclick = (e) => { document.querySelector(".saito-calendar-prev").click(); }
    });
