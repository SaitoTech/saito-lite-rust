...
class SaitoContacts {
	...
	async render(){
		if (!document.getElementById("saito-contacts-modal")){
			this.overlay.show(await SaitoContactsTemplate(this.app, this));
		}else{
			this.app.browser.replaceElementById(await SaitoContactsTemplate(this.app, this), "saito-contacts-modal");
		}
