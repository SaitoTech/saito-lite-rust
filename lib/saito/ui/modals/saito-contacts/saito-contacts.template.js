module.exports = (app, contacts) => {
  ...
  let html = `<div id="saito-contacts-modal" class="saito-modal">
                <div class="saito-modal-title">My Contacts</div>
  ...
  if (contacts.multi_select){
    html += `<button id="saito-contact-submit" class="saito-button-primary" type="button">Select</button>`;
  }
  html += "</div>";      
