...
<form>
            <div class="saito-overlay-form">
              ...
              <div class="saito-overlay-form-text">Protect ${txt} by adding remote login. Your email / password will be used for wallet encryption and not shared publicly:</div>
