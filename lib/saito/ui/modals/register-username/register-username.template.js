      ...
      <div class="welcome-modal-left">
        ...
        <div class="welcome-modal-main">
          ...
          <div class="welcome-modal__input-container">
            <input class="welcome-modal__input" id="registry-input" type="text" placeholder="username">
            <span">@saito</span>
          </div>
        </div>
      <div class="register-modal-controls">
      <button class="welcome-modal__button button" id="registry-modal-button">REGISTER USERNAME</button>  
