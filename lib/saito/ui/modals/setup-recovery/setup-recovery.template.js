module.exports = SetupRecoveryTemplate = (identifier = "") => {
...
<form>
            <div class="saito-overlay-form">
              <div class="saito-overlay-form-header">
                <div class="saito-overlay-form-header-title">Setup Account Recovery</div>
                <img class="saito-overlay-form-header-image" src="/saito/img/dreamscape.png" />
              </div>
              <div class="saito-overlay-form-text">Login to ${txt} by adding an email/password. This information is used in your browser for wallet encryption and is not shared publicly:</div>
              <div class="saito-overlay-subform">
		<input type="checkbox" class="saito-overlay-subform-checkbox" checked />
		<div class="saito-overlay-subform-text">i understand wallet will be only as secure as the password i provide</div>
		<div></div>
