...
class GameHammerMobile {
  ...
  render(target = ".gameboard"){
    ...
    this.current.z = Math.floor(100 * Math.min(window.innerWidth / boardWidth, window.innerHeight / boardHeight)) / 100;
    this.current.width = boardWidth;
    this.current.height = boardHeight;
