module.exports = SaitoUserTemplate = (user) => {
	...
	return `
  <div ${uuid ? `id="${uuid}"` : ''}
  	class="saito-user ${user.extra_classes} saito-user-${publicKey}${myPublicKey == publicKey ? ' saito-user-self' : ''}" 
  	data-id="${publicKey}" data-disable="${data_disable}">
    <div class="saito-identicon-box">
    	<img class="saito-identicon" src="${imgsrc}" data-id="${publicKey}">${icon}</div>
