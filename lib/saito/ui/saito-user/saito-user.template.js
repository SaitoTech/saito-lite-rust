module.exports = SaitoUserTemplate = (user) => {
  ...
  let myPublicKey = user.mod?.publicKey;
  ...
  return `
  <div ${uuid ? `id="${uuid}"`:""}class="saito-user saito-user-${publicKey}${myPublicKey == publicKey?" saito-user-self":""}" data-id="${publicKey}" data-disable="${data_disable}">
