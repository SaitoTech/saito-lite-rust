...
class GameMenu {
  ...
  render() {
      ...
      if (this.debug || this.game_mod.debug) {
        this.addSubMenuOption("game-game", {
          ...
          callback: function (app, game_mod) {
            ...
            menu_self.overlay.show(`<div class="debug_overlay"></div>`);
    ...
    let html = `<div id="game-menu-toggle" class="game-menu-icon game-menu-mobile-toggle"><i class="fas fa-bars"></i></div><ul>`;
  ...
  addChatMenu(shortNames = null, longNames = null) {
    ...
    menu_self.addMenuOption("game-social", "Social");
    ...
    if (this.game_mod?.game?.players) {
        menu_self.addSubMenuOption("game-chat", {
          ...
          callback: function (app, game_mod) {
            ...
            if (game_mod.game.players.length > 2){
              ...
              app.connection.emit("open-chat-with", { key: game_mod.game.opponents[0] });
            }
          },
        });
      ...
      /*for (let ii = 0; ii < this.game_mod.game.players.length; ii++) {
        if (this.game_mod.game.players[ii] != this.game_mod.publicKey) {
          ...
          menu_self.addSubMenuOption("game-chat", {
            ...
            callback: function (app, game_mod) {
              menu_self.hideSubMenus();
              app.connection.emit("open-chat-with", { key: player_id });
            },
          });
        }
      }*/
