class SaitoMentions {
  ...
  selectItem(active) {
    ...
    return () => {
      ...
      console.log('${preMention}${mention}${postMention}: ', preMention, mention, postMention);
  ...
  onInput(ev) {
    ...
    setTimeout(() => {
      ...
      if (this.inputType != 'div') {
        ...
        console.log('boundPos:', boundPos);
        let listWidth = 481;
        let listHeight = 298;
        let listPosX = 0;
        let listPosY = 0;

        console.log('listWidth+(boundPos.left): ', listWidth+(boundPos.left));
        ...
        if (listWidth+(boundPos.left) > window.innerWidth) {
          ...
          console.log('goind out of screen left //');
        } else {
          listPosX =  0;
        }
        ...
        this.left = listPosX;
        this.top = this.top = coords.top  + coords.height - this.ref.scrollTop + offsetTop;;
      }
