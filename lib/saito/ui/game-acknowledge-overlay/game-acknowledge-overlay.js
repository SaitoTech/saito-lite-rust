...
class GameAcknowledgeOverlay {
  ...
  render(msg="", img="") {
    ...
    try {
      ...
      document.querySelector(".game-acknowledge-menu").innerHTML = `<div class="game-acknowledge-notice">${msg}</div><ul><li class="textchoice acknowledge" id="acknowledge">acknowledge</li></ul>`;
    } catch (err) {
    }
  }
