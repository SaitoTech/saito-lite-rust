...
****/
  ...
  calculateElementHeight(elm) {
   ...
   //Check if the newly size hud overflows off the bottoom
    ...
    if (this.debugging) { console.log("elmRect: " + JSON.stringify(elmRect));}
