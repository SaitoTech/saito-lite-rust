...
class GameHud {
  ...
  resizeHud() {
    ...
    //console.log("*** Original DOM statistics: ");
...
console.log("existing hud width: " + this.hud_width);
console.log("existing hud left: " + hud.style.left);
...
console.log("new hud left 1: " + hud.style.left);
	  }
	} else {
...
console.log("width difference: " + width_difference);
	  if (width_difference >= 1) {
	    hud.style.left = (parseInt(hud.style.left) + parseInt(width_difference)) + "px";
console.log("new hud left 2: " + hud.style.left);
	  }
	}
      }
console.log("updated left positioning of hud");
