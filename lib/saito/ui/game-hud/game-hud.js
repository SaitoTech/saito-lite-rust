...
//          break;
	...
	// set the height of the hud_body based on the contents / cardbox
      ...
      //
      let hudbh = parseInt(this.calculateElementHeight(document.getElementById("hud-body")));
      let hudhh = parseInt(this.calculateElementHeight(document.getElementById("hud-header")));
      let hudh  = parseInt(this.calculateElementHeight(document.getElementById("hud")));
