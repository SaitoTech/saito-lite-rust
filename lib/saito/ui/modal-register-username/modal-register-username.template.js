module.exports = ModalRegisterUsernameTemplate = () => {
  ...
  <div class="welcome-modal-wrapper">
    <div class="welcome-modal-action">
      ...
      <input id="" style="" class="username-registry-input" id="registry-input welcome-modal__input" type="text" placeholder="username"><b style="margin: 1em 1em 1em 10px;">@saito</b>
      </div>
