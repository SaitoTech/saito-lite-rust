...
class SaitoImageOverlay {
  ...
  render(image_idx = -1) {
    ...
    //
    if (image_idx > -1) { this.image_idx = image_idx; }
    ...
    this.image_array.forEach((img, idx) => {
      ...
      if (io_self.image_idx == idx) {
        io_self.checkArrows(document.getElementById("saito-overlay-img-"+idx));
      } else {
  ...
  attachEvents() {
    ...
    document.getElementById("saito-img-arrow-box-left").addEventListener('click', (e) => {
      this.image_idx--;
      if (this.image_idx <= 0) { this.image_idx = 0; }
      this.hideAllImgs();
      this.showImage(this.image_idx);
    });

    document.getElementById("saito-img-arrow-box-right").addEventListener('click', function(e){
      this.image_idx++;
      if (this.image_idx >= this.image_array.length) { this.image_idx = this.image_array.length-1; }
      this.hideAllImgs();
      this.showImage(this.image_idx);
    });
	...
	if (obj) {
	  if (obj.style.display != "none") {
	    document.getElementById("saito-img-arrow-box-left").click();
	  }
	}
      };
	...
	if (obj) {
	  if (obj.style.display != "none") {
	    document.getElementById("saito-img-arrow-box-right").click();
	  }
	}
      };
    };
  ...
  checkArrows(img){
    ...
    if (document.querySelector('#saito-img-arrow-box-right')) {
      document.querySelector('#saito-img-arrow-box-right').style.right = '-'+ right_arrow_pos + 'px';
    }
  ...
  showArrows(){
    if (document.querySelector('#saito-img-arrow-box-left')) {
      document.querySelector('#saito-img-arrow-box-left').style.display = 'block';
    }
    if (document.querySelector('#saito-img-arrow-box-right')) {
      document.querySelector('#saito-img-arrow-box-right').style.display = 'block';
    }
  }

  hideArrowLeft(){
    if (document.querySelector('#saito-img-arrow-box-left')) {
      document.querySelector('#saito-img-arrow-box-left').style.display = 'none';    
    }
  }

  hideArrowRight(){
    if (document.querySelector('#saito-img-arrow-box-right')) {
      document.querySelector('#saito-img-arrow-box-right').style.display = 'none';    
    }
  }
