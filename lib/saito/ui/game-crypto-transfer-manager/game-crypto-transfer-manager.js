 ...
 */ 
    balance(app, mod, address, ticker, mycallback=null) {
      ...
      this.overlay.showOverlay(app, mod, GameCryptoTransferManagerBalanceTemplate(app, sobj));
 ...
 */ 
    send(app, mod, sender, receiver, amount, ts, ticker, mycallback=null) {
      ...
      this.overlay.showOverlay(app, mod, GameCryptoTransferManagerSendTemplate(app, sobj));
      this.overlay.blockClose();
 ...
 */ 
    receive(app, mod, sender, receiver, amount, ts, ticker, mycallback=null) {
      ...
      this.overlay.showOverlay(app, mod, GameCryptoTransferManagerReceiveTemplate(app, sobj));
      this.overlay.blockClose();
