...
class SendBlockchainBlockData {
    ...
    block_hash = [];
    timestamp = 0;
    pre_hash = []; // TODO : remove this field if not required
    number_of_transactions = 0; // TODO : remove this field if not required
...
class SendBlockchainMessage {
    ...
    constructor(sync_type, starting_hash, blocks_data, app: Saito) {
