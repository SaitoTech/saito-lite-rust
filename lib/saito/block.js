...
console.log("A 3 : " + i);
          ...
          let gt = this.app.goldenticket.deserialize(mempool.mempool.golden_tickets[i].transaction.m);

console.log("mempool golden tickets length: " + mempool.mempool.golden_tickets.length);
