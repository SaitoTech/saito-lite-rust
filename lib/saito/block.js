...
class Block {
  ...
  deserialize(buffer) {
    ...
    this.block.treasury = BigInt(binary.u64FromBytes(buffer.slice(181, 189)));
    this.block.staking_treasury = BigInt(binary.u64FromBytes(buffer.slice(189, 197)));
    this.block.burnfee = BigInt(binary.u64FromBytes(buffer.slice(197, 205)));
