...
class Peer {
    ...
    async handleApplicationMessage(peer, message) {

        console.log("handleApplicationMessage:: sending response for : " + message.message_id + " : " + message.message_name);
        peer.sendResponseFromStr(message.message_id, "Response A");
    ...
    async sendResponseFromStr(message_id, data) {
        ...
        if (this.socket && this.socket.readyState === this.socket.OPEN) {
            await this.app.networkApi.sendAPIResponse(this.socket, "RESULT__", message_id, buffer);
        } else {
    ...
    //
    sendRequestWithCallback(message, data = {}, callback = null) {
