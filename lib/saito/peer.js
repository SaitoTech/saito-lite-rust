...
console.log("done emitting handshake complete");
	...
	if (reconstructed_message) { message.request = reconstructed_message; }
	if (reconstructed_data) { message.data = reconstructed_data; }
	...
	let mycallback = function(response_object) {
          //peer.sendResponseFromStr(msg.message_id, "Response A");
          //peer.sendResponseFromStr(msg.message_id, "Response A");
	}
