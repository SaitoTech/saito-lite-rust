    ...
    async handlePeerCommand(message) {
        ...
        if (command === "SHAKINIT") {
            ...
            if (bytes) {
                ...
                await this.sendAPIResponse(this.socket, "ERROR__", message.message_id, Buffer.from("ERROR", "utf-8"));
            }
            ...
            if (blockchain_message) {
                ...
                await this.app.networkApi.sendAPIResponse(this.socket, "ERROR__", message.message_id, Buffer.from("UNKNOWN BLOCK HASH", "utf-8"));
            }
            ...
            await this.sendErrorResponseFromStr(message.message_id, "UNHANDLED COMMAND");
            ...
            await this.sendErrorResponseFromStr(message.message_id, "NO SUCH");
        }
    }
    ...
    async buildSendBlockchainMessage(request_blockchain_message) {
        ...
        if (request_blockchain_message.latest_block_id === 0 &&
            ...
            if (!this.app.blockchain.blockring.containsBlockHashAtBlockId(request_blockchain_message.latest_block_id,
                ...
                console.warn("block hash is not in the longest chain");
