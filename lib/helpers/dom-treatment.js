...
`
    ...
    wrapper.querySelector("i").addEventListener("click", () => {
      content.classList.contains("show-content")
    ...
    optionList.forEach((item) => {
      item.addEventListener("click", (e) => {
        ...
        el.options[0].innerHTML = e.target.innerHTML
        // el.options[0].value = e.target.value;
        content.classList.remove("show-content");
      });
    });
