...
class GameAcknowledge {
	...
	/*
	   ...
	   ******** WARNING ********
	   **************************
	   This function won't necessary halt the game, so incoming commands may be run, breaking the game.

	   You must manually set this.halted to true/1 and saveGame outside of the game

	   mycallback should contain restartQueue() which will unset the flag and continue process the game queue
