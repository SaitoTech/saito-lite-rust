...
class GameAcknowledge {
	...
	playerAcknowledgeNotice(msg, mycallback) {
		...
		// These should *NOT* be a problem because this function is usually called
		// by the ACKNOWLEDGE queue command which sets halted and saves the game
		// if anything, calling them here ensures consistency as to whether it is 
		// coming through the queue or being manually called by the user
