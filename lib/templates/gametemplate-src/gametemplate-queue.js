...
console.log("initiali game queue continue...");
...
//console.log("FM: " + this.game.future.length);
		...
		//
console.log("NOW RUN QUEUE: " + JSON.stringify(this.game.queue));
		if ((await this.runQueue()) == 0) {
			...
			// call this function
			//
console.log("NOW PROCESS FUTURE MOVES: " + JSON.stringify(this.game.queue));
