...
let debug_trigger = false;
for (let i = 0; i < this.game.turn.length; i++) { if (this.game.turn[i].indexOf("RESOLVE") != -1) { debug_trigger = true; } }
if (debug_trigger) {
console.log("#");
console.log("#");
console.log("# sending RESOLVE w/ step: " + ns.game);
console.log("#");
}
