...
console.log("FOUND UNPROCESSED RESOLVE... returning 1");
										return 1;
									} else {
console.log("FOUND UNPROCESSED RESOLVE... but not next move, skipping");
									}
...
console.log("adding " + JSON.stringify(gametxmsg.turn) + " move from " + gametx.from[0].publicKey);
console.log("UPDATE player-step to " + gametxmsg.step.game);

		this.game.step.players[gametx.from[0].publicKey] = gametxmsg.step.game;

console.log("game-step is " + this.game.step.game);
		if (gametxmsg.step.game > this.game.step.game) {
			this.game.step.game = gametxmsg.step.game;
console.log("UPDATE game-step to " + gametxmsg.step.game);
...
//		console.info(`ADD (${gametxmsg.step.game}): ${JSON.stringify(gametxmsg.turn)}`);
