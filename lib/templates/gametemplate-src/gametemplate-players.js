...
console.log("target is not: " + this.game.target);

		if (this.game.over == 0) {
console.log("is gameBrowserActive(): " + this.gameBrowserActive());
			if (this.gameBrowserActive()){
				if (this.useClock) {
					this.startClock();
				}
console.log("can we set PLAY reminder active!");
				if (this.game.target == this.game.player) { 
console.log("setting PLAY reminder active!");
				...
				setTimeout(()=> {
alert("emiting the arcade notify player turn indicator: " + target);
