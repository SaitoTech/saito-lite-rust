...
console.log("send request with callback: " + message.request + " -- " + message.data);
...
console.log("HERE WITH MSG: " + JSON.stringify(message));
...
console.log("message is not null");
    ...
    peers.forEach((peer) => {
console.log("SENDING WITH CALLBACK!");
      peer.sendRequestWithCallback(message.request, message.data, function (res) {
