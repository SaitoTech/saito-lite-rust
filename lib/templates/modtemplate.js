...
class ModTemplate {
	...
	async render() {
		...
		if (document.querySelector(".saito-welcome-overlay")){
			document.querySelector(".saito-welcome-overlay").style.pointerEvents = "none";

			document.querySelector(".saito-welcome-overlay-backdrop").onclick = (e) => {
				document.querySelector(".saito-welcome-overlay-backdrop").remove();
				document.querySelector(".saito-welcome-overlay").remove();
			}

			document.querySelector(".saito-welcome-header").innerHTML = "Welcome to Web3";
			document.querySelector(".saito-welcome-footer").innerHTML = "click anywhere to continue";
		}
	}
