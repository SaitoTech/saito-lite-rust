...
const Toggler = require('../saito/saito-ui/dark_mode_toggler');
...
class ModTemplate {
    ...
    //
    async initialize(app, meta, stylesheets, scripts) {


        if (meta && stylesheets && scripts) {
            this.meta = meta;
    ...
    initializeHTML(app) {
      ...
      this.darkModeToggler.initialize();
        ...
        // if (additionalURL) {
        //     var newurl = window?.location.protocol + "//" + window?.location.host + window?.location.pathname + additionalURL;
