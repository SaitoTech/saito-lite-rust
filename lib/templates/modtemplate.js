...
console.log("rendering mod: " + this.name);
    ...
    if (this.includes_attached == 0) {
      ...
      if (!document.getElementById("saito-container")) {
        app.browser.addElementToDom('<div id="saito-container" class="saito-container"></div>');
      }
    ...
    for (let i = 0; i < this.components.length; i++) {
      this.components[i].render(app, mod, class_container);
    }
