...
console.log("request to activate: " + this.ticker);
    if (!this.optionsStorage.isActivated) {
      this.optionsStorage.isActivated = true;
console.log("saving isActivated: " + this.optionsStorage.isActivated);
      this.save();
...
console.log("loading this options Storage!");
      this.optionsStorage = this.app.options.crypto[this.ticker];
console.log("now it is activated: " + this.optionsStorage.isActivated);
    }
  }
