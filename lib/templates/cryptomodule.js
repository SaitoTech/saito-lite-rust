...
console.log("fallback 1: " + this.name);
      if (this.app.options.crypto[this.ticker]) {
console.log("fallback 2: " + this.name);
        if (this.app.options.crypto[this.ticker].isActivated == true) {
console.log("fallback 3: " + this.name);
          return true;
        }
      }
    }
...
console.log("---- ACTIVATE ---- " + this.name);
  ...
  async formatBalance() {
    ...
    // console.log("balance_as_float //////////")
    // console.log(balance_as_float);

    // if (balance_as_float == 0) {
    //   balance_as_float = balance_as_float.toPrecision(1); 
    // }
