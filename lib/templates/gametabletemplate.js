...
class GameTableTemplate extends GameTemplate {
  ...
  async initializeHTML(app) {
    ...
    if (this.game.player == 0) {
      ...
      if (this.willleave || this.game?.eliminated?.includes(this.publicKey)) {
      ...
      btn.onclick = async (e) => {
        switch (e.currentTarget.id) {
          case "join":
            ...
            await game_self.sendMetaMessage("JOIN");
          ...
          case "leave":
            ...
            await game_self.sendMetaMessage("LEAVE");
            break;
          case "cancel":
            await game_self.sendMetaMessage("CANCEL");
