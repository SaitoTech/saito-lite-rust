    ...
    <div class="saito-table">
      ...
      <div class="saito-table-body">
        <div class="saito-table-row">
          ...
          <div>${this.game.state.session.round-1} </div>
          <div>${this.game.state.lifetime.round + this.game.state.session.round-1} </div>
        </div>
        <div class="saito-table-row">
        ...
        <div class="saito-table-row">
          ...
          <div>${(this.game.state.session.round>1)? Math.round(1000* this.game.state.session.wins / (this.game.state.session.round-1))/10 : 0}</div>
          <div>${(this.game.state.lifetime.round + this.game.state.session.round > 1)? Math.round(1000* (this.game.state.lifetime.wins + this.game.state.session.wins)/ (this.game.state.lifetime.round+ this.game.state.session.round - 1))/10 : 0}</div>
        </div>
      </div>
    </div>
    </div>`;
