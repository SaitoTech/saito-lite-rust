      ...
      <div class="saito-table">
        ...
        <div class="saito-table-body">
          ...
          <div class="saito-table-row">
            ...
            <div>${	this.game.state.session.round + adjustment > 0
		? Math.round(	(1000 * this.game.state.session.wins) /	this.game.state.session.round + adjustment ) / 10
		: 0
}</div>
            <div>${	this.game.state.lifetime.round + this.game.state.session.round + adjustment >
				0
		? Math.round(
			(1000 *
								(this.game.state.lifetime.wins +
									this.game.state.session.wins)) /
								(this.game.state.lifetime.round +
									this.game.state.session.round + adjustment)
					  ) / 10
		: 0
}</div>
          </div>
