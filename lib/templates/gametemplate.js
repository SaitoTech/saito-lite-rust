	...
	async attachEvents(app) {
		if (this?.game?.id) {
			...
			this.app.connection.on('arcade-data-loaded', ()=> {
				this.app.connection.emit('league-overlay-games-list', { game: this.game.name });
			});
	...
	createSplashScreen() {
		let html = `<div class="scrollable-page">
			...
			<div class="saito-splash-info">
				<div class="splash-page-game-description">${this.description}</div>`;
		...
		html += `
			...
			<div class="saito-splash-info">
				<div class="splash-page-leaderboard"><div class="saito-loader"></div></div>
			</div>
			<div class="saito-splash-image" style="background-image: url(/${this.returnSlug()}/img/arcade/arcade-banner-background.png);">
				<div class="saito-splash-section-title">
			...
			<div class="saito-splash-info">
				<div class="game-lists"><div class="saito-loader"></div></div>
			</div>
			<div class="saito-splash-image" style="background-image: url(/${this.returnSlug()}/img/arcade/arcade-banner-background.png);">
				<div class="saito-splash-section-title">
					<h2>How to Play</h2>
