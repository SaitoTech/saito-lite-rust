...
const GameScoreboard = require("./../saito/new-ui/game-scoreboard/game-scoreboard");
...
console.info("started queue done");
  ...
  */
    ...
    try {
      if (this.useHUD) {
        ...
        let status_obj =
          ...
          document.getElementById("obstatus");
        if (status_obj) {
  ...
  identifyPlayer(player) {
    ...
    if (!name) {
      name = this.app.keys.returnIdentifierByPublicKey(this.game.players[player - 1]);
    }
    if (name != "") {
      if (name.indexOf("@") > 0) {
        name = name.substring(0, name.indexOf("@"));
  ...
  identifyPlayerByPublicKey(pkey) {
    ...
    if (!name) {
      name = this.app.keys.returnIdentifierByPublicKey(pkey);
    }
    if (name != "") {
      if (name.indexOf("@") > 0) {
        name = name.substring(0, name.indexOf("@"));
