...
class GameTemplate extends ModTemplate {
  ...
  constructor(app) {
    ...
    this.cardbox_callback = function(card) { console.log(temp_self.changeable_callback);
...
****/
	...
	backup_game.queue.push(`ACKNOWLEDGE\tLast Warning -- we're not kidding -- your game will continue the next time you click to continue, but if not all players have restored things will break.`);
	backup_game.queue.push(`ACKNOWLEDGE\tGame Reloased. Note that this is BETA functionality -- do not click to continue your game until all players have confirmed they can see this message.`);
...
console.log("is anyone left to move: " + anyone_left_to_move);
	...
	let receiver_crypto_address = "";
	  ...
	  if (game_self.game.players[i] === receiver) { receiver_crypto_address = game_self.game.keys[i]; }
        ...
        game_self.crypto_transfer_manager.sendPayment(this.app, this, [sender_crypto_address], [receiver_crypto_address], [amount], ts, ticker, function() {
          ...
          game_self.app.wallet.sendPayment([sender_crypto_address], [receiver_crypto_address], [amount], ts, function(robj) {
            ...
            //
            // and save so we continue from AFTER this point if the game is reloaded...
	    //
            game_self.saveGame(game_self.game.id);
	...
	let receiver_crypto_address = "";
	  ...
	  if (game_self.game.players[i] === receiver) { receiver_crypto_address = game_self.game.keys[i]; }
        ...
        game_self.crypto_transfer_manager.receivePayment(this.app, this, [sender], [receiver], [amount], ts, ticker, function() {
