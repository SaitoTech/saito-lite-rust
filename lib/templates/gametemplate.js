...
console.log("HERE: " + this.game.clock_limit + " --- " + this.game.block_spent);
...
console.log("STARTING THE CLOCK: " + this.game.clock_limit);
...
console.log("time on click: " + time_on_clock + " -- " + (x - this.time.last_received));
