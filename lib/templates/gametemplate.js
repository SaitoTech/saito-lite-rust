...
console.log(txmsg.game_id + " -- " + game_self.game.id + " -- " + txmsg.id + " -- " + game_self.game.id);
...
console.log("STEPS: " + txmsg.step.game + " -- " + game_self.game.step.game);
...
//	}
	...
	//
console.log("RECEIVE MESSAGE 2: " + JSON.stringify(gametxmsg.step));
	if (this.name === gametxmsg.module) {
console.log("CHECKING ID: " + game_self.game.id + " -- " + gametxmsg.game_id);
//console.log("RECEIVED MESSAGE: " + JSON.stringify(gametxmsg));
console.log(this.name + " ------ " + gametxmsg.module);
console.log("A");
