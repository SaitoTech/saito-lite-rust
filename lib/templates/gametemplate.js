  ...
  initializeQueueCommands() {
    ...
    this.commands.push((game_self, gmv) => {
      if (gmv[0] === "SAVE") {
        ...
        game_self.game.queue.splice(game_self.game.queue.length - 1, 1);
	game_self.updateLog(`<p></p>This game has been saved. To restore from this point, all players should visit the following URL:<p></p>&nbsp;<p></p>https://saito.io/loadgame?game_id=${game_self.game.id}<p></p>`);
      }
      return 1;
    });
