...
console.log("FTMSG: " + JSON.stringify(ftxmsg));
  ...
  loadGame(game_id = null) {
    ...
    if (game_id == null) {
      ...
      if (this.app.options.games && this.app.options.games.length > 1){
  ...
  initializeSinglePlayerGame() {
    ...
    //
console.log("TGD: " + this.game.dice);
...
console.log("DICE IS NOW: " + this.game.dice);
  ...
  newGame(game_id = null) {
    ...
    if (!game_id) {
      game_id = Math.random().toString(); //Returns 0.19235734589 format. We never want this to happen!
