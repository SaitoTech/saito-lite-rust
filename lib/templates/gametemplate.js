    ...
    */
	...
	async onPeerServiceUp(app, peer, service = {}) {
		...
		if (service.service === 'relay') {
			let data = {
				module: this.name, 
				notification: `${this.app.keychain.returnUsername(this.publicKey)} has joined the game`
			};
  ...
  */
	...
	exitGame() {
		...
		if (!this.game.over){
			let data = {
				module: this.name, 
				notification: `${this.app.keychain.returnUsername(this.publicKey)} has left the room`
			};
			this.app.connection.emit("relay-notify-peer", this.game.opponents, data);
		}
