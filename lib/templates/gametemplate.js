...
console.log("22222");
  ...
  onPeerHandshakeComplete(app, peer){
    ...
    if (this.hasGameMovePending() && this.game?.initializing == 0) {
      ...
      console.log("REBROADCASTING MOVES NOW THAT WE CONNECT TO NETWORK:");
      //
...
console.log("success ... restart game");
	...
	//
        ...
        for (let i = 0; i < game_self.game.players.length; i++) {
          ...
          if (game_self.app.crypto.verifyMessage(msg_to_verify, obj.sigs[i], game_self.game.players[i]) != true) {
	    auths++;
	  } else {
