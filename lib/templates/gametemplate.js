...
*/
		...
		if (this.loadGamePreference("crypto_transfers_outbound_approved") == null){
			this.saveGamePreference("crypto_transfers_outbound_approved", 0);
		}

		if (this.loadGamePreference("crypto_transfers_inbound_trusted") == null){
			this.saveGamePreference("crypto_transfers_inbound_trusted", 0);
		}
