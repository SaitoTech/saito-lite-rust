...
function subscribeNewBlocks(instanceId, api) {
  return (0, _index2.memo)(instanceId, () => api.derive.chain.subscribeNewHeads().pipe((0, _rxjs.switchMap)(header => {
    ...
    return api.queryAt(blockHash).pipe((0, _rxjs.switchMap)(queryAt => (0, _rxjs.combineLatest)([(0, _rxjs.of)(header), api.rpc.chain.getBlock(blockHash), queryAt.system.events()])));
